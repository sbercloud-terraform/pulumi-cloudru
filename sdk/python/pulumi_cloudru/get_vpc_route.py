...
def get_vpc_route(destination: Optional[builtins.str] = None,
    ...
    :param builtins.str destination: The route destination address (CIDR).
    :param builtins.str id: The id of the specific route to retrieve.
    :param builtins.str region: The region in which to obtain the vpc route. If omitted, the provider-level region will
           be used.
    :param builtins.str tenant_id: Only the administrator can specify the tenant ID of other tenants.
    :param builtins.str type: Route type for filtering.
    :param builtins.str vpc_id: The id of the VPC that the desired route belongs to.
    """
    __args__ = dict()
