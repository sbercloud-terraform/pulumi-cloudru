...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] delay: Specifies the maximum time between health checks in the unit of second. The value ranges
               from 1 to 50.
        :param pulumi.Input[builtins.int] max_retries: Specifies the maximum number of consecutive health checks after which the backend
        ...
        :param pulumi.Input[builtins.str] pool_id: Specifies the id of the pool that this monitor will be assigned to. Changing
               this creates a new monitor.
        :param pulumi.Input[builtins.int] timeout: Specifies the health check timeout duration in the unit of second.
               The value ranges from 1 to 50 and must be less than the `delay` value.
        :param pulumi.Input[builtins.str] type: Specifies the monitor protocol.
        ...
        :param pulumi.Input[builtins.str] expected_codes: Specifies the expected HTTP status code. Required for HTTP type.
               You can either specify a single status like "200", or a range like "200-202".
        :param pulumi.Input[builtins.str] http_method: Specifies the HTTP request method. Required for HTTP type.
               The default value is *GET*.
        :param pulumi.Input[builtins.str] name: Specifies the health check name. The value contains a maximum of 255 characters.
        :param pulumi.Input[builtins.int] port: Specifies the health check port. The port number ranges from 1 to 65535. If not specified,
               the port of the backend server will be used as the health check port.
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB monitor resource. If omitted, the
               provider-level region will be used. Changing this creates a new monitor.
        :param pulumi.Input[builtins.str] url_path: Specifies the HTTP request path for the health check. Required for HTTP type.
