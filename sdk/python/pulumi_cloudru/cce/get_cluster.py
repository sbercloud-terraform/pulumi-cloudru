...
def get_cluster(cluster_type: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_type: Specifies the type of the cluster. Possible values: **VirtualMachine**, **ARM64**.
    :param builtins.str id: Specifies the ID of the cluster.
    :param builtins.str name: Specifies the name of the cluster.
    :param builtins.str region: Specifies the region in which to obtain the CCE cluster. If omitted, the provider-level
           region will be used.
...
def get_cluster_output(cluster_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
