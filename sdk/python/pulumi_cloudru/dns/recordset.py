...
class RecordsetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: Specifies an array of DNS records. The value rules vary depending on the record set type.
        :param pulumi.Input[builtins.str] type: Specifies the type of the record set.
               Value options: **A**, **AAAA**, **MX**, **CNAME**, **TXT**, **NS**, **SRV**, **CAA**.
        :param pulumi.Input[builtins.str] zone_id: Specifies the zone ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the record set.
        :param pulumi.Input[builtins.str] name: Specifies the name of the record set.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the DNS recordset.
        :param pulumi.Input[builtins.int] ttl: Specifies the time to live (TTL) of the record set (in seconds).
