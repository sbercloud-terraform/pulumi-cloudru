...
class DcsRestoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: A dcs_instance ID in UUID format.
        :param pulumi.Input[builtins.str] project_id: The enterprise project id of the dcs instance. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] remark: Description of DCS instance restoration.
        """
