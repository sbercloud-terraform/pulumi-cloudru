...
class TurboArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone where the file system is located.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the security group ID.
        :param pulumi.Input[builtins.int] size: Specifies the capacity of a sharing file system, in GB.
        ...
        :param pulumi.Input[builtins.str] subnet_id: Specifies the network ID of the subnet. Changing this will create a new
               resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled.  
               The valid values are **true** and **false**.
        :param pulumi.Input[builtins.str] backup_id: Specifies the backup ID.
               
               > This parameter is mandatory when a file system is created from a backup.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the SFS Turbo.
               Valid values are **prePaid** and **postPaid**, defaults to **postPaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] crypt_key_id: Specifies the ID of a KMS key to encrypt the file system. Changing this
               will create a new resource.
        :param pulumi.Input[builtins.str] dedicated_flavor: Specifies the VM flavor used for creating a dedicated file system.
        :param pulumi.Input[builtins.str] dedicated_storage_id: Specifies the ID of the dedicated distributed storage used
               when creating a dedicated file system.
        :param pulumi.Input[builtins.bool] enhanced: Specifies whether the file system is enhanced or not. Changing this will
               create a new resource.
               
               This parameter is valid only when `share_type` is set to **STANDARD** or **PERFORMANCE**.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the file system. Changing this
               will create a new resource.
        :param pulumi.Input[builtins.str] hpc_bandwidth: Specifies the HPC bandwidth. Changing this will create a new resource.
               This parameter is valid and required when `share_type` is set to **HPC**.
               Valid values are: **20M**, **40M**, **125M**, **250M**, **500M** and **1000M**.
        :param pulumi.Input[builtins.str] hpc_cache_bandwidth: Specifies the HPC cache bandwidth(GB/s).
               This parameter is valid and required when `share_type` is set to **HPC_CACHE**.
               Valid values are: **2G**, **4G**, **8G**, **16G**, **24G**, **32G** and **48G**.
        :param pulumi.Input[builtins.str] name: Specifies the name of an SFS Turbo file system. The value contains `4` to `64`
               characters and must start with a letter.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the SFS Turbo.
               If `period_unit` is set to **month**, the value ranges from `1` to `11`.
               If `period_unit` is set to **year**, the value ranges from `1` to `3`.
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the SFS Turbo.
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the SFS Turbo resource. If omitted, the
               provider-level region will be used. Changing this creates a new SFS Turbo resource.
        :param pulumi.Input[builtins.str] share_proto: Specifies the protocol for sharing file systems. The valid value is NFS.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] share_type: Specifies the file system type. Changing this will create a new resource.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the SFS Turbo.
...
class _TurboState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone where the file system is located.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] available_capacity: The available capacity of the SFS Turbo file system in the unit of GB.
        :param pulumi.Input[builtins.str] backup_id: Specifies the backup ID.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the file system. Changing this
               will create a new resource.
        :param pulumi.Input[builtins.str] export_location: The mount point of the SFS Turbo file system.
        :param pulumi.Input[builtins.str] hpc_bandwidth: Specifies the HPC bandwidth. Changing this will create a new resource.
               This parameter is valid and required when `share_type` is set to **HPC**.
               Valid values are: **20M**, **40M**, **125M**, **250M**, **500M** and **1000M**.
        :param pulumi.Input[builtins.str] hpc_cache_bandwidth: Specifies the HPC cache bandwidth(GB/s).
        ...
        :param pulumi.Input[builtins.int] size: Specifies the capacity of a sharing file system, in GB.
               ...
               **8G**.
               ...
               > The file system capacity can only be expanded, not reduced.
        :param pulumi.Input[builtins.str] status: The status of the SFS Turbo file system.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the network ID of the subnet. Changing this will create a new
               resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the SFS Turbo.
               ...
               normal use, SFS Turbo will enable the inbound rules for ports *111*, *445*, *2049*, *2051*, *2052*, and *20048* in the
               security group you specified.
        :param pulumi.Input[builtins.str] version: The version ID of the SFS Turbo file system.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this will create a new resource.
        """
        if auto_renew is not None:
            pulumi.set(__self__, "auto_renew", auto_renew)
...
class Turbo(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Turbo':
        """
