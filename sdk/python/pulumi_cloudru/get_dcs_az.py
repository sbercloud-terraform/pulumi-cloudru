...
def get_dcs_az(code: Optional[builtins.str] = None,
    ...
    :param builtins.str code: Specifies the code of an AZ, e.g. "ru-moscow-1a".
    :param builtins.str name: Indicates the name of an AZ.
    :param builtins.str port: Indicates the port number of an AZ.
    :param builtins.str region: The region in which to obtain the dcs az. If omitted, the provider-level region will be
           used.
    """
    __args__ = dict()
    __args__['code'] = code
