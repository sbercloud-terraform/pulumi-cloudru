...
export class ElbIpgroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ElbIpgroupState, opts?: pulumi.CustomResourceOptions): ElbIpgroup {
        return new ElbIpgroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/elbIpgroup:ElbIpgroup';

    /**
     * Returns true if the given object is an instance of ElbIpgroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ElbIpgroup {
     ...
     */
    constructor(name: string, args: ElbIpgroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ElbIpgroupArgs | ElbIpgroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ElbIpgroup.__pulumiType, name, resourceInputs, opts);
    }
}
