...
class DdsParameterTemplateArgs:
    def __init__(__self__, *,
                 ...
                 node_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] node_type: Specifies the node type of parameter template. Valid value:
        ...
        :param pulumi.Input[builtins.str] node_version: Specifies the database version.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameter_values: Specifies the mapping between parameter names and parameter values.
    ...
    def node_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @node_version.setter
    def node_version(self, value: pulumi.Input[builtins.str]):
...
class _DdsParameterTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The create time of the parameter template.
        :param pulumi.Input[builtins.str] description: Specifies the parameter template description.
               The description must consist of a maximum of 256 characters and cannot contain the carriage
               return character or the following special characters: >!<"&'=.
        :param pulumi.Input[builtins.str] name: Specifies the parameter template name.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] updated_at: The update time of the parameter template.
        """
...
class DdsParameterTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'DdsParameterTemplate':
        """
    ...
    @property
    @pulumi.getter(name="parameterValues")
    def parameter_values(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Specifies the mapping between parameter names and parameter values.
        You can customize parameter values based on the parameters in the default parameter template.
        """
