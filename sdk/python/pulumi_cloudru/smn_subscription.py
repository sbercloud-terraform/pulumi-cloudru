...
class SmnSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint: Message endpoint.
        ...
        :param pulumi.Input[builtins.str] protocol: Protocol of the message endpoint. Currently, email,
               sms, http, and https are supported.
        :param pulumi.Input[builtins.str] topic_urn: Resource identifier of a topic, which is unique.
        :param pulumi.Input[builtins.str] region: The region in which to create the SMN subscription resource. If omitted, the provider-level region will be used. Changing this creates a new SMN subscription resource.
        :param pulumi.Input[builtins.str] remark: Remark information. The remarks must be a UTF-8-coded
...
class _SmnSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] owner: Project ID of the topic creator.
        :param pulumi.Input[builtins.str] protocol: Protocol of the message endpoint. Currently, email,
               sms, http, and https are supported.
        :param pulumi.Input[builtins.str] region: The region in which to create the SMN subscription resource. If omitted, the provider-level region will be used. Changing this creates a new SMN subscription resource.
        :param pulumi.Input[builtins.str] remark: Remark information. The remarks must be a UTF-8-coded
               character string containing 128 bytes.
        :param pulumi.Input[builtins.int] status: Subscription status.
               + **0**: indicates that the subscription is not confirmed.
               + **1**: indicates that the subscription is confirmed.
               + **3**: indicates that the subscription is canceled.
        :param pulumi.Input[builtins.str] subscription_urn: Resource identifier of a subscription, which is unique.
        :param pulumi.Input[builtins.str] topic_urn: Resource identifier of a topic, which is unique.
        """
