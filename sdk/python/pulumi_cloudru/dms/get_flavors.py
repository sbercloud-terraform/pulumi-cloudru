...
def get_flavors(arch_type: Optional[builtins.str] = None,
    ...
    :param builtins.str charging_mode: Specifies the flavor billing mode.
           The valid values are **prePaid** and **postPaid**.
    :param builtins.str flavor_id: Specifies the DMS flavor ID, e.g. **c6.2u4g.cluster**.
    :param builtins.str region: Specifies the region in which to obtain the dms kafka flavors.
...
def get_flavors_output(arch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
