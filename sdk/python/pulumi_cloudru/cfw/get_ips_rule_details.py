...
def get_ips_rule_details(fw_instance_id: Optional[builtins.str] = None,
...
def get_ips_rule_details_output(fw_instance_id: Optional[pulumi.Input[builtins.str]] = None,
