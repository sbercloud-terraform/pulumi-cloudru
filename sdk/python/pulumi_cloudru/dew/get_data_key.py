...
def get_data_key(datakey_length: Optional[builtins.str] = None,
    ...
    :param builtins.str datakey_length: Number of bits in the length of a DEK (data encryption keys).
           The maximum number is 512. Changing this gets the new data encryption key.
    :param builtins.str encryption_context: The value of this parameter must be a series of
    ...
    :param builtins.str key_id: The globally unique identifier for the key.
           Changing this gets the new data encryption key.
    :param builtins.str region: The region in which to obtain the keys. If omitted, the provider-level region will be used.
    """
    __args__ = dict()
...
def get_data_key_output(datakey_length: Optional[pulumi.Input[builtins.str]] = None,
