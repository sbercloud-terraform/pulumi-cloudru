...
class ServergroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: Specifies an array of one or more instance ID to attach server group.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the server group. This parameter can contain a
               maximum of 255 characters, which may consist of letters, digits, underscores (_), and hyphens (-). Changing this
               creates a new server group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policies: Specifies the set of policies for the server group. Only *anti-affinity*
               policies are supported.
               
               + `anti-affinity`: All ECS in this group must be deployed on different hosts. Changing this creates a new server
               group.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the server group resource. If omitted,
...
class Servergroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'Servergroup':
        """
