...
def get_ips_custom_rules(action_type: Optional[builtins.int] = None,
    ...
    :param builtins.int action_type: Specifies the action type.
    ...
    :param builtins.str fw_instance_id: Specifies the firewall ID.
...
def get_ips_custom_rules_output(action_type: Optional[pulumi.Input[Optional[builtins.int]]] = None,
