...
def get_pg_plugin_parameter_value_range(instance_id: Optional[builtins.str] = None,
...
def get_pg_plugin_parameter_value_range_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
