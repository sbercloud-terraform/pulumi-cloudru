...
class ConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scaling_configuration_name: Specifies the AS configuration name.
               The name contains only letters, digits, underscores (_), and hyphens (-), and cannot exceed 64 characters.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the AS configuration.
...
class _ConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scaling_configuration_name: Specifies the AS configuration name.
               The name contains only letters, digits, underscores (_), and hyphens (-), and cannot exceed 64 characters.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] status: The AS configuration status, the value can be **Bound** or **Unbound**.
        """
...
class Configuration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            scaling_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Configuration':
        """
