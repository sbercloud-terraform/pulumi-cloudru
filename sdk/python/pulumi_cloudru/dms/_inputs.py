...
class KafkaPermissionsPolicyArgs:
    def __init__(__self__, *,
                 ...
                 user_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] access_policy: Specifies the permissions type. The value can be:
               + **all**: publish and subscribe permissions.
               + **pub**: publish permissions.
               + **sub**: subscribe permissions.
        :param pulumi.Input[builtins.str] user_name: Specifies the username.
        """
