...
class FgsAsyncInvokeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_async_event_age_in_seconds: pulumi.Input[builtins.int],
                 max_async_retry_attempts: pulumi.Input[builtins.int],
                 enable_async_status_log: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] function_urn: Specifies the function URN to which the asynchronous invocation belongs.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.int] max_async_event_age_in_seconds: Specifies the maximum validity period of a message.  
               The valid value is range from `1` to `86,400`.
        :param pulumi.Input[builtins.int] max_async_retry_attempts: Specifies the maximum number of retry attempts to be made if
               asynchronous invocation fails.
               The valid value is range from `0` to `3`.
        :param pulumi.Input[builtins.bool] enable_async_status_log: Specifies whether to enable asynchronous invocation status persistence.
        ...
        :param pulumi.Input['FgsAsyncInvokeConfigurationOnSuccessArgs'] on_success: Specifies the target to be invoked when a function is successfully executed.  
               The object structure is documented below.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to configure the asynchronous invocation.  
    ...
    def max_async_event_age_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def max_async_event_age_in_seconds(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_async_event_age_in_seconds", value)

    @property
    @pulumi.getter(name="maxAsyncRetryAttempts")
    def max_async_retry_attempts(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def max_async_retry_attempts(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_async_retry_attempts", value)

    @property
    @pulumi.getter(name="enableAsyncStatusLog")
    def enable_async_status_log(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_async_status_log(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FgsAsyncInvokeConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The creation time of the asynchronous invocation, in RFC3339 format.
        :param pulumi.Input[builtins.bool] enable_async_status_log: Specifies whether to enable asynchronous invocation status persistence.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to configure the asynchronous invocation.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] updated_at: The latest update time of the asynchronous invocation, in RFC3339 format.
        """
...
class FgsAsyncInvokeConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            on_success: Optional[pulumi.Input[Union['FgsAsyncInvokeConfigurationOnSuccessArgs', 'FgsAsyncInvokeConfigurationOnSuccessArgsDict']]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'FgsAsyncInvokeConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="enableAsyncStatusLog")
    def enable_async_status_log(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable asynchronous invocation status persistence.
    ...
    @property
    @pulumi.getter(name="maxAsyncEventAgeInSeconds")
    def max_async_event_age_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the maximum validity period of a message.  
        The valid value is range from `1` to `86,400`.
        """
    ...
    @property
    @pulumi.getter(name="maxAsyncRetryAttempts")
    def max_async_retry_attempts(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the maximum number of retry attempts to be made if
        asynchronous invocation fails.
        The valid value is range from `0` to `3`.
