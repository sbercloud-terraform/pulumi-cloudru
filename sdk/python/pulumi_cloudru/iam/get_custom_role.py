...
def get_custom_role(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description: Description of the custom policy.
    :param builtins.str domain_id: The domain the policy belongs to.
    :param builtins.str id: ID of the custom policy.
    :param builtins.str name: Name of the custom policy.
    :param builtins.int references: The number of citations for the custom policy.
    :param builtins.str type: Display mode. Valid options are _AX_: Account level and _XA_: Project level.
    """
    __args__ = dict()
...
def get_custom_role_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
