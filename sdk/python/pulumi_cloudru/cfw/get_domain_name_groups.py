...
def get_domain_name_groups(config_status: Optional[builtins.str] = None,
...
def get_domain_name_groups_output(config_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
