...
class BucketObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl: The ACL policy to apply. Defaults to `private`.
        :param pulumi.Input[builtins.str] content: The literal content being uploaded to the bucket.
        :param pulumi.Input[builtins.str] content_type: A standard MIME type describing the format of the object data, e.g. application/octet-stream.
               All Valid MIME Types are valid for this input.
        :param pulumi.Input[builtins.str] etag: Specifies the unique identifier of the object content. It can be used to trigger updates.
               The only meaningful value is `md5(file("path_to_file"))`.
               
               Either `source` or `content` must be provided to specify the bucket content.
               These two arguments are mutually-exclusive.
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the kms key. If omitted, the default master key will be used.
        :param pulumi.Input[builtins.str] region: The region in which to create the OBS bucket object resource. If omitted, the provider-level region will be used. Changing this creates a new OBS bucket object resource.
        :param pulumi.Input[builtins.str] source: The path to the source file being uploaded to the bucket.
        :param pulumi.Input[builtins.str] storage_class: Specifies the storage class of the object. Defaults to `STANDARD`.
        """
...
class _BucketObjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the kms key. If omitted, the default master key will be used.
        :param pulumi.Input[builtins.str] region: The region in which to create the OBS bucket object resource. If omitted, the provider-level region will be used. Changing this creates a new OBS bucket object resource.
        :param pulumi.Input[builtins.int] size: the size of the object in bytes.
        :param pulumi.Input[builtins.str] source: The path to the source file being uploaded to the bucket.
        :param pulumi.Input[builtins.str] storage_class: Specifies the storage class of the object. Defaults to `STANDARD`.
