...
class ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: The protocol can either be TCP, UDP, HTTP or TERMINATED_HTTPS. Changing this
               creates a new listener.
        :param pulumi.Input[builtins.int] protocol_port: The port on which to listen for client traffic. Changing this creates a
               new listener.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the listener. A valid value is true (UP) or false (
               DOWN).
        :param pulumi.Input[builtins.int] connection_limit: The maximum number of connections allowed for the listener. The value ranges from
               -1 to 2,147,483,647. This parameter is reserved and has been not used. Only the administrator can specify the maximum
               number of connections.
        :param pulumi.Input[builtins.str] default_pool_id: The ID of the default pool with which the listener is associated.
               Changing this creates a new listener.
        :param pulumi.Input[builtins.str] default_tls_container_ref: Specifies the ID of the server certificate used by the listener. This
        ...
        :param pulumi.Input[builtins.str] name: Human-readable name for the listener. Does not have to be unique.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sni_container_refs: Lists the IDs of SNI certificates (server certificates with a domain name)
...
class Listener(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            tls_ciphers_policy: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Listener':
        """
