...
class ApiFuncGraphArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] version: Specifies the version of the API. A maximum of 16 characters are allowed.
        """
...
class GroupEnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] variable_id: The ID of the variable that the group has.  
               _Deprecated: Use `id` instead._
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
