...
class SqlAuditArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] keep_days: Specifies the number of days for storing audit logs. Value ranges from `1` to `732`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audit_types: Specifies the list of audit types. Value options: **CREATE_USER**, **DROP_USER**,
        ...
        :param pulumi.Input[builtins.bool] reserve_auditlogs: Specifies whether the historical audit logs will be reserved for some time
...
class SqlAudit(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            keep_days: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            reserve_auditlogs: Optional[pulumi.Input[builtins.bool]] = None) -> 'SqlAudit':
        """
