...
class ServiceDiscoveryRuleDiscoveryRuleArgs:
    def __init__(__self__, *,
                 ...
                 check_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] check_contents: Specifies the matched value. This is a list of strings.
        :param pulumi.Input[builtins.str] check_mode: Specifies the match condition. The values can be **contain** and **equals**.
        :param pulumi.Input[builtins.str] check_type: Specifies the match type. The values can be **cmdLine**, **env** and **scope**.
        """
...
class ServiceDiscoveryRuleLogPathRuleArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: Specifies the command. This is a list of strings.
        :param pulumi.Input[builtins.str] name_type: Specifies the value type, which can be **cmdLineHash**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies the log path. This is a list of strings.
...
class ServiceDiscoveryRuleNameRulesApplicationNameRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: Specifies the input value.
        :param pulumi.Input[builtins.str] name_type: Specifies the value type. The value can be **cmdLineHash**, **cmdLine**, **env**
               and **str**.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies the application name, which is mandatory only when the value of
               `name_type` is **cmdLineHash**.
        """
        pulumi.set(__self__, "args", args)
        pulumi.set(__self__, "name_type", name_type)
