...
class NodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies the cluster ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the flavor ID. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.int] initial_node_count: Specifies the initial number of expected nodes in the node pool.
        ...
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled. Valid values are "true" and "false".
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] availability_zone: Specifies the name of the available partition (AZ). Default value
               is random to create nodes in a random AZ in the node pool. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CCE node pool. Valid values are
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NodePoolDataVolumeArgs']]] data_volumes: Specifies the configuration of the data disks.
               The structure is described below. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ecs_group_id: Specifies the ECS group ID. If specified, the node will be created under
               the cloud server group. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID of the node pool.
        ...
        :param pulumi.Input['NodePoolHostnameConfigArgs'] hostname_config: Specifies the hostname config of the kubernetes node,
               ...
               The object structure is documented below.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] initialized_conditions: Specifies the custom initialization flags.
        :param pulumi.Input[builtins.str] key_pair: Specifies the key pair name when logging in to select the key pair mode.
               This parameter and `password` are alternative. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] label_policy_on_existing_nodes: Specifies the label policy on existing nodes.
               The value can be **ignore** and **refresh**, defaults to **refresh**.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies the tags of a Kubernetes node, key/value pair format.
        ...
        :param pulumi.Input[builtins.str] os: Specifies the operating system of the node.
        ...
        :param pulumi.Input[builtins.str] password: Specifies the root password when logging in to select the password mode.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the CCE node pool. If `period_unit` is set to
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the CCE node pool.
               Valid values are *month* and *year*. This parameter is mandatory if `charging_mode` is set to *prePaid*.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pod_security_groups: Specifies the list of security group IDs for the pod.
        ...
        :param pulumi.Input[builtins.int] priority: Specifies the weight of the node pool.
               A node pool with a higher weight has a higher priority during scaling.
        :param pulumi.Input[builtins.str] region: The region in which to create the CCE pool resource. If omitted, the
               provider-level region will be used. Changing this creates a new CCE node pool resource.
        :param pulumi.Input[builtins.str] runtime: Specifies the runtime of the CCE node pool. Valid values are *docker* and
               *containerd*. Changing this creates a new resource.
        :param pulumi.Input[builtins.int] scale_down_cooldown_time: Specifies the time interval between two scaling operations, in minutes.
        :param pulumi.Input[builtins.bool] scall_enable: Specifies whether to enable auto scaling.
               If Autoscaler is enabled, install the autoscaler add-on to use the auto scaling feature.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: Specifies the list of custom security group IDs for the node pool.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_lists: Specifies the ID list of the subnet to which the NIC belongs.
        :param pulumi.Input[builtins.str] tag_policy_on_existing_nodes: Specifies the tag policy on existing nodes.
               The value can be **ignore** and **refresh**, defaults to **ignore**.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of a VM node, key/value pair format.
        :param pulumi.Input[builtins.str] taint_policy_on_existing_nodes: Specifies the taint policy on existing nodes.
               The value can be **ignore** and **refresh**, defaults to **refresh**.
...
class _NodePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the name of the available partition (AZ). Default value
               is random to create nodes in a random AZ in the node pool. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] billing_mode: Billing mode of a node.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CCE node pool. Valid values are
               *prePaid* and *postPaid*, defaults to *postPaid*. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] cluster_id: Specifies the cluster ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] current_node_count: The current number of the nodes.
        :param pulumi.Input[Sequence[pulumi.Input['NodePoolDataVolumeArgs']]] data_volumes: Specifies the configuration of the data disks.
               The structure is described below. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ecs_group_id: Specifies the ECS group ID. If specified, the node will be created under
               the cloud server group. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: Specifies the list of custom security group IDs for the node pool.
               ...
               the rules of the port on which CCE running depends. For details, see
               [documentation](https://support.hc.sbercloud.ru/usermanual/cce/cce_faq_00265.html).
        :param pulumi.Input[builtins.str] status: Node status information.
        :param pulumi.Input['NodePoolStorageArgs'] storage: Specifies the disk initialization management parameter.
               If omitted, disks are managed based on the DockerLVMConfigOverride parameter in extendParam.
               This parameter is supported for clusters of v1.15.11 and later. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of the subnet to which the NIC belongs.
...
class NodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            taint_policy_on_existing_nodes: Optional[pulumi.Input[builtins.str]] = None,
            taints: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NodePoolTaintArgs', 'NodePoolTaintArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NodePool':
        """
