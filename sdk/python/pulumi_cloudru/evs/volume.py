...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] volume_type: Specifies the disk type.
        ...
        :param pulumi.Input[builtins.str] backup_id: The backup ID from which to create the volume.
               Changing this creates a new volume.
        :param pulumi.Input[builtins.bool] cascade: Specifies the delete mode of snapshot. The default value is false. All snapshot
               associated with the disk will also be deleted when the parameter is set to true.
        :param pulumi.Input[builtins.str] description: Specifies the disk description. The value can contain a maximum of 255 bytes.
        :param pulumi.Input[builtins.str] device_type: The device type of volume to create. Valid options are VBD and SCSI.
               Defaults to VBD. Changing this creates a new volume.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the disk. Changing this
               creates a new disk.
        :param pulumi.Input[builtins.str] image_id: The image ID from which to create the volume.
               Changing this creates a new volume.
        :param pulumi.Input[builtins.str] kms_id: The Encryption KMS ID to create the volume.
               Changing this creates a new volume.
        :param pulumi.Input[builtins.bool] multiattach: Default:false. Specifies the shared EVS disk information.
               Changing this creates a new volume.
        :param pulumi.Input[builtins.str] name: Specifies the disk name.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the EVS volume resource. If omitted, the provider-level region will be used. Changing this creates a new EVS resource.
        :param pulumi.Input[builtins.int] size: Specifies the disk size, in GB. Its value can be as follows:
...
class _VolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] volume_type: Specifies the disk type.
               ...
               - SATA: specifies the common I/O disk type.
               If the specified disk type is not available in the AZ, the disk will fail to create.
        :param pulumi.Input[builtins.str] wwn: Specifies the unique identifier used for mounting the EVS disk.
        """
...
class Volume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            volume_type: Optional[pulumi.Input[builtins.str]] = None,
            wwn: Optional[pulumi.Input[builtins.str]] = None) -> 'Volume':
        """
