...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_network_type: Specifies the container network type.
        ...
        :param pulumi.Input[builtins.str] flavor_id: Specifies the cluster specifications.
               Possible values:
        ...
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of the subnet used to create the node which should be
               configured with a *DNS address*. Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC used to create the node.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] alias: Specifies the display name of a cluster. The value of `alias` cannot be the same as the `name`
               and display names of other clusters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: schema: Internal
        :param pulumi.Input[builtins.str] authenticating_proxy_ca: Specifies the CA root certificate provided in the
               **authenticating_proxy** mode. The input value can be a Base64 encoded string or not.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] authenticating_proxy_cert: Specifies the Client certificate provided in the
               **authenticating_proxy** mode. The input value can be a Base64 encoded string or not.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] authenticating_proxy_private_key: Specifies the private key of the client certificate
               provided in the **authenticating_proxy** mode. The input value can be a Base64 encoded string or not.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] authentication_mode: Specifies the authentication mode of the cluster, possible values
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CCE cluster.
               Valid values are **prePaid** and **postPaid**, defaults to **postPaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] cluster_type: Specifies the cluster Type, possible values are **VirtualMachine** and
               **ARM64**. Defaults to **VirtualMachine**. Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] cluster_version: Specifies the cluster version, defaults to the latest supported
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterComponentConfigurationArgs']]] component_configurations: Specifies the kubernetes component configurations.
               ...
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] container_network_cidr: Specifies the container network segments.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_sans: Specifies the custom san to add to certificate (array of string).
        :param pulumi.Input[builtins.str] delete_all: Specified whether to delete all associated storage resources when deleting the CCE
               cluster. valid values are **true**, **try** and **false**. Default is **false**.
        :param pulumi.Input[builtins.str] delete_efs: Specified whether to unbind associated SFS Turbo file systems when deleting the CCE
               cluster. valid values are **true**, **try** and **false**. Default is **false**.
        :param pulumi.Input[builtins.str] delete_eni: schema: Internal
        :param pulumi.Input[builtins.str] delete_evs: Specified whether to delete associated EVS disks when deleting the CCE cluster.
               valid values are **true**, **try** and **false**. Default is **false**.
        :param pulumi.Input[builtins.str] delete_net: schema: Internal
        :param pulumi.Input[builtins.str] delete_obs: Specified whether to delete associated OBS buckets when deleting the CCE cluster.
               valid values are **true**, **try** and **false**. Default is **false**.
        :param pulumi.Input[builtins.str] delete_sfs: Specified whether to delete associated SFS file systems when deleting the CCE
               cluster. valid values are **true**, **try** and **false**. Default is **false**.
        :param pulumi.Input[builtins.str] description: Specifies the cluster description.
        :param pulumi.Input[builtins.str] eip: Specifies the EIP address of the cluster.
        :param pulumi.Input[builtins.str] eni_subnet_cidr: The ENI network segment. This value is valid when only one eni_subnet_id is specified.
        :param pulumi.Input[builtins.str] eni_subnet_id: Specifies the **IPv4 subnet ID** of the subnet where the ENI resides.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project ID of the CCE cluster.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterExtendParamArgs']]] extend_params: Specifies the extended parameter.
               The object structure is documented below.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.bool] hibernate: Specifies whether to hibernate the CCE cluster. Defaults to **false**. After a cluster is
        ...
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to enable IPv6 in the cluster.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] kube_proxy_mode: Specifies the service forwarding mode.
        ...
        :param pulumi.Input[builtins.bool] multi_az: Specifies whether to enable multiple AZs for the cluster, only when using HA
        ...
        :param pulumi.Input[builtins.str] name: Specifies the component name.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the CCE cluster.
               If `period_unit` is set to **month**, the value ranges from 1 to 9.
               If `period_unit` is set to **year**, the value ranges from 1 to 3.
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the CCE cluster.
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the CCE cluster resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the default worker node security group ID of the cluster.
        ...
        :param pulumi.Input[builtins.str] service_network_cidr: Specifies the service network segment.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.bool] support_istio: Specifies whether to support Istio in the cluster.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the CCE cluster, key/value pair format.
        """
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authentication_mode: Specifies the authentication mode of the cluster, possible values
               ...
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled. Valid values are **true** and **false**.
        :param pulumi.Input[builtins.str] category: The category of the cluster. The value can be **CCE** and **Turbo**.
        ...
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to enable IPv6 in the cluster.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] kube_config_raw: Raw Kubernetes config to be used by kubectl and other compatible tools.
        :param pulumi.Input[builtins.str] kube_proxy_mode: Specifies the service forwarding mode.
               Changing this parameter will create a new cluster resource. Two modes are available:
        ...
        :param pulumi.Input[builtins.str] service_network_cidr: Specifies the service network segment.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] status: Cluster status information.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of the subnet used to create the node which should be
               configured with a *DNS address*. Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.bool] support_istio: Specifies whether to support Istio in the cluster.
               Changing this parameter will create a new cluster resource.
