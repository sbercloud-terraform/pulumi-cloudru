...
class InstanceBackupStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] start_time: Specifies the backup time window. Automated backups will be triggered during the
               backup time window. It must be a valid value in the **hh:mm-HH:MM**
               format. The current time is in the UTC format. The HH value must be 1 greater than the hh value. The values of mm and
               MM must be the same and must be set to any of the following: 00, 15, 30, or 45. Example value: 08:15-09:15 23:00-00:
               00.
        :param pulumi.Input[builtins.int] keep_days: Specifies the retention days for specific backup files. The value range is from 0 to 732.
               
               > **NOTE:** Primary/standby DB instances of Microsoft SQL Server do not support disabling the automated backup
               policy.
        :param pulumi.Input[builtins.str] period: Specifies the backup cycle. Automatic backups will be performed on the specified days of
               the week, except when disabling the automatic backup policy. The value range is a comma-separated number, where each
               number represents a day of the week. For example, a value of 1,2,3,4 would set the backup cycle to Monday, Tuesday,
               Wednesday, and Thursday. The default value is 1,2,3,4,5,6,7.
        """
...
class InstanceDbArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the DB engine. Available value are **MySQL**, **PostgreSQL**
               and **SQLServer**. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] version: Specifies the database version. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.str] password: Specifies the database password. The value should contain 8 to 32 characters,
               including uppercase and lowercase letters, digits, and the following special characters: ~!@#%^*-_=+? You are advised
               to enter a strong password to improve security, preventing security risks such as brute force cracking.
        :param pulumi.Input[builtins.int] port: Specifies the database port.
               + The MySQL database port ranges from 1024 to 65535 (excluding 12017 and 33071, which are occupied by the RDS system
               and cannot be used). The default value is 3306.
               + The PostgreSQL database port ranges from 2100 to 9500. The default value is 5432.
               + The Microsoft SQL Server database port can be 1433 or ranges from 2100 to 9500, excluding 5355 and 5985. The
...
class InstanceMsdtcHostArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host_name: Specifies the host name.
        :param pulumi.Input[builtins.str] ip: Specifies the host IP address.
        :param pulumi.Input[builtins.str] id: Indicates the host ID.
        """
...
class InstanceNodeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] availability_zone: Specifies the list of AZ name. Changing this parameter will create a
               new resource.
        :param pulumi.Input[builtins.str] id: Indicates the host ID.
        :param pulumi.Input[builtins.str] name: Specifies the DB instance name. The DB instance name of the same type must be unique for
               the same tenant. The value must be 4 to 64 characters in length and start with a letter. It is case-sensitive and can
               contain only letters, digits, hyphens (-), and underscores (_).
        :param pulumi.Input[builtins.str] role: Indicates the node type. The value can be master or slave, indicating the primary node or standby node
               respectively.
...
class InstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the parameter name. Some of them needs the instance to be restarted
               to take effect.
        :param pulumi.Input[builtins.str] value: Specifies the parameter value.
...
class InstanceRestoreArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backup_id: Specifies the ID of the backup used to restore data. Changing this
               parameter will create a new resource.
        :param pulumi.Input[builtins.str] instance_id: Specifies the source DB instance ID. Changing this parameter will create
               a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] database_name: Specifies the database to be restored. This parameter applies only to
               Microsoft SQL Server databases. Changing this parameter will create a new resource.
        """
...
class InstanceVolumeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size: Specifies the volume size. Its value range is from 40 GB to 4000 GB. The value must be a
               multiple of 10 and greater than the original size.
        :param pulumi.Input[builtins.str] type: Specifies the volume type. Its value can be any of the following and is
               case-sensitive:
               + **CLOUDSSD**: cloud SSD storage. This storage type is supported only with general-purpose and dedicated DB
               instances (MySQL and PostreSQL).
               + **ESSD**: extreme SSD storage. Supported by: MySQL primary/standby, PostgeSQL (both single and primary/standby).
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] disk_encryption_id: Specifies the key ID for disk encryption.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] limit_size: Specifies the upper limit of automatic expansion of storage, in GB.
        :param pulumi.Input[builtins.int] trigger_threshold: Specifies the threshold to trigger automatic expansion.  
               If the available storage drops to this threshold or `10` GB, the automatic expansion is triggered.
               The valid values are as follows:
               + **10**
               + **15**
...
class MysqlDatabasePrivilegeUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] readonly: Specifies the read-only permission. The value can be:
               + **true**: indicates the read-only permission.
               + **false**: indicates the read and write permission.
...
class ParametergroupConfigurationParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] description: The parameter group description. It contains a maximum of 256 characters and cannot contain the following special characters:>!<"&'= the value is left blank by default.
        :param pulumi.Input[builtins.str] name: The parameter group name. It contains a maximum of 64 characters.
        :param pulumi.Input[builtins.bool] readonly: Indicates whether the parameter is read-only.
        :param pulumi.Input[builtins.bool] restart_required: Indicates whether a restart is required.
        ...
        :param pulumi.Input[builtins.str] value_range: Indicates the parameter value range.
        """
...
class ParametergroupDatastoreArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: The DB engine. Currently, MySQL, PostgreSQL, and Microsoft SQL Server are supported. The value is case-insensitive and can be mysql, postgresql, or sqlserver.
        :param pulumi.Input[builtins.str] version: Specifies the database version.
...
class PgAccountAttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] rol_inherit: Indicates whether a user automatically inherits the permissions of the role to which the user belongs.
...
class ReadReplicaInstanceDbArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] port: Indicates the database port information.
        :param pulumi.Input[builtins.str] type: Indicates the DB engine. Value: MySQL, PostgreSQL, SQLServer.
        :param pulumi.Input[builtins.str] user_name: Indicates the default user name of database.
        :param pulumi.Input[builtins.str] version: Indicates the database version.
        """
        if port is not None:
            pulumi.set(__self__, "port", port)
        if type is not None:
...
class ReadReplicaInstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the DB instance name. The DB instance name of the same type
               must be unique for the same tenant. The value must be 4 to 64 characters in length and start with a letter.
               It is case-sensitive and can contain only letters, digits, hyphens (-), and underscores (_).
               Changing this parameter will create a new resource.
        """
...
class ReadReplicaInstanceVolumeArgs:
    def __init__(__self__, *,
                 ...
                 trigger_threshold: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the volume type. Its value can be any of the following and is case-sensitive:
               - *ESSD* - ultrahigh I/O.
               - *CLOUDSSD* - high I/O.
...
class SqlserverDatabasePrivilegeUserArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the username of the database account.
        :param pulumi.Input[builtins.bool] readonly: Specifies the read-only permission. Value options:
               + **true**: indicates the read-only permission.
               + **false**: indicates the read and write permission.
