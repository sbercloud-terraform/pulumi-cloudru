...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Specifies the protection type of the CBR policy.
               Valid values are **backup** and **replication**.
               Changing this will create a new policy.
        :param pulumi.Input[builtins.int] backup_quantity: Specifies the maximum number of retained backups. The value ranges from `2` to
               `99,999`. This parameter and `time_period` are alternative.
        :param pulumi.Input[builtins.str] destination_project_id: Specifies the ID of the replication destination project, which is
               mandatory for cross-region replication. Required if `protection_type` is **replication**.
        :param pulumi.Input[builtins.str] destination_region: Specifies the name of the replication destination region, which is mandatory
        ...
        :param pulumi.Input[builtins.bool] enabled: Specifies whether to enable the CBR policy. Default to **true**.
        ...
        :param pulumi.Input[builtins.str] name: Specifies a unique name of the CBR policy. This parameter can contain a maximum of 64
               characters, which may consist of chinese characters, letters, digits, underscores(_) and hyphens (-).
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the CBR policy. If omitted, the
               provider-level region will be used. Changing this will create a new policy.
        :param pulumi.Input[builtins.int] time_period: Specifies the duration (in days) for retained backups. The value ranges from `2` to
               `99,999`.
               
               > **NOTE:** If this `backup_quantity` and `time_period` are both left blank, the backups will be retained permanently.
        :param pulumi.Input[builtins.str] time_zone: Specifies the UTC time zone, e.g.: `UTC+08:00`.
...
class Policy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['PolicyBackupCycleArgs', 'PolicyBackupCycleArgsDict']] backup_cycle: Specifies the scheduling rule for the CBR policy backup execution.
               The object structure is documented below.
        :param pulumi.Input[builtins.int] backup_quantity: Specifies the maximum number of retained backups. The value ranges from `2` to
               `99,999`. This parameter and `time_period` are alternative.
        :param pulumi.Input[builtins.str] destination_project_id: Specifies the ID of the replication destination project, which is
