...
def get_gateway(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description: Specifies the description of the nat
           gateway. The value contains 0 to 255 characters, and angle brackets (<)
           and (>) are not allowed.
    :param builtins.str enterprise_project_id: Specifies the enterprise project
           ID of the NAT gateway.
    :param builtins.str id: Specifies the ID of the NAT gateway.
    :param builtins.str internal_network_id: Specifies the network ID of the
           downstream interface (the next hop of the DVR) of the NAT gateway.
    :param builtins.str name: Specifies the nat gateway name. The name can
           contain only digits, letters, underscores (_), and hyphens(-).
    :param builtins.str region: Specifies the region in which to create the Nat
           gateway resource. If omitted, the provider-level region will be used.
    :param builtins.str router_id: Specifies the ID of the router this nat
           gateway belongs to.
    :param builtins.str spec: The NAT gateway type.
           The value can be:
    :param builtins.str status: Specifies the status of the NAT gateway.
    """
    __args__ = dict()
...
def get_gateway_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
