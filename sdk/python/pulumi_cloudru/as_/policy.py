...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scaling_group_id: Specifies the AS group ID. Changing this creates a new AS policy.
        :param pulumi.Input[builtins.str] scaling_policy_name: Specifies the name of the AS policy. The name contains only letters, digits,
               underscores(_), and hyphens(-), and cannot exceed 64 characters.
        :param pulumi.Input[builtins.str] scaling_policy_type: Specifies the AS policy type. The value can be `ALARM`, `SCHEDULED` or `RECURRENCE`.
        ...
        :param pulumi.Input[builtins.str] alarm_id: Specifies the alarm rule ID. This parameter is mandatory when `scaling_policy_type`
               is set to `ALARM`.
        :param pulumi.Input[builtins.int] cool_down_time: Specifies the cooling duration (in seconds).
               The value ranges from 0 to 86400 and is 300 by default.
               
               <a name="scheduled_policy_object"></a>
               The `scheduled_policy` block supports:
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the AS policy. If omitted, the
...
class _PolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PolicyScheduledPolicyArgs'] scheduled_policy: Specifies the periodic or scheduled AS policy.
               This parameter is mandatory when `scaling_policy_type` is set to `SCHEDULED` or `RECURRENCE`.
               The object structure is documented below.
        :param pulumi.Input[builtins.str] status: The AS policy status. The value can be *INSERVICE*, *PAUSED* or *EXECUTING*.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if alarm_id is not None:
...
class Policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scaling_policy_type: Optional[pulumi.Input[builtins.str]] = None,
            scheduled_policy: Optional[pulumi.Input[Union['PolicyScheduledPolicyArgs', 'PolicyScheduledPolicyArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Policy':
        """
