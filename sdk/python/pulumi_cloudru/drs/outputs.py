...
class JobDestinationDb(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str engine_type: Specifies the migration engine type.
        ...
        :param builtins.str ip: Specifies the IP of database. Changing this parameter will create a new resource.
        :param builtins.str password: Specifies the password of database.
               Changing this parameter will create a new resource.
        :param builtins.int port: Specifies the port of database. Changing this parameter will create a new resource.
        :param builtins.str user: Specifies the user name of database.
               Changing this parameter will create a new resource.
        :param builtins.str instance_id: Specifies the instance id of database when it is a RDS database.
               Changing this parameter will create a new resource.
        :param builtins.str name: Specifies the job name. The name consists of 4 to 50 characters, starting with
               a letter. Only letters, digits, underscores (\\_) and hyphens (-) are allowed.
        :param builtins.str region: The region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this parameter will create a new resource.
        :param builtins.str ssl_cert_check_sum: Specifies the checksum of SSL certificate content.
               It is mandatory when `ssl_enabled` is `true`. Changing this parameter will create a new resource.
        :param builtins.str ssl_cert_key: Specifies the SSL certificate content, encrypted with base64.
               It is mandatory when `ssl_enabled` is `true`. Changing this parameter will create a new resource.
        :param builtins.str ssl_cert_name: Specifies SSL certificate name.
               It is mandatory when `ssl_enabled` is `true`. Changing this parameter will create a new resource.
        :param builtins.str ssl_cert_password: Specifies SSL certificate password. It is mandatory when
               `ssl_enabled` is `true` and the certificate file suffix is `.p12`. Changing this parameter will create a new resource.
        :param builtins.bool ssl_enabled: Specifies whether to enable SSL connection.
               Changing this parameter will create a new resource.
        :param builtins.str subnet_id: Specifies subnet ID of database when it is a RDS database.
...
class JobLimitSpeed(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str end_time: Specifies the time to end speed limit, this time is UTC time. The input must
               end at 59 minutes, the format is `hh:mm`, for example: 15:59. Changing this parameter will create a new resource.
        :param builtins.str speed: Specifies the transmission speed, the value range is 1 to 9999, unit: `MB/s`.
               Changing this parameter will create a new resource.
        :param builtins.str start_time: Specifies the time to start speed limit, this time is UTC time. The start
