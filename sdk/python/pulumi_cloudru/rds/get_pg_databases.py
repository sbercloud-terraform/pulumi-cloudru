...
def get_pg_databases(character_set: Optional[builtins.str] = None,
...
def get_pg_databases_output(character_set: Optional[pulumi.Input[Optional[builtins.str]]] = None,
