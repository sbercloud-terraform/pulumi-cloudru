...
class BucketPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Specifies the name of the bucket to which to apply the policy.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the OBS bucket policy resource. If omitted, the provider-level region will be used. Changing this creates a new OBS bucket policy resource.
        """
