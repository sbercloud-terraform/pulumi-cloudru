...
class MysqlBinlogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] binlog_retention_hours: Specifies the binlog retention period. Value range: `1` to `168` (7x24).
        :param pulumi.Input[builtins.str] instance_id: Specifies the RDS MySQL instance ID. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the RDS binlog resource. If omitted, the
...
class MysqlBinlog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            binlog_retention_hours: Optional[pulumi.Input[builtins.int]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'MysqlBinlog':
        """
