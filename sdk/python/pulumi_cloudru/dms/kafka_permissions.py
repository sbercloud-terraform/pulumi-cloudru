...
class KafkaPermissionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the DMS kafka instance to which the permissions belongs.
        ...
        :param pulumi.Input[builtins.str] topic_name: Specifies the name of the topic to which the permissions belongs.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS kafka permissions resource. If omitted, the
...
class KafkaPermissions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['KafkaPermissionsPolicyArgs', 'KafkaPermissionsPolicyArgsDict']]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'KafkaPermissions':
        """
