...
def get_eips(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: Specifies an array of one or more IDs of the desired EIP.
    :param builtins.int ip_version: Specifies ip version of the desired EIP. The options are:
    :param Sequence[builtins.str] port_ids: Specifies an array of one or more port ids which bound to the desired EIP.
    :param Sequence[builtins.str] public_ips: Specifies an array of one or more public ip addresses of the desired EIP.
    :param builtins.str region: Specifies the region in which to obtain the EIP. If omitted, the provider-level region
           will be used.
...
def get_eips_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
