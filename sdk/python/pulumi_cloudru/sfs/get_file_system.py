...
def get_file_system(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The UUID of the shared file system.
    :param builtins.str name: The name of the shared file system.
    :param builtins.str region: Specifies the region in which to obtain the shared file system.
           If omitted, the provider-level region will be used.
    :param builtins.str status: The status of the shared file system.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_file_system_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
