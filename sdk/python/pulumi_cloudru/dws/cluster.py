...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: AZ in a cluster.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] network_id: Network ID, which is used for configuring cluster network.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] node_type: Node type.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.int] number_of_node: Number of nodes in a cluster. The value ranges from 3 to 32. When expanding,
               add at least 3 nodes.
        :param pulumi.Input[builtins.str] security_group_id: ID of a security group. The ID is used for configuring cluster
               network.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] user_name: Administrator username for logging in to a data warehouse cluster The
               ...
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] user_pwd: Administrator password for logging in to a data warehouse cluster A password
               ...
               ~!@#%^&*()-_=+|[{}];:,<.>/?
        :param pulumi.Input[builtins.str] vpc_id: VPC ID, which is used for configuring cluster network.
               Changing this creates a new cluster resource.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the dws cluster,
        ...
        :param pulumi.Input[builtins.str] name: Cluster name, which must be unique and contains 4 to 64 characters, which
               consist of letters, digits, hyphens(-), or underscores(_) only and must start with a letter.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.int] number_of_cn: The number of CN. If you use a large-scale cluster, deploy multiple CNs.
               Changing this creates a new cluster resource.
        ...
        :param pulumi.Input['ClusterPublicIpArgs'] public_ip: A nested object resource Structure is documented below.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the cluster resource. If omitted, the
        ...
        :param pulumi.Input[builtins.str] version: Data warehouse version.
        """
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: AZ in a cluster.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] created: Cluster creation time. The format is ISO8601:YYYY-MM-DDThh:mm:ssZ
        :param pulumi.Input[builtins.str] description: The description of the cluster.
        :param pulumi.Input[builtins.str] dss_pool_id: Dedicated storage pool ID.
        :param pulumi.Input[builtins.str] elb_id: The ID of the ELB load balancer.
        ...
        :param pulumi.Input[builtins.int] port: Service port of a cluster (8000 to 10000). The default value is 8000.
               Changing this creates a new cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: List of private network IP address.
        ...
        :param pulumi.Input['ClusterPublicIpArgs'] public_ip: A nested object resource Structure is documented below.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.int] recent_event: The recent event number.
        :param pulumi.Input[builtins.str] region: The region in which to create the cluster resource. If omitted, the
               provider-level region will be used. Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] security_group_id: ID of a security group. The ID is used for configuring cluster
               network.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] status: Cluster status, which can be one of the following:  CREATING AVAILABLE UNAVAILABLE CREATION FAILED.
        :param pulumi.Input[builtins.str] sub_status: Sub-status of clusters in the AVAILABLE state. The value can be one of the following:  NORMAL READONLY
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the cluster.
        :param pulumi.Input[builtins.str] task_status: Cluster management task. The value can be one of the following:
        ...
        :param pulumi.Input[builtins.str] updated: Last modification time of a cluster. The format is ISO8601:YYYY-MM-DDThh:mm:ssZ
        :param pulumi.Input[builtins.str] user_name: Administrator username for logging in to a data warehouse cluster The
               administrator username must:  Consist of lowercase letters, digits, or underscores. Start with a lowercase letter or
               an underscore. Contain 1 to 63 characters. Cannot be a keyword of the DWS database.
               Changing this creates a new cluster resource.
