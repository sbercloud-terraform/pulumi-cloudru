...
class PgDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] character_set: Specifies the database character set.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the database description. The value contains 0 to 512 characters.
        :param pulumi.Input[builtins.bool] is_revoke_public_privilege: Specifies whether to revoke the PUBLIC CREATE permission of
               the public schema.
        ...
        :param pulumi.Input[builtins.str] lc_ctype: Specifies the database classification.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the database name. The value contains 1 to 63 characters, including
               ...
               **template1**.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] owner: Specifies the database user. The value must be an existing username and must be different
        ...
        :param pulumi.Input[builtins.str] template: Specifies the name of the database template. Value options: **template0**,
...
class PgDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None) -> 'PgDatabase':
        """
