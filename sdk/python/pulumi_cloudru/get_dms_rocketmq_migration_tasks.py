...
def get_dms_rocketmq_migration_tasks(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: Specifies the RocketMQ instance ID.
    ...
    :param builtins.str task_id: Specifies the RocketMQ migration task ID.
...
def get_dms_rocketmq_migration_tasks_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
