...
def get_node_pool(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str node_pool_id: Specifies the ID of the node pool.
    :param builtins.str region: Specifies the region in which to obtain the CCE node pools.
           If omitted, the provider-level region will be used.
    :param builtins.str status: Specifies the state of the node pool.
    """
    __args__ = dict()
