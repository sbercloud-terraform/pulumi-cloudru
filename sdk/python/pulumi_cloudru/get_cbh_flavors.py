...
def get_cbh_flavors(action: Optional[builtins.str] = None,
    ...
    :param builtins.str action: Specifies the action of querying instances specification information.
    ...
    :param builtins.str flavor_id: Specifies the ID of the specification of CBH.
    ...
    :param builtins.str spec_code: Specifies the ID of the CBH specification, the query result shows all specifications
