...
class SparkJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_name: Specifies the name of the package that is of the JAR or python file type and
        ...
        :param pulumi.Input[builtins.str] queue_name: Specifies the DLI queue name.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] app_parameters: Specifies the input parameters of the main class.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] configurations: Specifies the configuration items of the DLI spark.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SparkJobDependentPackageArgs']]] dependent_packages: Specifies a list of package resource objects.
               ...
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.int] driver_cores: Specifies the number of CPU cores of the Spark application driver.
               ...
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] driver_memory: Specifies the driver memory of the spark application.
               The default value of this value corresponds to the configuration of the selected `specification`.
               If you set this value instead of the default value, `specification` will be invalid.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.int] executor_cores: Specifies the number of CPU cores of each executor in the Spark
               application. The default value of this value corresponds to the configuration of the selected `specification`.
               If you set this value instead of the default value, `specification` will be invalid.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] executor_memory: Specifies the executor memory of the spark application.
               application. The default value of this value corresponds to the configuration of the selected `specification`.
               If you set this value instead of the default value, `specification` will be invalid.
               Changing this parameter will submit a new spark job.
               
               ->**NOTE:** The unit must be provided, such as **GB** or **MB**.
        :param pulumi.Input[builtins.int] executors: Specifies the number of executors in a spark application.
               The default value of this value corresponds to the configuration of the selected `specification`.
               If you set this value instead of the default value, `specification` will be invalid.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] feature: Specifies the feature name for the Spark Job.
               Required for Spark 3. Known values: `basic`, `ai`, `custom`.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] files: Specifies a list of the other dependencies name which has been uploaded to the
               DLI resource management system. The OBS paths are allowed, for example, `obs://<bucket name>/<dependent files>`.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jars: Specifies a list of the jar package name which has been uploaded to the DLI
               resource management system. The OBS paths are allowed, for example, `obs://<bucket name>/<package name>`.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] main_class: Specifies the main class of the spark job.
               Required if the `app_name` is the JAR type.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.int] max_retries: Specifies the maximum retry times.
               The default value of this value corresponds to the configuration of the selected `specification`.
               If you set this value instead of the default value, `specification` will be invalid.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] modules: Specifies a list of modules that depend on system resources.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the spark job name.
               The value contains a maximum of 128 characters.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] python_files: Specifies a list of the python file name which has been uploaded to the
               DLI resource management system. The OBS paths are allowed, for example, `obs://<bucket name>/<python file name>`.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to submit a spark job.
               If omitted, the provider-level region will be used.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] spark_version: Version of Spark to use.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] specification: Specifies the compute resource type for spark application.
...
class _SparkJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] configurations: Specifies the configuration items of the DLI spark.
               ...
               this argument. If you want to enable the `access metadata` of DLI spark in SberCloud, please set
               `spark.dli.metaAccess.enable` to `true`. Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] created_at: Time of the DLI spark job submit.
        :param pulumi.Input[Sequence[pulumi.Input['SparkJobDependentPackageArgs']]] dependent_packages: Specifies a list of package resource objects.
               The object structure is documented below.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.int] driver_cores: Specifies the number of CPU cores of the Spark application driver.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the spark job name.
               The value contains a maximum of 128 characters.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] owner: The owner of the spark job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] python_files: Specifies a list of the python file name which has been uploaded to the
               DLI resource management system. The OBS paths are allowed, for example, `obs://<bucket name>/<python file name>`.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] queue_name: Specifies the DLI queue name.
...
class SparkJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            spark_version: Optional[pulumi.Input[builtins.str]] = None,
            specification: Optional[pulumi.Input[builtins.str]] = None) -> 'SparkJob':
        """
