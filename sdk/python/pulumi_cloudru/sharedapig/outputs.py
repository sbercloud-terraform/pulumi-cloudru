...
class ApiBackendParam(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Specifies the name of the API. An API name consists of 3–64 characters, starting with a
        ...
        :param builtins.str description: Specifies the description of the API. The description cannot exceed 255 characters.
        """
...
class ApiFuncGraph(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str request_protocol: Specifies the request protocol. The value can be 'HTTP', 'HTTPS', and 'BOTH'
        ...
        :param builtins.str version: Specifies the version of the API. A maximum of 16 characters are allowed.
        """
...
class ApiWeb(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str request_method: Specifies the request method, including 'GET','POST','PUT' and etc..
        :param builtins.str request_protocol: Specifies the request protocol. The value can be 'HTTP', 'HTTPS', and 'BOTH'
               which means the API can be accessed through both 'HTTP' and 'HTTPS'. Defaults to 'HTTPS'.
...
class GroupEnvironmentVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str variable_id: The ID of the variable that the group has.  
