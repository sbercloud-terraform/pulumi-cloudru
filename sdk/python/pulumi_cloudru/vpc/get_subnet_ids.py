...
def get_subnet_ids(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: The region in which to obtain the subnet ids. If omitted, the provider-level region will
           be used.
    :param builtins.str vpc_id: Specifies the VPC ID used as the query filter.
    """
    __args__ = dict()
...
def get_subnet_ids_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
