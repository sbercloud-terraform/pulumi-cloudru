...
class InstanceBackupPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] backup_ats: Day in a week on which backup starts, the value ranges from `1` to `7`.
               Where: 1 indicates Monday; 7 indicates Sunday.
        :param pulumi.Input[builtins.str] begin_at: Time at which backup starts.
               Format: `hh24:00-hh24:00`, "00:00-01:00" indicates that backup starts at 00:00:00.
               
               <a name="DcsInstance_Parameters"></a>
               The `parameters` block supports:
        :param pulumi.Input[builtins.str] backup_type: Backup type. Default value is `auto`. The valid values are as follows:
        :param pulumi.Input[builtins.str] period_type: Interval at which backup is performed. Default value is `weekly`.
               Currently, only weekly backup is supported.
        :param pulumi.Input[builtins.int] save_days: Retention time. Unit: day, the value ranges from `1` to `7`.
               This parameter is required if the backup_type is **auto**.
        """
...
class InstanceBandwidthInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] bandwidth: Indicates the bandwidth size, the unit is **GB**.
        :param pulumi.Input[builtins.str] begin_time: Indicates the begin time of temporary increase.
        :param pulumi.Input[builtins.str] current_time: Indicates the current time.
        :param pulumi.Input[builtins.str] end_time: Indicates the end time of temporary increase.
        :param pulumi.Input[builtins.int] expand_count: Indicates the number of increases.
        :param pulumi.Input[builtins.int] expand_effect_time: Indicates the interval between temporary increases, the unit is **ms**.
        :param pulumi.Input[builtins.int] expand_interval_time: Indicates the time interval to the next increase, the unit is **ms**.
        :param pulumi.Input[builtins.int] max_expand_count: Indicates the maximum number of increases.
        :param pulumi.Input[builtins.str] next_expand_time: Indicates the next increase time.
        :param pulumi.Input[builtins.bool] task_running: Indicates whether the increase task is running.
        """
...
class InstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: A resource ID in UUID format.
        :param pulumi.Input[builtins.str] name: Specifies the name of an instance.
               The name must be 4 to 64 characters and start with a letter.
               Only english, letters (case-insensitive), digits, underscores (_) ,and hyphens (-) are allowed.
        :param pulumi.Input[builtins.str] value: Specifies the value of the configuration item.
        """
...
class InstanceWhitelistArgs:
    def __init__(__self__, *,
                 ...
                 ip_addresses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] group_name: Specifies the name of IP address group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: Specifies the list of IP address or CIDR which can be whitelisted for an instance.
               The maximum is 20.
        """
