...
def get_protection_rules(action_type: Optional[builtins.str] = None,
    ...
    :param builtins.str action_type: Specifies the rule action type.
           ...
           + **0**: allow;
           + **1**: deny.
    :param builtins.str destination: Specifies the destination address.
    ...
    :param builtins.str source: Specifies the source address.
...
def get_protection_rules_output(action_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
