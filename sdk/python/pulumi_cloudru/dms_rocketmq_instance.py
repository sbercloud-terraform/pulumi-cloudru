...
class DmsRocketmqInstanceArgs:
    def __init__(__self__, *,
                 ...
                 enable_publicip: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 publicip_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 retention_policy: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the list of availability zone names, where
               instance brokers reside and which has available resources.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of the RocketMQ engine.
               Valid values are **4.8.0** and **5.x**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the flavor ID.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage capacity, Unit: GB.
               When `engine_version` is **4.8.0**, value ranges from `300` to `30,000`.
               When `engine_version` is **5.x**, value ranges from `200` to `60,000`.
        :param pulumi.Input[builtins.str] storage_spec_code: Specifies the storage I/O specification.
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled. Valid values are "true" and "false".
        :param pulumi.Input[builtins.int] broker_num: Specifies the broker numbers. It's **required** when instance architecture is
               **cluster**. Defaults to `1` when instance architecture is **single node**.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are *prePaid*
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the DMS RocketMQ instance.
               The description can contain a maximum of `1,024` characters.
        :param pulumi.Input[builtins.bool] enable_acl: Specifies whether access control is enabled.
        :param pulumi.Input[builtins.bool] enable_publicip: Specifies whether to enable public access. By default, public access is disabled.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the instance.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to support IPv6. Defaults to **false**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the config name.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the instance. If `period_unit` is set to *month*
        ...
        :param pulumi.Input[builtins.str] publicip_id: Specifies the ID of the EIP bound to the instance. Use commas (,) to separate
        ...
        :param pulumi.Input[builtins.bool] retention_policy: Specifies whether access control is enabled.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether the RocketMQ SASL_SSL is enabled. Defaults to **false**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the instance.
        """
    ...
    def enable_publicip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_publicip(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def publicip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @publicip_id.setter
    def publicip_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def retention_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether access control is enabled.
        """
    ...
    def retention_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DmsRocketmqInstanceState:
    def __init__(__self__, *,
                 ...
                 broker_address: Optional[pulumi.Input[builtins.str]] = None,
                 broker_num: Optional[pulumi.Input[builtins.int]] = None,
                 charging_mode: Optional[pulumi.Input[builtins.str]] = None,
                 configs: Optional[pulumi.Input[Sequence[pulumi.Input['DmsRocketmqInstanceConfigArgs']]]] = None,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 namesrv_address: Optional[pulumi.Input[builtins.str]] = None,
                 new_spec_billing_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 node_num: Optional[pulumi.Input[builtins.int]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 period_unit: Optional[pulumi.Input[builtins.str]] = None,
                 public_broker_address: Optional[pulumi.Input[builtins.str]] = None,
                 public_namesrv_address: Optional[pulumi.Input[builtins.str]] = None,
                 publicip_address: Optional[pulumi.Input[builtins.str]] = None,
                 publicip_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the list of availability zone names, where
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] broker_address: Indicates the service data address.
        :param pulumi.Input[builtins.int] broker_num: Specifies the broker numbers. It's **required** when instance architecture is
               **cluster**. Defaults to `1` when instance architecture is **single node**.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are *prePaid*
               and *postPaid*, defaults to *postPaid*. Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to support IPv6. Defaults to **false**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] maintain_begin: Indicates the time at which the maintenance window starts. The format is HH:mm:ss.
        :param pulumi.Input[builtins.str] maintain_end: Indicates the time at which the maintenance window ends. The format is HH:mm:ss.
        :param pulumi.Input[builtins.str] name: Specifies the config name.
        :param pulumi.Input[builtins.str] namesrv_address: Indicates the metadata address.
        :param pulumi.Input[builtins.bool] new_spec_billing_enable: Indicates whether billing based on new specifications is enabled.
        :param pulumi.Input[builtins.int] node_num: Indicates the node quantity.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the instance. If `period_unit` is set to *month*
               , the value ranges from 1 to 9. If `period_unit` is set to *year*, the value ranges from `1` to `3`. This parameter is
               mandatory if `charging_mode` is set to *prePaid*. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
               Valid values are *month* and *year*. This parameter is mandatory if `charging_mode` is set to *prePaid*.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] public_broker_address: Indicates the public network service data address.
        :param pulumi.Input[builtins.str] public_namesrv_address: Indicates the public network metadata address.
        :param pulumi.Input[builtins.str] publicip_address: Indicates the public IP address.
        :param pulumi.Input[builtins.str] publicip_id: Specifies the ID of the EIP bound to the instance. Use commas (,) to separate
               multiple EIP IDs. It is mandatory if `enable_publicip` is **true** and should be empty when `enable_publicip` is **false**.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] resource_spec_code: Indicates the resource specifications.
        :param pulumi.Input[builtins.bool] retention_policy: Specifies whether access control is enabled.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group.
        :param pulumi.Input[builtins.str] specification: Indicates the instance specification. For a cluster DMS RocketMQ instance, VM specifications
               and the number of nodes are returned.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether the RocketMQ SASL_SSL is enabled. Defaults to **false**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] status: Indicates the status of the DMS RocketMQ instance.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage capacity, Unit: GB.
               When `engine_version` is **4.8.0**, value ranges from `300` to `30,000`.
               When `engine_version` is **5.x**, value ranges from `200` to `60,000`.
        :param pulumi.Input[builtins.str] storage_spec_code: Specifies the storage I/O specification.
        ...
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of a subnet.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the instance.
        :param pulumi.Input[builtins.str] type: Indicates the DMS RocketMQ instance type. Value: cluster.
        :param pulumi.Input[builtins.int] used_storage_space: Indicates the used message storage space. Unit: GB.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC.
               Changing this parameter will create a new resource.
        """
        if auto_renew is not None:
    ...
    def broker_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def broker_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def namesrv_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namesrv_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "namesrv_address", value)

    @property
    @pulumi.getter(name="newSpecBillingEnable")
    def new_spec_billing_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def new_spec_billing_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def public_broker_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_broker_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_broker_address", value)

    @property
    @pulumi.getter(name="publicNamesrvAddress")
    def public_namesrv_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_namesrv_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_namesrv_address", value)

    @property
    @pulumi.getter(name="publicipAddress")
    def publicip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def publicip_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DmsRocketmqInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            used_storage_space: Optional[pulumi.Input[builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DmsRocketmqInstance':
        """
    ...
    @property
    @pulumi.getter(name="brokerAddress")
    def broker_address(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the service data address.
        """
        return pulumi.get(self, "broker_address")
    ...
    @property
    @pulumi.getter(name="brokerNum")
    def broker_num(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the broker numbers. It's **required** when instance architecture is
        **cluster**. Defaults to `1` when instance architecture is **single node**.
        """
    ...
    @property
    @pulumi.getter(name="enablePublicip")
    def enable_publicip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable public access. By default, public access is disabled.
        """
        return pulumi.get(self, "enable_publicip")
    ...
    @property
    @pulumi.getter(name="namesrvAddress")
    def namesrv_address(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the metadata address.
        """
        return pulumi.get(self, "namesrv_address")
    ...
    @property
    @pulumi.getter(name="newSpecBillingEnable")
    def new_spec_billing_enable(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether billing based on new specifications is enabled.
        """
        return pulumi.get(self, "new_spec_billing_enable")
    ...
    @property
    @pulumi.getter(name="publicBrokerAddress")
    def public_broker_address(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the public network service data address.
        """
        return pulumi.get(self, "public_broker_address")
    ...
    @property
    @pulumi.getter(name="publicNamesrvAddress")
    def public_namesrv_address(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the public network metadata address.
        """
        return pulumi.get(self, "public_namesrv_address")
    ...
    @property
    @pulumi.getter(name="publicipAddress")
    def publicip_address(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the public IP address.
        """
        return pulumi.get(self, "publicip_address")
    ...
    @property
    @pulumi.getter(name="publicipId")
    def publicip_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the ID of the EIP bound to the instance. Use commas (,) to separate
        multiple EIP IDs. It is mandatory if `enable_publicip` is **true** and should be empty when `enable_publicip` is **false**.
        """
    ...
    @pulumi.getter(name="retentionPolicy")
    @_utilities.deprecated("""Use 'enable_acl' instead""")
    def retention_policy(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether access control is enabled.
        """
        return pulumi.get(self, "retention_policy")
