...
class GroupMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group: The group ID of this membership.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: A List of user IDs to associate to the group.
        """
