...
class KafkaInstanceParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Specifies the name of the DMS Kafka instance. An instance name starts with a letter,
...
class KafkaPermissionsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_policy: Specifies the permissions type. The value can be:
               + **all**: publish and subscribe permissions.
               + **pub**: publish permissions.
               + **sub**: subscribe permissions.
        :param builtins.str user_name: Specifies the username.
        """
...
class KafkaTopicConfig(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Specifies the name of the topic. The name starts with a letter, consists of 4 to
...
class GetFlavorsFlavorResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] arch_types: The list of supported CPU architectures.
        :param Sequence[builtins.str] charging_modes: The list of supported billing modes.
        :param builtins.str id: The flavor ID.
        ...
        :param Sequence['GetFlavorsFlavorSupportFeatureArgs'] support_features: The list of features supported by the current specification.
               The object structure is documented below.
        :param builtins.str type: Specifies flavor type. The valid values are **single**, **cluster** and **cluster.small**.
        :param builtins.str vm_specification: The underlying VM specification.
        """
...
class GetFlavorsFlavorIoResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: Specifies flavor type. The valid values are **single**, **cluster** and **cluster.small**.
        :param Sequence[builtins.str] unavailability_zones: The list of unavailability zones with available resources.
        """
...
class GetFlavorsFlavorPropertyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str flavor_alias: The flavor ID alias.
        :param builtins.int max_bandwidth_per_broker: The maximum bandwidth per broker.
        :param builtins.int max_broker: The maximum number of brokers.
        :param builtins.int max_consumer_per_broker: The maximum number of consumers per broker.
        :param builtins.int max_partition_per_broker: The maximum number of partitions per broker.
        :param builtins.int max_storage_per_node: The maximum storage per node. The unit is GB.
        :param builtins.int max_tps_per_broker: The maximum TPS per broker.
        :param builtins.int min_broker: The minimum number of brokers.
        :param builtins.int min_storage_per_node: The minimum storage per node. The unit is GB.
        """
...
class GetFlavorsFlavorSupportFeatureResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The function name, e.g. **connector_obs**.
...
class GetFlavorsFlavorSupportFeaturePropertyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_node: The maximum number of nodes for the dump function.
        :param builtins.int max_task: The maximum number of tasks for the dump function.
        :param builtins.int min_node: The minimum number of nodes for the dump function.
        :param builtins.int min_task: The minimum number of tasks for the dump function.
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param builtins.str access_user: The access username.
        :param Sequence[builtins.str] availability_zones: The list of AZ names.
        :param builtins.str connect_address: The IP address for instance connection.
        ...
        :param builtins.str description: The instance description.
        :param builtins.bool dumping: Whether to dumping is enabled.
        :param builtins.bool enable_auto_topic: Whether to enable automatic topic creation.
        :param builtins.bool enable_public_ip: Whether public access to the instance is enabled.
        :param builtins.str engine_version: The kafka engine version.
        :param builtins.str enterprise_project_id: Specifies the enterprise project ID to which all instances of the list
               belong.
        :param builtins.str id: The instance ID.
        :param builtins.str maintain_begin: The time at which a maintenance time window starts, the format is `HH:mm`.
        :param builtins.str maintain_end: The time at which a maintenance time window ends, the format is `HH:mm`.
        :param builtins.str management_connect_address: The connection address of the Kafka manager of an instance.
        :param builtins.str manager_user: The username for logging in to the Kafka Manager.
        :param builtins.str name: Specifies the kafka instance name for data-source queries.
        :param builtins.str network_id: The subnet ID to which the instance belongs.
        :param builtins.int partition_num: The maximum number of topics in the DMS kafka instance.
        :param builtins.int port: The port number.
        :param builtins.str product_id: The product ID used by the instance.
        :param builtins.str public_conn_addresses: The instance public access address.
               The format of each connection address is `{IP address}:{port}`.
        :param Sequence[builtins.str] public_ip_ids: The IDs of the elastic IP address (EIP).
        :param builtins.str resource_spec_code: The resource specifications identifier.
        :param builtins.str retention_policy: The action to be taken when the memory usage reaches the disk capacity threshold.
        :param builtins.str security_group_id: The security group ID associated with the instance.
        :param builtins.bool ssl_enable: Whether the Kafka SASL_SSL is enabled.
        :param builtins.str status: Specifies the kafka instance status for data-source queries.
        :param builtins.int storage_space: The message storage capacity, in GB unit.
        :param builtins.str storage_spec_code: The storage I/O specification.
        :param Mapping[str, builtins.str] tags: The key/value pairs to associate with the instance.
        :param builtins.str type: The instance type.
        :param builtins.int used_storage_space: The used message storage space, in GB unit.
        :param builtins.str user_id: The user ID who created the instance.
        :param builtins.str user_name: The username who created the instance.
        :param builtins.str vpc_id: The VPC ID to which the instance belongs.
        """
...
class GetInstancesInstanceCrossVpcAccessResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str advertised_ip: The advertised IP Address.
        :param builtins.str listener_ip: The listener IP address.
        :param builtins.int port: The port number.
        :param builtins.str port_id: The port ID associated with the address
        """
