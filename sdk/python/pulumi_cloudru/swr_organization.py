...
class SwrOrganizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the organization. The organization name must be globally
               unique.
...
class _SwrOrganizationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] creator: The creator user name of the organization.
        :param pulumi.Input[builtins.str] login_server: The URL that can be used to log into the container registry.
        :param pulumi.Input[builtins.str] name: Specifies the name of the organization. The organization name must be globally
               unique.
        :param pulumi.Input[builtins.str] permission: The permission of the organization, the value can be Manage, Write, and Read.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        """
