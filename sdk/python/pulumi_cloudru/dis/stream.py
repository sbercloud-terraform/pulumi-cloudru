...
class StreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] partition_count: Number of the expect partitions. NOTE: Each stream can be scaled up and down a
        ...
        :param pulumi.Input[builtins.str] stream_name: Name of the DIS stream to be created.
        :param pulumi.Input[builtins.int] auto_scale_max_partition_count: Maximum number of partition for automatic scaling.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] auto_scale_min_partition_count: Minimum number of partition for automatic scaling.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] compression_format: Data compression type. The value is one of snappy, gzip and zip.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] csv_delimiter: Field separator for CSV file. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.str] data_schema: User's JOSN, CSV format data schema, described with Avro schema. Changing
               this parameter will create a new resource.
        :param pulumi.Input[builtins.str] data_type: Data type of the data putting into the stream. The value is one of `BLOB`,
               `JSON` and `CSV`. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the dis stream, Value 0
               indicates the default enterprise project. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the DIS stream resource. If omitted, the
               provider-level region will be used. Changing this creates a new DIS Stream resource.
        :param pulumi.Input[builtins.int] retention_period: The number of hours for which data from the stream will be retained in DIS.
               Value range: `24` to `72`. Unit: `hour`. Default:`24`. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] stream_type: Stream Type. The value is COMMON(means 1M bandwidth) or ADVANCED(means 5M
               bandwidth). Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the stream.
        """
...
class _StreamState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compression_format: Data compression type. The value is one of snappy, gzip and zip.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] created: Timestamp at which the DIS stream was created.
        :param pulumi.Input[builtins.str] csv_delimiter: Field separator for CSV file. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.str] data_schema: User's JOSN, CSV format data schema, described with Avro schema. Changing
               this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.int] readable_partition_count: Total number of readable partitions (including partitions in ACTIVE state only).
        :param pulumi.Input[builtins.str] region: The region in which to create the DIS stream resource. If omitted, the
               provider-level region will be used. Changing this creates a new DIS Stream resource.
        :param pulumi.Input[builtins.int] retention_period: The number of hours for which data from the stream will be retained in DIS.
               Value range: `24` to `72`. Unit: `hour`. Default:`24`. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] status: The status of the partition.
        :param pulumi.Input[builtins.str] stream_id: Indicates a stream ID in UUID format.
        :param pulumi.Input[builtins.str] stream_name: Name of the DIS stream to be created.
        :param pulumi.Input[builtins.str] stream_type: Stream Type. The value is COMMON(means 1M bandwidth) or ADVANCED(means 5M
               bandwidth). Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the stream.
        :param pulumi.Input[builtins.int] writable_partition_count: Total number of writable partitions (including partitions in ACTIVE and DELETED states).
        """
        if auto_scale_max_partition_count is not None:
            pulumi.set(__self__, "auto_scale_max_partition_count", auto_scale_max_partition_count)
        if auto_scale_min_partition_count is not None:
...
class Stream(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stream_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            writable_partition_count: Optional[pulumi.Input[builtins.int]] = None) -> 'Stream':
        """
