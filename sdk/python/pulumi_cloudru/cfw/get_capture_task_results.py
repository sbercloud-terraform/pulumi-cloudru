...
def get_capture_task_results(fw_instance_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ips: Specifies the public IP address ranges.
    ...
    :param builtins.str task_id: Specifies the capture task ID.
    :param builtins.int type: Specifies whether to set a public IP address for downloading.
...
def get_capture_task_results_output(fw_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                    ips: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                    region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    task_id: Optional[pulumi.Input[builtins.str]] = None,
                                    type: Optional[pulumi.Input[Optional[builtins.int]]] = None,
