...
class EipAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of ECS instance to associated with.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] bandwidth_id: Specifies the **shared** bandwidth ID to associate.
               It's **mandatory** when you want to associate the ECS instance with a specified shared bandwidth.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] fixed_ip: Specifies the private IP address to direct traffic to. It's **mandatory**
               and must be a valid IPv6 address when you want to associate the ECS instance with a specified shared bandwidth.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] public_ip: Specifies the EIP address to associate. It's **mandatory**
               when you want to associate the ECS instance with an EIP. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the associated resource.
...
class _EipAssociateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of ECS instance to associated with.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] port_id: The port ID of the ECS instance that associated with.
        :param pulumi.Input[builtins.str] public_ip: Specifies the EIP address to associate. It's **mandatory**
               when you want to associate the ECS instance with an EIP. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the associated resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
...
class EipAssociate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port_id: Optional[pulumi.Input[builtins.str]] = None,
            public_ip: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'EipAssociate':
        """
