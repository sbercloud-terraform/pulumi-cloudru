...
func NewApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.RegisterResource("sbercloud:DedicatedApig/api:Api", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApi(ctx *pulumi.Context,
	...
	var resource Api
	err := ctx.ReadResource("sbercloud:DedicatedApig/api:Api", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
