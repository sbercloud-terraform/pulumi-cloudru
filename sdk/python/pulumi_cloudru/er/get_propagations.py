...
def get_propagations(attachment_id: Optional[builtins.str] = None,
...
def get_propagations_output(attachment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
