...
def get_certificate(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of certificate. The value is case sensitive and does not supports fuzzy matching.
           
           > **NOTE:** The certificate name is not unique. Only returns the last created one when matched multiple certificates.
    :param builtins.str region: The region in which to obtain the ELB certificate. If omitted, the provider-level region
           will be used.
    :param builtins.str type: Specifies the certificate type. The default value is `server`. The value can be one of the
           following:
    """
    __args__ = dict()
    __args__['name'] = name
