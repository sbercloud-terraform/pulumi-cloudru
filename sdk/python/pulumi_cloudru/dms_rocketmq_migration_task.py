...
class DmsRocketmqMigrationTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] overwrite: Specifies whether to overwrite configurations with the same name.
               Value options:
...
class _DmsRocketmqMigrationTaskState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 overwrite: Optional[pulumi.Input[builtins.str]] = None,
                 queues: Optional[pulumi.Input[Sequence[pulumi.Input['DmsRocketmqMigrationTaskQueueArgs']]]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] start_date: Indicates the start time of the migration task.
        :param pulumi.Input[builtins.str] status: Indicates the status of the migration task. The value can be **finished** or **failed***.
        :param pulumi.Input[Sequence[pulumi.Input['DmsRocketmqMigrationTaskSubscriptionGroupArgs']]] subscription_groups: Specifies the consumer group metadata.
               The subscription_groups structure is documented below.
               Changing this creates a new resource.
    ...
    @property
    @pulumi.getter
    def overwrite(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether to overwrite configurations with the same name.
        Value options:
        + **true**: Configurations in the destination metadata with the same name as the source metadata will be overwritten.
    ...
    @overwrite.setter
    def overwrite(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "overwrite", value)
...
class DmsRocketmqMigrationTask(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def overwrite(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to overwrite configurations with the same name.
        Value options:
        + **true**: Configurations in the destination metadata with the same name as the source metadata will be overwritten.
