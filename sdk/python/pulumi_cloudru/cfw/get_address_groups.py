...
def get_address_groups(address: Optional[builtins.str] = None,
    ...
    :param builtins.str address: Specifies IP address of the IP address group.
    :param builtins.str address_type: Specifies the IP address type.
           The value can be **0** (IPv4) or **1** (IPv6).
    :param builtins.str enterprise_project_id: Specifies the enterprise project id to which the IP address group belongs.
    :param builtins.str fw_instance_id: Specifies the firewall instance ID.
    :param builtins.str key_word: Specifies the keyword of the address group description.
    ...
    :param builtins.int query_address_set_type: Specifies the address group type of the query.
...
def get_address_groups_output(address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
