...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_type: Specifies the access type of the user. Available values are:
        ...
        :param pulumi.Input[builtins.str] country_code: Specifies the country code. The country code of the Chinese mainland is 0086. This
               parameter must be used together with `phone`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the user.
        :param pulumi.Input[builtins.str] email: Specifies the email address with a maximum of 255 characters.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether the user is enabled or disabled. Valid values are `true` and `false`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the user. The user name consists of 5 to 32 characters. It can
               contain only uppercase letters, lowercase letters, digits, spaces, and special characters (-_) and cannot start with a
               digit.
        :param pulumi.Input[builtins.str] password: Specifies the password for the user with 6 to 32 characters. It must contain at least
               two of the following character types: uppercase letters, lowercase letters, digits, and special characters.
        :param pulumi.Input[builtins.str] phone: Specifies the mobile number with a maximum of 32 digits. This parameter must be used
               together with `country_code`.
        :param pulumi.Input[builtins.bool] pwd_reset: Specifies whether or not the password should be reset. By default, the password is asked
...
class _UserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] country_code: Specifies the country code. The country code of the Chinese mainland is 0086. This
               parameter must be used together with `phone`.
        :param pulumi.Input[builtins.str] create_time: The time when the IAM user was created.
        :param pulumi.Input[builtins.str] description: Specifies the description of the user.
        :param pulumi.Input[builtins.str] email: Specifies the email address with a maximum of 255 characters.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether the user is enabled or disabled. Valid values are `true` and `false`.
        :param pulumi.Input[builtins.str] last_login: The tiem when the IAM user last login.
        :param pulumi.Input[builtins.str] name: Specifies the name of the user. The user name consists of 5 to 32 characters. It can
               contain only uppercase letters, lowercase letters, digits, spaces, and special characters (-_) and cannot start with a
               digit.
        :param pulumi.Input[builtins.str] password: Specifies the password for the user with 6 to 32 characters. It must contain at least
               two of the following character types: uppercase letters, lowercase letters, digits, and special characters.
        :param pulumi.Input[builtins.str] password_strength: Indicates the password strength.
        :param pulumi.Input[builtins.str] phone: Specifies the mobile number with a maximum of 32 digits. This parameter must be used
               together with `country_code`.
        :param pulumi.Input[builtins.bool] pwd_reset: Specifies whether or not the password should be reset. By default, the password is asked
               to reset at the first login.
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password_strength: Optional[pulumi.Input[builtins.str]] = None,
            phone: Optional[pulumi.Input[builtins.str]] = None,
            pwd_reset: Optional[pulumi.Input[builtins.bool]] = None) -> 'User':
        """
