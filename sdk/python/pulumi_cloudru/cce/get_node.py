...
def get_node(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: Specifies the ID of container cluster.
    :param builtins.str name: Specifies the name of the node.
    :param builtins.str node_id: Specifies the ID of the node.
    :param builtins.str region: Specifies the region in which to obtain the CCE nodes.
           If omitted, the provider-level region will be used.
    :param builtins.str status: Specifies the state of the node.
    """
    __args__ = dict()
...
def get_node_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
