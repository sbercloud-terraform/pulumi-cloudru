...
class AlarmruleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alarm_name: Specifies the name of an alarm rule. The value can be a string of 1 to 128
        ...
        :param pulumi.Input[builtins.bool] alarm_action_enabled: Specifies whether to enable the action to be triggered by an alarm. The
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AlarmruleAlarmActionArgs']]] alarm_actions: Specifies the action triggered by an alarm. The structure is described
               below.
        :param pulumi.Input[builtins.str] alarm_description: The value can be a string of 0 to 256 characters.
        :param pulumi.Input[builtins.bool] alarm_enabled: Specifies whether to enable the alarm. The default value is true.
        :param pulumi.Input[builtins.str] alarm_type: Specifies the alarm type. The value can be **EVENT.SYS**, **EVENT.CUSTOM**,
               **MULTI_INSTANCE** and **ALL_INSTANCE**. Defaults to **MULTI_INSTANCE**.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the alarm rule. Changing
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AlarmruleOkActionArgs']]] ok_actions: Specifies the action triggered by the clearing of an alarm. The structure is
               described below.
        :param pulumi.Input[builtins.str] region: The region in which to create the alarm rule resource. If omitted, the
...
class _AlarmruleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alarm_name: Specifies the name of an alarm rule. The value can be a string of 1 to 128
               characters that can consist of letters, digits, underscores (_), hyphens (-) and chinese characters.
        :param pulumi.Input[builtins.str] alarm_state: Indicates the alarm status. The value can be:
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the alarm rule resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.int] update_time: Indicates the time when the alarm status changed. The value is a UNIX timestamp and the unit is ms.
        """
        if alarm_action_enabled is not None:
            pulumi.set(__self__, "alarm_action_enabled", alarm_action_enabled)
        if alarm_actions is not None:
...
class Alarmrule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ok_actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlarmruleOkActionArgs', 'AlarmruleOkActionArgsDict']]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.int]] = None) -> 'Alarmrule':
        """
