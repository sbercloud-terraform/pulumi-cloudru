...
class ElbCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The public encrypted key of the Certificate, PEM format.
        :param pulumi.Input[builtins.str] description: Human-readable description for the Certificate.
        :param pulumi.Input[builtins.str] domain: The domain of the Certificate. The value contains a maximum of 100 characters. This
               parameter is valid only when `type` is set to "server".
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the certificate.
        :param pulumi.Input[builtins.str] name: Human-readable name for the Certificate. Does not have to be unique.
        :param pulumi.Input[builtins.str] private_key: The private encrypted key of the Certificate, PEM format. This parameter is valid
               and mandatory only when `type` is set to "server".
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB certificate resource. If omitted, the
               provider-level region will be used. Changing this creates a new certificate.
        :param pulumi.Input[builtins.str] type: Specifies the certificate type. The default value is "server". The value can be
...
class _ElbCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The public encrypted key of the Certificate, PEM format.
        :param pulumi.Input[builtins.str] create_time: Indicates the creation time.
        :param pulumi.Input[builtins.str] description: Human-readable description for the Certificate.
        :param pulumi.Input[builtins.str] domain: The domain of the Certificate. The value contains a maximum of 100 characters. This
               parameter is valid only when `type` is set to "server".
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the certificate.
        :param pulumi.Input[builtins.str] expire_time: Indicates the expire time.
        :param pulumi.Input[builtins.str] name: Human-readable name for the Certificate. Does not have to be unique.
        :param pulumi.Input[builtins.str] private_key: The private encrypted key of the Certificate, PEM format. This parameter is valid
               and mandatory only when `type` is set to "server".
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB certificate resource. If omitted, the
        ...
        :param pulumi.Input[builtins.str] type: Specifies the certificate type. The default value is "server". The value can be
               ...
               + server: indicates the server certificate.
               + client: indicates the CA certificate.
        :param pulumi.Input[builtins.str] update_time: Indicates the update time.
        """
