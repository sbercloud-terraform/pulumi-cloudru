...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the zone. Changing this creates a
               new zone.
        :param pulumi.Input[builtins.str] name: The name of the zone. Note the `.` at the end of the name. Changing this creates
               a new DNS zone.
        :param pulumi.Input[builtins.str] proxy_pattern: The recursive resolution proxy mode for subdomains of the private zone.
        :param pulumi.Input[builtins.str] region: The region in which to create the DNS zone. If omitted, the `region` argument
        ...
        :param pulumi.Input[builtins.str] zone_type: The type of zone. Can either be `public` or `private`. Changing this
...
class _ZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the zone. Changing this creates a
               new zone.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] masters: An array of master DNS servers.
        :param pulumi.Input[builtins.str] name: The name of the zone. Note the `.` at the end of the name. Changing this creates
               a new DNS zone.
        :param pulumi.Input[builtins.str] proxy_pattern: The recursive resolution proxy mode for subdomains of the private zone.
        :param pulumi.Input[builtins.str] region: The region in which to create the DNS zone. If omitted, the `region` argument
...
class Zone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Zone':
        """
