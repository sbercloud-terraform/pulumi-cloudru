...
class RouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC for which a route is to be added. Changing this creates a
               new resource.
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the route.
               The value is a string of no more than 255 characters and cannot contain angle brackets (< or >).
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC route. If omitted, the provider-level
               region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] route_table_id: Specifies the route table ID for which a route is to be added.
...
class _RouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] route_table_id: Specifies the route table ID for which a route is to be added.
               If the value is not set, the route will be added to the *default* route table.
        :param pulumi.Input[builtins.str] route_table_name: The name of route table.
        :param pulumi.Input[builtins.str] type: Specifies the route type. Currently, the value can be:
               **ecs**, **eni**, **vip**, **nat**, **peering**, **vpn**, **dc** and **cc**.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC for which a route is to be added. Changing this creates a
               new resource.
...
class Route(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_table_name: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Route':
        """
