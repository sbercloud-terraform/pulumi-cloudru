...
def get_product(availability_zones: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] availability_zones: Indicates the list of availability zones with available resources.
    :param builtins.str bandwidth: Indicates the baseline bandwidth of a DMS instance.
           The valid values are **100MB**, **300MB**, **600MB** and **1200MB**.
    :param builtins.str engine: Indicates the name of a message engine. The valid values are **kafka**, **rabbitmq**.
    :param builtins.str instance_type: Indicates an instance type. The valid values are **single** and **cluster**.
    :param builtins.str node_num: Indicates the number of nodes in a cluster.
    :param builtins.str partition_num: Indicates the maximum number of topics that can be created for a Kafka instance.
           The valid values are **300**, **900** and **1800**.
    :param builtins.str region: The region in which to obtain the dms products. If omitted, the provider-level region
           will be used.
    :param builtins.str storage: Indicates the storage capacity of the resource.
           The default value is the storage capacity of the product.
    :param builtins.str storage_spec_code: Indicates an I/O specification.
           The valid values are **dms.physical.storage.high** and **dms.physical.storage.ultra**.
    :param builtins.str version: Indicates the version of a message engine.
    :param builtins.str vm_specification: Indicates underlying VM specification, such as **c6.large.2**.
    """
    __args__ = dict()
...
def get_product_output(availability_zones: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
