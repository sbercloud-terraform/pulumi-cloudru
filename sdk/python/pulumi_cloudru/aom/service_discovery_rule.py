...
class ServiceDiscoveryRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_file_suffixes: Specifies the log file suffix. This is a list of strings.
        ...
        :param pulumi.Input[builtins.str] service_type: Specifies the service type, which is used only for rule classification and UI display.
               You can enter any field. For example, enter Java or Python by technology stack, or enter collector or database by function.
        :param pulumi.Input[builtins.bool] detect_log_enabled: Specifies whether to enable log collection. The default value is true.
        :param pulumi.Input[builtins.bool] discovery_rule_enabled: Specifies whether the rule is enabled. The default value is true.
        :param pulumi.Input[builtins.bool] is_default_rule: Specifies whether the rule is the default one. The default value is false.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the rule name, which contains 4 to 63 characters. It must start
               with a lowercase letter but cannot end with a hyphen (-). Only digits, lowercase letters, and hyphens are allowed.
        :param pulumi.Input[builtins.int] priority: Specifies the rule priority. Value range: 1 to 9999. The default value is 9999.
        :param pulumi.Input[builtins.str] region: The region in which to create the service discovery rule resource. If omitted,
...
class _ServiceDiscoveryRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the service discovery rule resource. If omitted,
               the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] rule_id: The rule ID in uuid format.
        :param pulumi.Input[builtins.str] service_type: Specifies the service type, which is used only for rule classification and UI display.
               You can enter any field. For example, enter Java or Python by technology stack, or enter collector or database by function.
        """
...
class ServiceDiscoveryRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            rule_id: Optional[pulumi.Input[builtins.str]] = None,
            service_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceDiscoveryRule':
        """
