...
def get_dependencies(is_versions_query_allowed: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_versions_query_allowed: Specifies whether to query the versions of each dependency package.
           Defaults to **false**.
    :param builtins.str name: Specifies the name of the dependency package.
    :param builtins.str region: Specifies the region where the dependency packages are located.  
    ...
    :param builtins.str runtime: Specifies the runtime of the dependency package.  
           ...
           + **http**
           + **Custom Image**
    :param builtins.str type: Specifies the type of the dependency package.  
           The valid values are as follows:
           + **public**
           + **private**
    """
...
def get_dependencies_output(is_versions_query_allowed: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
