...
class DdsParameterTemplateApplyArgs:
    def __init__(__self__, *,
                 ...
                 entity_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entity_ids: Specifies the entity IDs.
    ...
    def entity_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @entity_ids.setter
    def entity_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DdsParameterTemplateApply(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            configuration_id: Optional[pulumi.Input[builtins.str]] = None,
            entity_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'DdsParameterTemplateApply':
        """
    ...
    @property
    @pulumi.getter(name="entityIds")
    def entity_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies the entity IDs.
        + If the DB instance type is cluster and the shard or config parameter template is to be changed, the value is the
        group ID. If the parameter template of the mongos node is to be changed, the value is the node ID.
