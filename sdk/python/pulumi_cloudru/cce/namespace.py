...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies the cluster ID to which the CCE namespace belongs.
               Changing this will create a new namespace resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Specifies an unstructured key value map for external parameters.
               Changing this will create a new namespace resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies the map of string keys and values for labels.
               Changing this will create a new namespace resource.
        :param pulumi.Input[builtins.str] name: Specifies the unique name of the namespace.
        ...
        :param pulumi.Input[builtins.str] prefix: Specifies a prefix used by the server to generate a unique name.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the namespace resource.
...
class _NamespaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies the cluster ID to which the CCE namespace belongs.
               Changing this will create a new namespace resource.
        :param pulumi.Input[builtins.str] creation_timestamp: The server time when namespace was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies the map of string keys and values for labels.
               Changing this will create a new namespace resource.
        :param pulumi.Input[builtins.str] name: Specifies the unique name of the namespace.
               This parameter can contain a maximum of 63 characters, which may consist of lowercase letters, digits and hyphens (-),
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the namespace resource.
               If omitted, the provider-level region will be used. Changing this will create a new namespace resource.
        :param pulumi.Input[builtins.str] status: The current phase of the namespace.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
...
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            prefix: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Namespace':
        """
