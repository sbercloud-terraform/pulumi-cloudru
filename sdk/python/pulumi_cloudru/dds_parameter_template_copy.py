...
class DdsParameterTemplateCopyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] configuration_id: Specifies the parameter template ID.
...
class _DdsParameterTemplateCopyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of replicated parameter template.
               ...
               underscores (_), and periods (.).
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] node_version: Indicates the database version.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameter_values: Specifies the mapping between parameter names and parameter values.
               You can customize parameter values based on the parameters in the default parameter template.
...
class DdsParameterTemplateCopy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'DdsParameterTemplateCopy':
        """
