...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] engine_version: Specifies the engine version.
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the cluster.
        ...
        :param pulumi.Input[builtins.str] engine_type: Specifies the engine type. The valid value can be **elasticsearch** or **opensearch**.
               Defaults to **elasticsearch**. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the css cluster, The value **0**
        ...
        :param pulumi.Input[builtins.bool] https_enabled: Specifies whether to enable HTTPS. Defaults to **false**.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the cluster name. It contains `4` to `32` characters.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] password: Specifies the password of the cluster administrator in security mode.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the cluster resource. If omitted, the
        ...
        :param pulumi.Input[builtins.bool] security_mode: Specifies whether to enable authentication.
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone name.
               ...
               distributed to each AZ. If the number of nodes is not a multiple of the number of AZs, the absolute difference
               between node quantity in any two AZs is **1** at most.
        :param pulumi.Input[builtins.bool] backup_available: Whether the snapshot function is enabled.
        :param pulumi.Input['ClusterBackupStrategyArgs'] backup_strategy: Specifies the advanced backup policy. Structure is documented below.
        :param pulumi.Input[builtins.str] bandwidth_resource_id: The resource ID of bandwidth.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the cluster.
               Valid value is **postPaid**, defaults to **postPaid**.
        :param pulumi.Input['ClusterClientNodeConfigArgs'] client_node_config: Specifies the config of client node.
               The client_node_config structure is documented below.
        ...
        :param pulumi.Input[builtins.str] created_at: Time when a cluster is created. The format is ISO8601: CCYY-MM-DDThh:mm:ss.
        :param pulumi.Input[builtins.bool] disk_encrypted: Whether disks are encrypted.
        :param pulumi.Input[builtins.str] endpoint: The IP address and port number.
        :param pulumi.Input[builtins.str] engine_type: Specifies the engine type. The valid value can be **elasticsearch** or **opensearch**.
               Defaults to **elasticsearch**. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] engine_version: Specifies the engine version.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the css cluster, The value **0**
        ...
        :param pulumi.Input[builtins.bool] https_enabled: Specifies whether to enable HTTPS. Defaults to **false**.
               When `https_enabled` is set to **true**, the `security_mode` needs to be set to **true**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] is_period: Whether a cluster is billed on the yearly/monthly mode.
        :param pulumi.Input['ClusterKibanaPublicAccessArgs'] kibana_public_access: Specifies Kibana public network access information.
               This parameter is valid only when security_mode is set to **true**.
               The kibana_public_access structure is documented below.
        :param pulumi.Input['ClusterMasterNodeConfigArgs'] master_node_config: Specifies the config of master node.
        ...
        :param pulumi.Input[builtins.str] subnet_id: Specifies the Subnet ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the cluster.
        :param pulumi.Input[builtins.str] updated_at: Time when a cluster is updated. The format is ISO8601: CCYY-MM-DDThh:mm:ss.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input['ClusterVpcepEndpointArgs'] vpcep_endpoint: Specifies the VPC endpoint service information.
               The vpcep_endpoint structure is documented below.
        :param pulumi.Input[builtins.str] vpcep_endpoint_id: The VPC endpoint service ID.
        :param pulumi.Input[builtins.str] vpcep_ip: The private IP address of VPC endpoint service.
        """
        if auto_renew is not None:
            pulumi.set(__self__, "auto_renew", auto_renew)
        if availability_zone is not None:
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpcep_endpoint: Optional[pulumi.Input[Union['ClusterVpcepEndpointArgs', 'ClusterVpcepEndpointArgsDict']]] = None,
            vpcep_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
            vpcep_ip: Optional[pulumi.Input[builtins.str]] = None) -> 'Cluster':
        """
