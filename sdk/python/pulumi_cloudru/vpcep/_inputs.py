...
class ServiceConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_id: The user's domain ID.
        :param pulumi.Input[builtins.str] endpoint_id: The unique ID of the VPC endpoint.
...
class ServicePortMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol used in port mappings. Only **TCP** is supported.
        :param pulumi.Input[builtins.int] service_port: Specifies the port for accessing the VPC endpoint service. This port is provided by
               the backend service to provide services. The value ranges from 1 to 65535.
        :param pulumi.Input[builtins.int] terminal_port: Specifies the port for accessing the VPC endpoint. This port is provided by the VPC
               endpoint, allowing you to access the VPC endpoint service. The value ranges from 1 to 65535.
        """
