...
export class SfsTurboPermRule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SfsTurboPermRuleState, opts?: pulumi.CustomResourceOptions): SfsTurboPermRule {
        return new SfsTurboPermRule(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is SfsTurboPermRule {
     ...
     */
    constructor(name: string, args: SfsTurboPermRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SfsTurboPermRuleArgs | SfsTurboPermRuleState, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface SfsTurboPermRuleState {
 ...
 */
export interface SfsTurboPermRuleArgs {
    ipCidr: pulumi.Input<string>;
    region?: pulumi.Input<string>;
    rwType: pulumi.Input<string>;
    shareId: pulumi.Input<string>;
