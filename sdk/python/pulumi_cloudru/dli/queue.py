...
class QueueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] cu_count: Minimum number of CUs that are bound to a queue. Initial value can be `16`,
               `64`, or `256`. When scale_out or scale_in, the number must be a multiple of 16
        :param pulumi.Input[builtins.str] description: Description of a queue. Changing this parameter will create a new
               resource.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Enterprise project ID. The value 0 indicates the default
               enterprise project. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] feature: Indicates the queue feature. Changing this parameter will create a new
               resource. The options are as follows:
               + basic: basic type (default value)
               + ai: AI-enhanced (Only the SQL x86_64 dedicated queue supports this option.)
        :param pulumi.Input[builtins.str] name: Name of a queue. Name of a newly created resource queue. The name can contain
        ...
        :param pulumi.Input[builtins.str] platform: CPU architecture of queue compute resources. Changing this parameter will
               create a new resource. The options are as follows:
               + x86_64 : default value
               + aarch64
        :param pulumi.Input[builtins.str] queue_type: Indicates the queue type. Changing this parameter will create a new
               resource. The options are as follows:
               + sql
               + general
               
               The default value is `sql`.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the dli queue resource. If omitted,
               the provider-level region will be used. Changing this will create a new VPC channel resource.
        :param pulumi.Input[builtins.int] resource_mode: Queue resource mode. Changing this parameter will create a new
               resource. The options are as follows:
               + 0: indicates the shared resource mode.
               + 1: indicates the exclusive resource mode.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Label of a queue. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] vpc_cidr: The CIDR block of a queue. If use DLI enhanced datasource connections, the CIDR block
...
class _QueueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] create_time: Time when a queue is created.
        :param pulumi.Input[builtins.int] cu_count: Minimum number of CUs that are bound to a queue. Initial value can be `16`,
               `64`, or `256`. When scale_out or scale_in, the number must be a multiple of 16
        :param pulumi.Input[builtins.str] description: Description of a queue. Changing this parameter will create a new
               resource.
...
class Queue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_cidr: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_cidr: Optional[pulumi.Input[builtins.str]] = None) -> 'Queue':
        """
