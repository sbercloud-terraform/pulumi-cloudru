...
class KafkaUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the DMS kafka instance to which the user belongs.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] password: Specifies the password of the user. The parameter must be 8 to 32 characters
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the user. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS kafka user resource. If omitted, the
...
class _KafkaUserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] default_app: Indicates whether the application is the default application.
        :param pulumi.Input[builtins.str] description: Specifies the description of the user.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the DMS kafka instance to which the user belongs.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the user. Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS kafka user resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] role: Indicates the user role.
        """
...
class KafkaUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'KafkaUser':
        """
