...
def get_dms_rocketmq_flavors(arch_type: Optional[builtins.str] = None,
    ...
    :param builtins.str charging_mode: Specifies the billing mode of the flavor.
           Value options: **prePaid** and **postPaid**.
    :param builtins.str flavor_id: Specifies the ID of the flavor, e.g. **c6.2u4g.cluster**.
...
def get_dms_rocketmq_flavors_output(arch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
