...
class SparkJobDependentPackageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] group_name: Specifies the user group name.
               Changing this parameter will submit a new spark job.
...
class SparkJobDependentPackagePackageArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] package_name: Specifies the resource name of the package.
               Changing this parameter will submit a new spark job.
        :param pulumi.Input[builtins.str] type: Specifies the resource type of the package.
               Changing this parameter will submit a new spark job.
        """
