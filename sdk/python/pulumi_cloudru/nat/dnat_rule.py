...
class DnatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nat_gateway_id: ID of the nat gateway this dnat rule belongs to.
               Changing this creates a new dnat rule.
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol type. Currently,
               TCP, UDP, and ANY are supported.
               Changing this creates a new dnat rule.
        :param pulumi.Input[builtins.str] description: Specifies the description of the DNAT rule.  
               The value is a string of no more than `255` characters, and angle brackets (<>) are not allowed.
        :param pulumi.Input[builtins.int] external_service_port: Specifies port used by ECSs or
               BMSs to provide services for external systems.
               Changing this creates a new dnat rule.
        :param pulumi.Input[builtins.str] external_service_port_range: Specifies port range used by ECSs or BMSs to provide
        ...
        :param pulumi.Input[builtins.str] floating_ip_id: Specifies the ID of the floating IP address.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] global_eip_id: The ID of the global EIP connected by the DNAT rule.
        :param pulumi.Input[builtins.int] internal_service_port: Specifies port used by ECSs or BMSs
               to provide services for external systems. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] internal_service_port_range: Specifies port range used by Floating IP provide services
               for external systems.
               This parameter and `external_service_port_range` are mapped **1:1** in sequence(, ranges must have the same length).
               The valid value for range is **1~65535** and the port ranges can only be concatenated with the `-` character.
        :param pulumi.Input[builtins.str] port_id: Specifies the port ID of an ECS or a BMS.
               This parameter and private_ip are alternative. Changing this creates a
               new dnat rule.
        :param pulumi.Input[builtins.str] private_ip: Specifies the private IP address of a
               user, for example, the IP address of a VPC for dedicated connection.
               This parameter and port_id are alternative.
               Changing this creates a new dnat rule.
        :param pulumi.Input[builtins.str] region: The region in which to create the dnat rule resource. If omitted, the provider-level region will be used. Changing this creates a new Dnat rule resource.
        """
...
class _DnatRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Dnat rule creation time.
        :param pulumi.Input[builtins.str] description: Specifies the description of the DNAT rule.  
               The value is a string of no more than `255` characters, and angle brackets (<>) are not allowed.
        :param pulumi.Input[builtins.int] external_service_port: Specifies port used by ECSs or
               BMSs to provide services for external systems.
        ...
        :param pulumi.Input[builtins.str] external_service_port_range: Specifies port range used by ECSs or BMSs to provide
               ...
               The valid value for range is **1~65535** and the port ranges can only be concatenated with the `-` character.
               Required if `internal_service_port_range` is set.
        :param pulumi.Input[builtins.str] floating_ip_address: The actual floating IP address.
        :param pulumi.Input[builtins.str] floating_ip_id: Specifies the ID of the floating IP address.
               Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol type. Currently,
               ...
               Changing this creates a new dnat rule.
        :param pulumi.Input[builtins.str] region: The region in which to create the dnat rule resource. If omitted, the provider-level region will be used. Changing this creates a new Dnat rule resource.
        :param pulumi.Input[builtins.str] status: Dnat rule status.
        """
...
class DnatRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'DnatRule':
        """
