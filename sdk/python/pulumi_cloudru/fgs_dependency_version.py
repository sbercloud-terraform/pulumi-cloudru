...
class FgsDependencyVersionArgs:
    def __init__(__self__, *,
                 link: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] link: The OBS bucket path where the dependency package is located.
        :param pulumi.Input[builtins.str] runtime: Specifies the runtime of the custom dependency version.
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the custom dependency version.  
               The description can contain a maximum of `512` characters.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the custom dependency package to which the version
               belongs.
               ...
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region where the custom dependency version is located.  
    ...
    @property
    @pulumi.getter
    def link(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @link.setter
    def link(self, value: pulumi.Input[builtins.str]):
...
class _FgsDependencyVersionState:
    def __init__(__self__, *,
                 dependency_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dependency_id: The ID of the dependency package corresponding to the version.
        :param pulumi.Input[builtins.str] description: Specifies the description of the custom dependency version.  
               The description can contain a maximum of `512` characters.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] etag: The unique ID of the dependency.
        :param pulumi.Input[builtins.str] link: The OBS bucket path where the dependency package is located.
        :param pulumi.Input[builtins.str] name: Specifies the name of the custom dependency package to which the version
               belongs.
               The name can contain a maximum of `96` characters and must start with a letter and end with a letter or digit.
               Only letters, digits, underscores (_), periods (.), and hyphens (-) are allowed.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] owner: The dependency owner, **public** indicates a public dependency.
        :param pulumi.Input[builtins.str] region: Specifies the region where the custom dependency version is located.  
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] runtime: Specifies the runtime of the custom dependency version.
               The valid values are as follows:
               ...
               Changing this will create a new resource.
        :param pulumi.Input[builtins.int] size: The dependency size, in bytes.
        :param pulumi.Input[builtins.int] version: The dependency package version.
        :param pulumi.Input[builtins.str] version_id: The ID of the dependency package version.
        """
    ...
    def dependency_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dependency_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FgsDependencyVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None,
            version_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FgsDependencyVersion':
        """
    ...
    @property
    @pulumi.getter(name="dependencyId")
    def dependency_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the dependency package corresponding to the version.
        """
        return pulumi.get(self, "dependency_id")
