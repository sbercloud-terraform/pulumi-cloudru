...
def get_images(__support_agent_list: Optional[builtins.str] = None,
...
def get_images_output(__support_agent_list: Optional[pulumi.Input[Optional[builtins.str]]] = None,
