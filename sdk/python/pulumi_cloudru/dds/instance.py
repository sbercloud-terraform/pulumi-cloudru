...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the ID of the availability zone. Changing this creates a
               new instance.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceFlavorArgs']]] flavors: Specifies the flavors information. The structure is described below. Changing
               this creates a new instance.
        :param pulumi.Input[builtins.str] mode: Specifies the mode of the database instance. **Sharding**, **ReplicaSet**,
               **Single** are supported. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the security group ID of the DDS instance.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the subnet Network ID. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this creates a new instance.
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance.
        ...
        :param pulumi.Input[builtins.str] disk_encryption_id: Specifies the disk encryption ID of the instance. Changing this
               creates a new instance.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the dds instance.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] name: Specifies the DB instance name. The DB instance name of the same type is unique in the
               same tenant.
        :param pulumi.Input[builtins.str] password: Specifies the Administrator password of the database instance.
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
               ...
               Changing this creates a new instance.
        :param pulumi.Input[builtins.int] port: Specifies the database access port. The valid values are range from `2100` to `9500` and
               `27017`, `27018`, `27019`. Defaults to `8635`.
        :param pulumi.Input[builtins.str] region: Specifies the region of the DDS instance. Changing this creates a new
               instance.
        :param pulumi.Input[builtins.bool] ssl: Specifies whether to enable or disable SSL. Defaults to true.
               
               **NOTE:** The instance will be restarted in the background when switching SSL. Please operate with caution.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the DDS instance.
        """
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InstanceDatastoreArgs'] datastore: Specifies database information. The structure is described below. Changing
               this creates a new instance.
        :param pulumi.Input[builtins.str] db_username: Indicates the DB Administator name.
        :param pulumi.Input[builtins.str] disk_encryption_id: Specifies the disk encryption ID of the instance. Changing this
               creates a new instance.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the dds instance.
               Changing this creates a new instance.
