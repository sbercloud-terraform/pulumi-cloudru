...
class BandwidthPublicipArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the EIP or IPv6 port that uses the bandwidth.
        :param pulumi.Input[builtins.str] ip_address: The IPv4 or IPv6 address.
        :param pulumi.Input[builtins.int] ip_version: The IP version, either 4 or 6.
...
class EipBandwidthArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] share_type: Whether the bandwidth is dedicated or shared. Changing this creates a new
               eip. Possible values are as follows:
               + *PER*: Dedicated bandwidth
               + *WHOLE*: Shared bandwidth
        :param pulumi.Input[builtins.str] charge_mode: Specifies whether the bandwidth is billed by traffic or by bandwidth
               size. The value can be *traffic* or *bandwidth*. Changing this creates a new eip.
        :param pulumi.Input[builtins.str] id: The shared bandwidth id. This parameter is mandatory when
               `share_type` is set to *WHOLE*. Changing this creates a new eip.
        :param pulumi.Input[builtins.str] name: The bandwidth name, which is a string of 1 to 64 characters that contain letters, digits,
               underscores (_), and hyphens (-). This parameter is mandatory when `share_type` is set to *PER*.
        :param pulumi.Input[builtins.int] size: The bandwidth size. The value ranges from 1 to 300 Mbit/s. This parameter is mandatory
               when `share_type` is set to *PER*.
        """
...
class EipPublicipArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ip_address: The value must be a valid IP address in the available IP address segment.
               Changing this creates a new eip.
        :param pulumi.Input[builtins.int] ip_version: The IP version.
        :param pulumi.Input[builtins.str] port_id: The port id which this eip will associate with. If the value is "" or this not
               specified, the eip will be in unbind state.
        :param pulumi.Input[builtins.str] type: The type of the eip. Changing this creates a new eip.
        """
        if ip_address is not None:
            pulumi.set(__self__, "ip_address", ip_address)
        if ip_version is not None:
...
class RouteTableRouteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination: Specifies the destination address in the CIDR notation format,
               for example, 192.168.200.0/24. The destination of each route must be unique and cannot overlap
               with any subnet in the VPC.
        :param pulumi.Input[builtins.str] nexthop: Specifies the next hop.
               + If the route type is **ecs**, the value is an ECS instance ID in the VPC.
               + If the route type is **eni**, the value is the extension NIC of an ECS in the VPC.
               + If the route type is **vip**, the value is a virtual IP address.
               + If the route type is **nat**, the value is a VPN gateway ID.
               ...
               + If the route type is **dc**, the value is a Direct Connect gateway ID.
               + If the route type is **cc**, the value is a Cloud Connection ID.
        :param pulumi.Input[builtins.str] type: Specifies the route type. Currently, the value can be:
               **ecs**, **eni**, **vip**, **nat**, **peering**, **vpn**, **dc** and **cc**.
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the route.
               The value is a string of no more than 255 characters and cannot contain angle brackets (< or >).
        """
...
class SecgroupRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The effective policy.
        :param pulumi.Input[builtins.str] description: Description of the security group.
        :param pulumi.Input[builtins.str] direction: The direction of the rule. The value can be *egress* or *ingress*.
        :param pulumi.Input[builtins.str] ethertype: The IP protocol version. The value can be *IPv4* or *IPv6*.
        :param pulumi.Input[builtins.str] id: The security group rule ID.
        ...
        :param pulumi.Input[builtins.str] ports: The port value range.
        :param pulumi.Input[builtins.int] priority: The priority number.
        :param pulumi.Input[builtins.str] protocol: The protocol type.
        :param pulumi.Input[builtins.str] remote_address_group_id: The ID of the remote address group.
        :param pulumi.Input[builtins.str] remote_group_id: The ID of the peer security group.
        :param pulumi.Input[builtins.str] remote_ip_prefix: The remote IP address. The value can be in the CIDR format or IP addresses.
        """
