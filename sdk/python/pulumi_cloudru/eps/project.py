...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the enterprise project.
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the enterprise project. Default to *true*.
        :param pulumi.Input[builtins.str] name: Specifies the name of the enterprise project.
        ...
        :param pulumi.Input[builtins.bool] skip_disable_on_destroy: Specifies whether to skip disable the enterprise project on destroy.
               Defaults to **false**.
        :param pulumi.Input[builtins.str] type: Specifies the type of the enterprise project.
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Indicates the time (UTC) when the enterprise project was created. Example: 2018-05-18T06:49:06Z
        :param pulumi.Input[builtins.str] description: Specifies the description of the enterprise project.
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the enterprise project. Default to *true*.
        :param pulumi.Input[builtins.str] name: Specifies the name of the enterprise project.
               This parameter can contain 1 to 64 characters. Only letters, digits, underscores (_), and hyphens (-) are allowed.
        ...
        :param pulumi.Input[builtins.bool] skip_disable_on_destroy: Specifies whether to skip disable the enterprise project on destroy.
               Defaults to **false**.
        :param pulumi.Input[builtins.int] status: Indicates the status of an enterprise project.
               + 1 indicates Enabled.
               + 2 indicates Disabled.
        :param pulumi.Input[builtins.str] type: Specifies the type of the enterprise project.
               The valid values are *poc* and *prod*, default to *prod*.
        :param pulumi.Input[builtins.str] updated_at: Indicates the time (UTC) when the enterprise project was modified. Example: 2018-05-28T02:21:36Z
        """
