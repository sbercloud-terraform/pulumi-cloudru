...
class SqlserverAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: Specifies the password of the DB account. It consists of 8 to 128 characters and
               contains at least three types of the following characters: uppercase letters, lowercase letters, digits, and special
               characters.
        :param pulumi.Input[builtins.str] name: Specifies the username of the DB account. The username consists of 1 to 128
...
class _SqlserverAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] state: Indicates the DB user status. Its value can be any of the following:
...
class SqlserverAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlserverAccount':
        """
