...
class RouteTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID for which a route table is to be added.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the route table name. The value is a string of no more than
               64 characters that can contain letters, digits, underscores (_), hyphens (-), and periods (.).
        :param pulumi.Input[builtins.str] region: The region in which to create the vpc route table.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: Specifies an array of one or more subnets associating with the route table.
