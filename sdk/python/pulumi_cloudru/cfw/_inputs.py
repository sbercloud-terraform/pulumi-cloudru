...
class AclRuleCustomServiceGroupsArgs:
    def __init__(__self__, *,
                 ...
                 protocols: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_ids: The IDs of the predefined service groups.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] protocols: The protocols used in the predefined service groups.
...
class AntiVirusScanProtocolConfigArgs:
    def __init__(__self__, *,
                 ...
                 protocol_type: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] action: The anti virus action. The valid value can be **0** (observe) or **1** (block).
...
class CaptureTaskServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] protocol: Specifies the protocol type.
               ...
               + **58**: indicates ICMPv6;
               + **-1**: indicates any protocol.
        :param pulumi.Input[builtins.str] dest_port: Specifies the destination port.
        :param pulumi.Input[builtins.str] source_port: Specifies the source port.
        """
        pulumi.set(__self__, "protocol", protocol)
...
class FirewallFlavorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] version: Specifies the version of the firewall.
               ...
               When the charging_mode is **postPaid**: the value can be **Prefessional**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the firewall.
        :param pulumi.Input[builtins.int] default_bandwidth: The default bandwidth of the firewall.
        :param pulumi.Input[builtins.int] default_eip_count: The default EIP number of the firewall.
        :param pulumi.Input[builtins.int] default_log_storage: The default log storage of the firewall.
        :param pulumi.Input[builtins.int] default_vpc_count: The default VPC number of the firewall.
        :param pulumi.Input[builtins.int] eip_count: The EIP number of the firewall.
        ...
        :param pulumi.Input[builtins.int] extend_vpc_count: Specifies the extend VPC number of the firewall.
               Only works when the charging_mode is **prePaid**.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] log_storage: The log storage of the firewall.
        :param pulumi.Input[builtins.int] total_rule_count: The total rule count of the firewall.
        :param pulumi.Input[builtins.int] used_rule_count: The used rule count of the firewall.
        :param pulumi.Input[builtins.int] vpc_bandwidth: The VPC bandwidth of the firewall.
        :param pulumi.Input[builtins.int] vpc_count: The VPC number of the firewall.
        """
...
class FirewallProtectObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] object_name: The protected object name.
        :param pulumi.Input[builtins.int] type: The object type.
               The options are as follows: 0: north-south; 1: east-west.
        """
