...
class DcsParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A mapping of parameters to assign to the DCS instance. 
               Each parameter is represented by one key-value pair.
        :param pulumi.Input[builtins.str] project_id: Specifies the project.
        """
