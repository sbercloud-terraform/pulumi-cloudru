...
class ThrottlingPolicyAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: The ID of the dedicated instance to which the APIs and the throttling policy belongs.
        :param pulumi.Input[_builtins.str] policy_id: The ID of the throttling policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] publish_ids: The publish IDs corresponding to the APIs bound by the throttling policy.
        :param pulumi.Input[_builtins.str] region: The region where the dedicated instance and the throttling policy are located.
        """
...
class ThrottlingPolicyAssociate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ThrottlingPolicyAssociate resource with the given unique name, props, and options.
