...
def get_vpn_customer_gateways(asn: Optional[builtins.int] = None,
    ...
    :param builtins.str customer_gateway_id: Specifies the customer gateway ID used as the query filter.
    ...
    :param builtins.str region: Specifies the region in which to obtain the VPN customer gateways.
