...
def get_service_groups(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str key_word: Specifies the keyword of the service group description.
...
def get_service_groups_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
