...
class CbhInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CBH instance.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the product ID of the CBH server. When updating the flavor, it can only be
        ...
        :param pulumi.Input[builtins.str] password: Specifies the password for logging in to the management console. The value of the field
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the IDs of the security group. Multiple security group IDs are
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the CBH instance
               belongs. For enterprise users, if omitted, default enterprise project will be used.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 network is enabled. Defaults to **false**.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the CBH instance. The field can contain `1` to `64` characters.
        ...
        :param pulumi.Input[builtins.str] power_action: Specifies the power action after the CBH instance is created.
               ...
               is **ACTIVE**.
        :param pulumi.Input[builtins.str] public_ip: Indicates the elastic IP address.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the CBH instance.
        """
...
class _CbhInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CBH instance.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.float] data_disk_size: Indicates the data disk size of the instance. The unit is TB. It represents the sum of the disks
        ...
        :param pulumi.Input[builtins.str] power_action: Specifies the power action after the CBH instance is created.
               ...
               <br/>2. The **stop**, **soft-reboot**, and **hard-reboot** operations can only be performed when the instance status
               is **ACTIVE**.
        :param pulumi.Input[builtins.str] private_ip: Indicates the private IP address of the instance.
        :param pulumi.Input[builtins.str] public_ip: Indicates the elastic IP address.
        :param pulumi.Input[builtins.str] public_ip_id: Specifies the ID of the elastic IP.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
