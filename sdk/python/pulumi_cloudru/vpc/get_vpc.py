...
def get_vpc(cidr: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Specifies the id of the VPC to retrieve.
    :param builtins.str name: Specifies an unique name for the VPC. The value is a string of no more than 64 characters
