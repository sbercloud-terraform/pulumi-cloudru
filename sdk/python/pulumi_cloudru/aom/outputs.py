...
class ServiceDiscoveryRuleDiscoveryRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] check_contents: Specifies the matched value. This is a list of strings.
        :param builtins.str check_mode: Specifies the match condition. The values can be **contain** and **equals**.
        :param builtins.str check_type: Specifies the match type. The values can be **cmdLine**, **env** and **scope**.
        """
...
class ServiceDiscoveryRuleLogPathRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] args: Specifies the command. This is a list of strings.
        :param builtins.str name_type: Specifies the value type, which can be **cmdLineHash**.
        :param Sequence[builtins.str] values: Specifies the log path. This is a list of strings.
...
class ServiceDiscoveryRuleNameRulesApplicationNameRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] args: Specifies the input value.
        :param builtins.str name_type: Specifies the value type. The value can be **cmdLineHash**, **cmdLine**, **env**
               and **str**.
        :param Sequence[builtins.str] values: Specifies the application name, which is mandatory only when the value of
