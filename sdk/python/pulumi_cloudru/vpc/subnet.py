...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: Specifies the network segment on which the subnet resides. The value must be in
               CIDR format and within the CIDR block of the VPC. The subnet mask cannot be greater than 28. Changing this creates a
               new Subnet.
        :param pulumi.Input[builtins.str] gateway_ip: Specifies the gateway of the subnet. The value must be a valid IP address
               in the subnet segment. Changing this creates a new Subnet.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC to which the subnet belongs. Changing this creates
               a new Subnet.
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone (AZ) to which the subnet belongs.
               The value must be an existing AZ in the system. Changing this creates a new Subnet.
        :param pulumi.Input[builtins.str] description: Specifies supplementary information about the subnet. The value is a string of
               no more than 255 characters and cannot contain angle brackets (< or >).
        :param pulumi.Input[builtins.bool] dhcp_enable: Specifies whether the DHCP function is enabled for the subnet. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_lists: Specifies the DNS server address list of a subnet. This field is required if you need to
               use more than two DNS servers. This parameter value is the superset of both DNS server address 1 and DNS server
               address 2.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 function is enabled for the subnet. Defaults to false.
        :param pulumi.Input[builtins.str] name: Specifies the subnet name. The value is a string of 1 to 64 characters that can contain
               letters, digits, underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] primary_dns: Specifies the IP address of DNS server 1 on the subnet. The value must be a valid
               IP address.
        :param pulumi.Input[builtins.str] region: Specifies tThe region in which to create the vpc subnet. If omitted, the
               provider-level region will be used. Changing this creates a new Subnet.
        :param pulumi.Input[builtins.str] secondary_dns: Specifies the IP address of DNS server 2 on the subnet. The value must be a valid
               IP address.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the subnet.
        """
...
class _SubnetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] gateway_ip: Specifies the gateway of the subnet. The value must be a valid IP address
               in the subnet segment. Changing this creates a new Subnet.
        :param pulumi.Input[builtins.str] ipv4_subnet_id: The ID of the IPv4 subnet (Native OpenStack API).
        :param pulumi.Input[builtins.str] ipv6_cidr: The IPv6 subnet CIDR block.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 function is enabled for the subnet. Defaults to false.
        :param pulumi.Input[builtins.str] ipv6_gateway: The IPv6 subnet gateway.
        :param pulumi.Input[builtins.str] ipv6_subnet_id: The ID of the IPv6 subnet (Native OpenStack API).
        :param pulumi.Input[builtins.str] name: Specifies the subnet name. The value is a string of 1 to 64 characters that can contain
               letters, digits, underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] primary_dns: Specifies the IP address of DNS server 1 on the subnet. The value must be a valid
               IP address.
        ...
        :param pulumi.Input[builtins.str] secondary_dns: Specifies the IP address of DNS server 2 on the subnet. The value must be a valid
               IP address.
        :param pulumi.Input[builtins.str] subnet_id: The subnet (Native OpenStack API) ID.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the subnet.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC to which the subnet belongs. Changing this creates
               a new Subnet.
        """
