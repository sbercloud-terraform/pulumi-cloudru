...
def get_storage_types(db_type: Optional[builtins.str] = None,
    ...
    :param builtins.str db_type: DB engine. The valid values are **MySQL**, **PostgreSQL**, **SQLServer**.
    :param builtins.str db_version: DB version number.
    :param builtins.str instance_mode: HA mode. The valid values are **single**, **ha**, **replica**.
...
def get_storage_types_output(db_type: Optional[pulumi.Input[builtins.str]] = None,
