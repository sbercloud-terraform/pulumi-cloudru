...
class PeeringConnectionAccepterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_peering_connection_id: The VPC Peering Connection ID to manage. Changing this
               creates a new VPC peering connection accepter.
        :param pulumi.Input[builtins.bool] accept: Whether or not to accept the peering request. Defaults to `false`.
        :param pulumi.Input[builtins.str] region: The region in which to create the vpc peering connection accepter. If omitted,
...
class _PeeringConnectionAccepterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] accept: Whether or not to accept the peering request. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: The VPC peering connection name.
        :param pulumi.Input[builtins.str] peer_tenant_id: The Tenant Id of the accepter tenant.
        :param pulumi.Input[builtins.str] peer_vpc_id: The VPC ID of the accepter tenant.
        :param pulumi.Input[builtins.str] region: The region in which to create the vpc peering connection accepter. If omitted,
               the provider-level region will be used. Changing this creates a new VPC peering connection accepter resource.
        :param pulumi.Input[builtins.str] status: The VPC peering connection status.
        :param pulumi.Input[builtins.str] vpc_id: The ID of requester VPC involved in a VPC peering connection.
        :param pulumi.Input[builtins.str] vpc_peering_connection_id: The VPC Peering Connection ID to manage. Changing this
               creates a new VPC peering connection accepter.
        """
        if accept is not None:
...
class PeeringConnectionAccepter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_peering_connection_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PeeringConnectionAccepter':
        """
