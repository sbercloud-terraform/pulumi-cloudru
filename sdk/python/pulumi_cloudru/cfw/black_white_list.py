...
class BlackWhiteListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] object_id: Specifies the protected object ID.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] protocol: Specifies the protocol type. The value can be:
               + **6**: indicates TCP;
               + **17**: indicates UDP;
               + **1**: indicates ICMP;
               + **58**: indicates ICMPv6;
               + **-1**: indicates any protocol;
        :param pulumi.Input[builtins.str] description: Specifies the description of the list.
...
class BlackWhiteList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.str]] = None,
            protocol: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'BlackWhiteList':
        """
