...
def get_cluster_certificates(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: Specifies the cluster ID which the cluster certificate in.
    :param builtins.int duration: Specifies the duration of the cluster certificate. The unit is days. The valid value in
           [1, 1827]. If the input value is -1, it will use the maximum 1827 as `duration` value.
    :param builtins.str region: Specifies the region in which to obtain the CCE cluster certificate. If omitted, the
...
def get_cluster_certificates_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
