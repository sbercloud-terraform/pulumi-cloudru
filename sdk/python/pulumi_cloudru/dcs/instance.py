...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] capacity: Specifies the cache capacity. Unit: GB.
        ...
        :param pulumi.Input[builtins.str] engine: Specifies a cache engine. Options: *Redis* and *Memcached*.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] subnet_id: The ID of subnet which the instance belongs to.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC which the instance belongs to.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] access_user: Specifies the username used for accessing a DCS Memcached instance.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The code of the AZ where the cache node resides.
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the redis instance.
               The valid values are as follows:
               + `prePaid`: indicates the yearly/monthly billing mode.
               + `postPaid`: indicates the pay-per-use billing mode.
               Default value is `postPaid`.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] deleted_nodes: Specifies the ID of the replica to delete. This parameter is mandatory when
               you delete replicas of a master/standby DCS Redis 4.0 or 5.0 instance. Currently, only one replica can be deleted
               at a time.
        :param pulumi.Input[builtins.str] description: Specifies the description of an instance.
               It is a string that contains a maximum of 1024 characters.
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of a cache engine.
               It is mandatory when the engine is *Redis*, the value can be 3.0, 4.0, 5.0 or 6.0.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the dcs instance.
        :param pulumi.Input[builtins.str] flavor: The flavor of the cache instance, which including the total memory, available memory,
        ...
        :param pulumi.Input[builtins.str] maintain_begin: Time at which the maintenance time window starts. Defaults to **02:00:00**.
        ...
        :param pulumi.Input[builtins.str] maintain_end: Time at which the maintenance time window ends. Defaults to **06:00:00**.
               + The start time and end time of a maintenance time window must indicate the time segment of a supported maintenance
               time window.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of an instance.
        ...
        :param pulumi.Input[builtins.str] password: Specifies the password of a DCS instance.
        ...
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the instance.
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
               ...
               Changing this creates a new instance.
        :param pulumi.Input[builtins.int] port: Port customization, which is supported only by Redis 4.0 and Redis 5.0 instances.
               Redis instance defaults to 6379. Memcached instance does not use this argument.
        :param pulumi.Input[builtins.str] private_ip: The IP address of the DCS instance,
               ...
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the DCS instance resource.
               If omitted, the provider-level region will be used. Changing this creates a new DCS instance resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] rename_commands: Critical command renaming, which is supported only by Redis 4.0 and
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserved_ips: Specifies IP addresses to retain. Mandatory during cluster scale-in. If this
               parameter is not set, the system randomly deletes unnecessary shards.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group which the instance belongs to.
               This parameter is mandatory for Memcached and Redis 3.0 version.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether to enable the SSL. Value options: **true**, **false**.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the dcs instance.
        :param pulumi.Input[builtins.str] template_id: The Parameter Template ID.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.bool] whitelist_enable: Enable or disable the IP address whitelists. Defaults to true.
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cache_mode: Indicates the instance type. The value can be **single**, **ha**, **cluster** or **proxy**.
        :param pulumi.Input[builtins.float] capacity: Specifies the cache capacity. Unit: GB.
               + **Redis4.0, Redis5.0 and Redis6.0**: Stand-alone and active/standby type instance values: `0.125`, `0.25`,
               `0.5`, `1`, `2`, `4`, `8`, `16`, `32` and `64`.
               Cluster instance specifications support `4`,`8`,`16`, `24`, `32`, `48`, `64`, `96`, `128`, `192`, `256`,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the redis instance.
               ...
               Default value is `postPaid`.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] cpu_type: Indicates the CPU type of the instance. The value can be **x86_64** or **aarch64**.
        :param pulumi.Input[builtins.str] created_at: Indicates the time when the instance is created, in RFC3339 format.
        :param pulumi.Input[builtins.str] deleted_nodes: Specifies the ID of the replica to delete. This parameter is mandatory when
               you delete replicas of a master/standby DCS Redis 4.0 or 5.0 instance. Currently, only one replica can be deleted
               at a time.
        :param pulumi.Input[builtins.str] description: Specifies the description of an instance.
               It is a string that contains a maximum of 1024 characters.
        :param pulumi.Input[builtins.str] domain_name: Domain name of the instance. Usually, we use domain name and port to connect to the DCS instances.
        :param pulumi.Input[builtins.str] engine: Specifies a cache engine. Options: *Redis* and *Memcached*.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of a cache engine.
               It is mandatory when the engine is *Redis*, the value can be 3.0, 4.0, 5.0 or 6.0.
        ...
        :param pulumi.Input[builtins.str] flavor: The flavor of the cache instance, which including the total memory, available memory,
               ...
               + Query some flavors
               in [DCS Instance Specifications](https://support.hc.sbercloud.ru/usermanual/dcs/en-us_topic_0054235835.html) + Log in to the DCS console, click *Buy DCS Instance*, and find the corresponding instance specification.
        :param pulumi.Input[builtins.str] launched_at: Indicates the time when the instance is started, in RFC3339 format.
        :param pulumi.Input[builtins.str] maintain_begin: Time at which the maintenance time window starts. Defaults to **02:00:00**.
               + The start time and end time of a maintenance time window must indicate the time segment of a supported maintenance
               time window.
               + The start time must be on the hour, such as **18:00:00**.
        ...
        :param pulumi.Input[builtins.str] maintain_end: Time at which the maintenance time window ends. Defaults to **06:00:00**.
               ...
               **19:00:00**.
               ...
               > **NOTE:** Parameters `maintain_begin` and `maintain_end` must be set in pairs.
        :param pulumi.Input[builtins.int] max_memory: Total memory size. Unit: MB.
        :param pulumi.Input[builtins.str] name: Specifies the name of an instance.
               The name must be 4 to 64 characters and start with a letter.
               Only english, letters (case-insensitive), digits, underscores (_) ,and hyphens (-) are allowed.
        :param pulumi.Input[builtins.str] order_id: The ID of the order that created the instance.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceParameterArgs']]] parameters: Specify an array of one or more parameters to be set to the DCS instance after
               launched. You can check on console to see which parameters supported.
               The parameters structure is documented below.
        :param pulumi.Input[builtins.str] password: Specifies the password of a DCS instance.
        ...
        :param pulumi.Input[builtins.str] private_ip: The IP address of the DCS instance,
               ...
               If omitted, the system will automatically allocate an available IP address to the Redis instance.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] product_type: Indicates the product type of the instance. The value can be: **generic** or **enterprise**.
        :param pulumi.Input[builtins.str] readonly_domain_name: Indicates the read-only domain name of the instance. This parameter is available
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] rename_commands: Critical command renaming, which is supported only by Redis 4.0 and
               Redis 5.0 instances but not by Redis 3.0 instance.
               The valid commands that can be renamed are: **command**, **keys**, **flushdb**, **flushall** and **hgetall**.
        :param pulumi.Input[builtins.int] replica_count: Indicates the number of replicas in the instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserved_ips: Specifies IP addresses to retain. Mandatory during cluster scale-in. If this
               parameter is not set, the system randomly deletes unnecessary shards.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group which the instance belongs to.
               This parameter is mandatory for Memcached and Redis 3.0 version.
        :param pulumi.Input[builtins.str] security_group_name: The name of security group which the instance belongs to.
        :param pulumi.Input[builtins.int] sharding_count: Indicates the number of shards in a cluster instance.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether to enable the SSL. Value options: **true**, **false**.
        :param pulumi.Input[builtins.str] status: Cache instance status. The valid values are as follows:
        ...
        :param pulumi.Input[builtins.str] subnet_cidr: Indicates the subnet segment.
        :param pulumi.Input[builtins.str] subnet_id: The ID of subnet which the instance belongs to.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] subnet_name: The name of subnet which the instance belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the dcs instance.
        :param pulumi.Input[builtins.str] template_id: The Parameter Template ID.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.bool] transparent_client_ip_enable: Indicates whether client IP pass-through is enabled.
        :param pulumi.Input[builtins.int] used_memory: Size of the used memory. Unit: MB.
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC which the instance belongs to.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] vpc_name: The name of VPC which the instance belongs to.
        :param pulumi.Input[builtins.bool] whitelist_enable: Enable or disable the IP address whitelists. Defaults to true.
               If the whitelist is disabled, all IP addresses connected to the VPC can access the instance.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceWhitelistArgs']]] whitelists: Specifies the IP addresses which can access the instance.
               This parameter is valid for Redis 4.0 and 5.0 versions. The structure is described below.
