...
def get_domain_name_parse_ip_list(address_type: Optional[builtins.str] = None,
    ...
    :param builtins.str address_type: Specifies the address type.
           The valid value can be **0** (IPv4) or **1** (IPv6).
    :param builtins.str domain_address_id: Specifies the domain name ID in a domain name group.
...
def get_domain_name_parse_ip_list_output(address_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
