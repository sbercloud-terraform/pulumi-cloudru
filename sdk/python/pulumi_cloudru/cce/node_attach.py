...
class NodeAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies the ID of the cluster. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.str] os: Specifies the operating System of the node. Changing this parameter will reset the node.
               + For VM nodes, clusters of v1.13 and later support *CentOS 7.6* and *Ubuntu 18.04*.
        :param pulumi.Input[builtins.str] server_id: Specifies the ecs server ID. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.int] docker_base_size: Specifies the available disk space of a single docker container on the
        ...
        :param pulumi.Input[builtins.str] lvm_config: Specifies the docker data disk configurations. The following is an
               example:
        :param pulumi.Input[builtins.int] max_pods: Specifies the the maximum number of instances a node is allowed to create.
               Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.str] postinstall: Specifies the script required after installation. The input value can be
               a Base64 encoded string or not. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] preinstall: Specifies the script required before installation. The input value can be
               a Base64 encoded string or not. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the CCE node attach resource. If omitted, the
               provider-level region will be used. Changing this creates a new CCE node attach resource.
        :param pulumi.Input[builtins.str] runtime: The runtime of the CCE node.
...
class _NodeAttachState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: The name of the available partition (AZ).
        :param pulumi.Input[builtins.str] cluster_id: Specifies the ID of the cluster. Changing this parameter will create a new
               resource.
        :param pulumi.Input[Sequence[pulumi.Input['NodeAttachDataVolumeArgs']]] data_volumes: The data disks related configuration.
        :param pulumi.Input[builtins.int] docker_base_size: Specifies the available disk space of a single docker container on the
               node in device mapper mode. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ecs_group_id: The Ecs group ID.
        :param pulumi.Input[builtins.str] flavor_id: The flavor ID of the CCE node.
        :param pulumi.Input[builtins.str] image_id: schema: Internal
        :param pulumi.Input[builtins.str] key_pair: Specifies the key pair name when logging in to select the key pair mode.
               This parameter and `password` are alternative. Changing this parameter will reset the node.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies the tags of a Kubernetes node, key/value pair format.
