...
def get_secgroup(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to obtain the security group. If omitted, the
           provider-level region will be used.
    :param builtins.str secgroup_id: Specifiest he ID of the security group.
    """
    __args__ = dict()
...
def get_secgroup_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
