...
class DmsRocketmqUserArgs:
    def __init__(__self__, *,
                 ...
                 default_group_perm: Optional[pulumi.Input[builtins.str]] = None,
                 default_topic_perm: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 white_remote_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DmsRocketmqUser resource.
        :param pulumi.Input[builtins.str] access_key: Specifies the name of the user, which starts with a letter, consists of 7
               to 64 characters and can contain only letters, digits, hyphens (-), and underscores (_).
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the rocketMQ instance.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] secret_key: Specifies the password of the user. Use 8 to 32 characters. Contain at
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] admin: Specifies whether the user is an administrator.
        :param pulumi.Input[builtins.str] default_group_perm: Specifies the default consumer group permissions.
               Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        :param pulumi.Input[builtins.str] default_topic_perm: Specifies the default topic permissions.
               Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DmsRocketmqUserTopicPermArgs']]] topic_perms: Specifies the special topic permissions.
               The permission structure is documented below.
        :param pulumi.Input[builtins.str] white_remote_address: Specifies the IP address whitelist.
        """
    ...
    def default_group_perm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_group_perm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_group_perm", value)

    @property
    @pulumi.getter(name="defaultTopicPerm")
    def default_topic_perm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_topic_perm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def white_remote_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def white_remote_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DmsRocketmqUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            topic_perms: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DmsRocketmqUserTopicPermArgs', 'DmsRocketmqUserTopicPermArgsDict']]]]] = None,
            white_remote_address: Optional[pulumi.Input[builtins.str]] = None) -> 'DmsRocketmqUser':
        """
    ...
    @property
    @pulumi.getter
    def admin(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the user is an administrator.
        """
        return pulumi.get(self, "admin")
    ...
    @property
    @pulumi.getter(name="defaultGroupPerm")
    def default_group_perm(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the default consumer group permissions.
        Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        """
    ...
    @property
    @pulumi.getter(name="defaultTopicPerm")
    def default_topic_perm(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the default topic permissions.
        Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        """
    ...
    @property
    @pulumi.getter(name="whiteRemoteAddress")
    def white_remote_address(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the IP address whitelist.
        """
        return pulumi.get(self, "white_remote_address")
