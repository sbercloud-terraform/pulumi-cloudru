...
def get_resource_tags(region: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_id: Specifies the resource ID to which the tags belong that to be queried.
...
def get_resource_tags_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
