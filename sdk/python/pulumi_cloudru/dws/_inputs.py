...
class ClusterElbArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The cluster ID
        ...
        :param pulumi.Input[builtins.str] private_ip: List of private network IP address.
        :param pulumi.Input[builtins.str] private_ip_v6: The IPv6 address of the ELB load balancer.
        :param pulumi.Input[builtins.str] public_ip: A nested object resource Structure is documented below.
               Changing this creates a new cluster resource.
...
class ClusterEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connect_info: (Optional, String) Private network connection information.
        :param pulumi.Input[builtins.str] jdbc_url: (Optional, String)
               JDBC URL. The following is the default format:
               jdbc:postgresql://< public_connect_info>/<YOUR_DATABASE_NAME>
        """
...
class ClusterPublicEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] jdbc_url: (Optional, String)
               JDBC URL. The following is the default format:
               jdbc:postgresql://< public_connect_info>/<YOUR_DATABASE_NAME>
        :param pulumi.Input[builtins.str] public_connect_info: (Optional, String)
               Public network connection information.
        """
        if jdbc_url is not None:
            pulumi.set(__self__, "jdbc_url", jdbc_url)
...
class ClusterPublicIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] eip_id: EIP ID.
               Changing this creates a new cluster resource.
        :param pulumi.Input[builtins.str] public_bind_type: Binding type of an EIP. The value can be either of the following:
               **auto_assign**, **not_use**, **bind_existing**. The default value is **not_use**.
               Changing this creates a new cluster resource.
        """
