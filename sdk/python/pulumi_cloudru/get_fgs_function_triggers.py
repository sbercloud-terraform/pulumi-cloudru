...
def get_fgs_function_triggers(end_time: Optional[builtins.str] = None,
                              function_urn: Optional[builtins.str] = None,
    ...
    :param builtins.str end_time: Specifies end time of creation time of the function trigger.
    ...
    :param builtins.str function_urn: Specifies the function URN to which the trigger belongs.
    :param builtins.str region: Specifies the region in which to query the data source.
           If omitted, the provider-level region will be used.
    :param builtins.str start_time: Specifies start time of creation time of the function trigger.
           The format is `YYYY-MM-DDThh:mm:ss{timezone}`.
    :param builtins.str status: Specifies status of the function trigger.
           The valid values are as follows:
           + **ACTIVE**
           + **DISABLED**
    :param builtins.str trigger_id: Specifies the ID of the function trigger.
...
def get_fgs_function_triggers_output(end_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
