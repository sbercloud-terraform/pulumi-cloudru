...
class ElbMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] interval: Specifies the interval between health checks, in seconds.
               Value ranges from **1** to **50**.
        :param pulumi.Input[builtins.int] max_retries: Specifies the number of consecutive health checks when the health check result of
               a backend server changes from OFFLINE to ONLINE. Value ranges from **1** to **50**.
        :param pulumi.Input[builtins.str] pool_id: Specifies the ID of the backend server group for which the health check is
               configured. Changing this creates a new monitor.
        :param pulumi.Input[builtins.str] protocol: Specifies the health check protocol. Value options: **TCP**, **UDP_CONNECT**,
               **HTTP**, or **HTTPS**.
        ...
        :param pulumi.Input[builtins.int] timeout: Specifies the maximum time required for waiting for a response from the health check,
               in seconds. Value ranges from **1** to **50**. It is recommended that you set the value less than that of
               parameter `interval`.
        :param pulumi.Input[builtins.str] domain_name: Specifies the domain name that HTTP requests are sent to during the health check.
        ...
        :param pulumi.Input[builtins.int] port: Specifies the port used for the health check. If this parameter is left blank, a port of
        ...
        :param pulumi.Input[builtins.str] status_code: Specifies the expected HTTP status code. This parameter will take effect only when
               ...
               Defaults to **200**.
        :param pulumi.Input[builtins.str] url_path: Specifies the HTTP request path for the health check. The value must start with a
