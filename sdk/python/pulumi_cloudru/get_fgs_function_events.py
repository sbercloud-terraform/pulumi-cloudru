...
def get_fgs_function_events(function_urn: Optional[builtins.str] = None,
    ...
    :param builtins.str function_urn: Specifies the function URN to which the events belong.
...
def get_fgs_function_events_output(function_urn: Optional[pulumi.Input[builtins.str]] = None,
