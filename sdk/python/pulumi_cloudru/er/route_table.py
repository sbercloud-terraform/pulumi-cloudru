...
class RouteTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the ER instance to which the route table belongs.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the route table.  
               The description contain a maximum of `255` characters, and the angle brackets (< and >) are not allowed.
        :param pulumi.Input[builtins.str] name: Specifies the name of the route table.  
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region where the ER instance and route table are located.  
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the route table.
        """
...
class _RouteTableState:
    def __init__(__self__, *,
                 ...
                 is_default_association: Optional[pulumi.Input[builtins.bool]] = None,
                 is_default_propagation: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the ER instance to which the route table belongs.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] is_default_association: Whether this route table is the default association route table.
        :param pulumi.Input[builtins.bool] is_default_propagation: Whether this route table is the default propagation route table.
        :param pulumi.Input[builtins.str] name: Specifies the name of the route table.  
               The name can contain `1` to `64` characters, only English letters, Chinese characters, digits, underscore (_),
               hyphens (-) and dots (.) allowed.
        :param pulumi.Input[builtins.str] region: Specifies the region where the ER instance and route table are located.  
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] status: The current status of the route table.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the route table.
    ...
    def is_default_association(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_default_association(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_default_association", value)

    @property
    @pulumi.getter(name="isDefaultPropagation")
    def is_default_propagation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_default_propagation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RouteTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteTable':
        """
    ...
    @property
    @pulumi.getter(name="isDefaultAssociation")
    def is_default_association(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this route table is the default association route table.
        """
        return pulumi.get(self, "is_default_association")
    ...
    @property
    @pulumi.getter(name="isDefaultPropagation")
    def is_default_propagation(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this route table is the default propagation route table.
        """
        return pulumi.get(self, "is_default_propagation")
