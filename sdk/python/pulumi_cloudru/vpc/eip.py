...
class EipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the elastic IP. Changing this
               creates a new eip.
        :param pulumi.Input[builtins.str] name: The name of the EIP.
        :param pulumi.Input[builtins.str] region: The region in which to create the eip resource. If omitted, the provider-level
               region will be used. Changing this creates a new eip resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the elastic IP.
        """
...
class _EipState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The IP address of the eip.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled. Valid values are "true" and "
               false". Changing this creates a new resource.
        :param pulumi.Input['EipBandwidthArgs'] bandwidth: The bandwidth object.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the elastic IP. Changing this
               creates a new eip.
        :param pulumi.Input[builtins.str] ipv6_address: The IPv6 address of the EIP.
        :param pulumi.Input[builtins.str] name: The name of the EIP.
        :param pulumi.Input[builtins.str] port_id: The port ID which the EIP associated with.
        :param pulumi.Input[builtins.str] private_ip: The private IP address bound to the EIP.
        :param pulumi.Input['EipPublicipArgs'] publicip: The elastic IP address object.
        :param pulumi.Input[builtins.str] region: The region in which to create the eip resource. If omitted, the provider-level
               region will be used. Changing this creates a new eip resource.
        :param pulumi.Input[builtins.str] status: The status of eip.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the elastic IP.
        """
...
class Eip(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Eip':
        """
