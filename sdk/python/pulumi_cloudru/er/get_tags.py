...
def get_tags(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to query the resource tags.  
           If omitted, the provider-level region will be used.
    :param builtins.str resource_type: Specifies the resource type to which the tags belong that to be queried.  
...
def get_tags_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
