...
def get_maintainwindow(begin: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudru:Dcs/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult).value
...
def get_maintainwindow_output(begin: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudru:Dcs/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult)
