...
class GatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spec: Specifies the nat gateway type.
               The value can be:
        :param pulumi.Input[builtins.str] subnet_id: Specifies the subnet ID of the downstream interface (the next hop of the
               DVR) of the NAT gateway.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC to which the NAT gateway belongs.  
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the nat
               gateway. The value contains 0 to 255 characters, and angle brackets (<)
               and (>) are not allowed.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the
        ...
        :param pulumi.Input[builtins.str] name: Specifies the nat gateway name. The name can
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the NAT geteway.
        """
...
class _GatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spec: Specifies the nat gateway type.
               The value can be:
        :param pulumi.Input[builtins.str] status: The status of the nat gateway.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the subnet ID of the downstream interface (the next hop of the
               DVR) of the NAT gateway.
               Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the NAT geteway.
