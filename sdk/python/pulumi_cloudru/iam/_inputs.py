...
class AclIpCidrArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cidr: Specifies the IPv4 CIDR block, for example, __192.168.0.0/24__.
        :param pulumi.Input[builtins.str] description: Specifies a description about an IPv4 CIDR block. This parameter can contain a
               maximum of 255 characters and the following charactors are not allowed:__@#%^&*<>\\\\__.
        """
...
class AclIpRangeArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] range: Specifies the Ip address range, for example, __0.0.0.0-255.255.255.0__.
        :param pulumi.Input[builtins.str] description: Specifies a description about an IP address range. This parameter can contain a
               maximum of 255 characters and the following charactors are not allowed:__@#%^&*<>\\\\__.
...
class AgencyProjectRoleArgs:
    def __init__(__self__, *,
                 ...
                 roles: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] project: Specifies the name of project.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Specifies an array of role names.
...
class ProviderAccessConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_type: Specifies the access type of the identity provider.
               Available options are:
        :param pulumi.Input[builtins.str] client_id: Specifies the ID of a client registered with the OpenID Connect identity provider.
        :param pulumi.Input[builtins.str] provider_url: Specifies the URL of the identity provider.
               This field corresponds to the iss field in the ID token.
        :param pulumi.Input[builtins.str] signing_key: Public key used to sign the ID token of the OpenID Connect identity provider.
               This field is required only if the protocol is set to *oidc*.
        :param pulumi.Input[builtins.str] authorization_endpoint: Specifies the authorization endpoint of the OpenID Connect identity
               provider. This field is required only if the access type is set to `program_console`.
        :param pulumi.Input[builtins.str] response_mode: Response mode.
               Valid values is *form_post* and *fragment*, default value is *form_post*.
               This field is required only if the access type is set to `program_console`.
        :param pulumi.Input[builtins.str] response_type: Response type. Valid values is *id_token*, default value is *id_token*.
               This field is required only if the access type is set to `program_console`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Specifies the scopes of authorization requests. It is an array of one or more scopes.
               Valid values are *openid*, *email*, *profile* and other values defined by you.
               This field is required only if the access type is set to `program_console`.
...
class ProviderConversionConversionRuleLocalArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] group: Specifies the user group to which the federated user belongs on the cloud platform.
        :param pulumi.Input[builtins.str] username: Specifies the name of a federated user on the cloud platform.
        """
...
class ProviderConversionConversionRuleRemoteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] attribute: Specifies the attribute in the IDP assertion.
        :param pulumi.Input[builtins.str] condition: Specifies the condition of conversion rule.
               Available options are:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies the rule is matched only if the specified strings appear in the attribute type.
        """
...
class ProviderConversionRuleLocalArgs:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] group: The user group to which the federated user belongs on the cloud platform.
        :param pulumi.Input[builtins.str] username: The name of a federated user on the cloud platform.
        """
        if group is not None:
            pulumi.set(__self__, "group", group)
        if username is not None:
...
class ProviderConversionRuleRemoteArgs:
    def __init__(__self__, *,
                 ...
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] attribute: The attribute in the IDP assertion.
        :param pulumi.Input[builtins.str] condition: The condition of conversion rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The rule is matched only if the specified strings appear in the attribute type.
        """
