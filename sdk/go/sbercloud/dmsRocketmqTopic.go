...
//			_, err := sbercloud.NewDmsRocketmqTopic(ctx, "test", &sbercloud.DmsRocketmqTopicArgs{
//				InstanceId:  pulumi.Any(instanceId),
//				Name:        pulumi.String("topic_test"),
...
//				InstanceId: pulumi.Any(instanceId),
//				Name:       pulumi.String("topic_test"),
//				QueueNum:   pulumi.Int(3),
//				Permission: pulumi.String("all"),
//				Brokers: sbercloud.DmsRocketmqTopicBrokerArray{
//					&sbercloud.DmsRocketmqTopicBrokerArgs{
...
//				Name:       pulumi.String("topic_test"),
//				Permission: pulumi.String("all"),
//				Queues: sbercloud.DmsRocketmqTopicQueueArray{
//					&sbercloud.DmsRocketmqTopicQueueArgs{
//						Broker:   pulumi.String("broker-0"),
//						QueueNum: pulumi.Int(3),
//					},
//				},
//			})
...
func NewDmsRocketmqTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sbercloud:index/dmsRocketmqTopic:DmsRocketmqTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDmsRocketmqTopic(ctx *pulumi.Context,
	...
	var resource DmsRocketmqTopic
	err := ctx.ReadResource("sbercloud:index/dmsRocketmqTopic:DmsRocketmqTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
