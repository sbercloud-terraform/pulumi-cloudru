...
class VpnConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpn_type: The connection type. The value can be **policy**, **static** or **bgp**.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] enable_nqa: Whether to enable NQA check. Defaults to **false**.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project ID.
        :param pulumi.Input[builtins.str] ha_role: Specifies the mode of the VPN connection.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] peer_subnets: The CIDR list of customer subnets. This parameter must be empty
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the VPN connection.
