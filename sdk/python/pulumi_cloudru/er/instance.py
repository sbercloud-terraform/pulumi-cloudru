...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 auto_accept_shared_attachments: Optional[pulumi.Input[builtins.bool]] = None,
                 default_association_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_propagation_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enable_default_association: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_default_propagation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] asn: The BGP AS number of the ER instance.  
               The valid value is range from `64,512` to `65534` or range from `4,200,000,000` to `4,294,967,294`.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The availability zone list where the ER instance is located.
        ...
        :param pulumi.Input[builtins.bool] auto_accept_shared_attachments: Whether to automatically accept the creation of shared
               attachment.
               The default value is **false**.
        :param pulumi.Input[builtins.str] default_association_route_table_id: The ID of the default association route table.
        ...
        :param pulumi.Input[builtins.str] default_propagation_route_table_id: The ID of the default propagation route table.
               
               > Before modifying the default routing table of this instance (except cancel the default route table), make sure
               `enable_default_propagation` is set to **true**.
        :param pulumi.Input[builtins.str] description: The description of the ER instance.  
               The description contain a maximum of `255` characters, and the angle brackets (< and >) are not allowed.
        :param pulumi.Input[builtins.bool] enable_default_association: Whether to enable the association of the default route table.  
               The default value is **false**.
        :param pulumi.Input[builtins.bool] enable_default_propagation: Whether to enable the propagation of the default route table.  
               The default value is **false**.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the ER instance
               belongs.
        :param pulumi.Input[builtins.str] name: The router name.  
    ...
    def auto_accept_shared_attachments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_accept_shared_attachments(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_accept_shared_attachments", value)

    @property
    @pulumi.getter(name="defaultAssociationRouteTableId")
    def default_association_route_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_association_route_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_association_route_table_id", value)

    @property
    @pulumi.getter(name="defaultPropagationRouteTableId")
    def default_propagation_route_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_propagation_route_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_default_association(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_default_association(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_default_association", value)

    @property
    @pulumi.getter(name="enableDefaultPropagation")
    def enable_default_propagation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_default_propagation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The availability zone list where the ER instance is located.
               The maximum number of availability zone is two. Select two AZs to configure active-active deployment for high
               availability which will ensure reliability and disaster recovery.
        :param pulumi.Input[builtins.str] created_at: The creation time.
        :param pulumi.Input[builtins.str] default_association_route_table_id: The ID of the default association route table.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] status: Current status of the router.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the instance.
        :param pulumi.Input[builtins.str] updated_at: The latest update time.
        """
        if asn is not None:
            pulumi.set(__self__, "asn", asn)
        if auto_accept_shared_attachments is not None:
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="autoAcceptSharedAttachments")
    def auto_accept_shared_attachments(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to automatically accept the creation of shared
        attachment.
        The default value is **false**.
    ...
    @property
    @pulumi.getter(name="defaultAssociationRouteTableId")
    def default_association_route_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the default association route table.
    ...
    @property
    @pulumi.getter(name="defaultPropagationRouteTableId")
    def default_propagation_route_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the default propagation route table.
    ...
    @property
    @pulumi.getter(name="enableDefaultAssociation")
    def enable_default_association(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the association of the default route table.  
        The default value is **false**.
        """
    ...
    @property
    @pulumi.getter(name="enableDefaultPropagation")
    def enable_default_propagation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the propagation of the default route table.  
        The default value is **false**.
        """
