...
def get_project(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Specifies the ID of an enterprise project. The value 0 indicates enterprise project default.
    :param builtins.str name: Specifies the enterprise project name. Fuzzy search is supported.
    :param builtins.int status: Specifies the status of an enterprise project.
           + 1 indicates Enabled.
