...
class KafkaInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of the Kafka engine,
               such as 1.1.0, 2.3.0, 2.7 or other supported versions. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] network_id: Specifies the ID of a subnet. Changing this creates a new instance
               resource.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group.
        :param pulumi.Input[builtins.str] storage_spec_code: Specifies the storage I/O specification. Value range:
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] access_user: Specifies the username of SASL_SSL user. A username consists of 4
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The names of the AZ where the Kafka instances reside.
        ...
        :param pulumi.Input[builtins.int] broker_num: Specifies the broker numbers.
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the DMS Kafka instance. It is a character string
               containing not more than 1,024 characters.
        :param pulumi.Input[builtins.bool] dumping: Specifies whether to enable message dumping.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.bool] enable_auto_topic: Specifies whether to enable automatic topic creation. If automatic
               ...
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID of the Kafka instance.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the Kafka `flavor ID`. This parameter and `product_id` are alternative.
        ...
        :param pulumi.Input[builtins.str] maintain_begin: Specifies the time at which a maintenance time window starts. Format: HH:mm. The
        ...
        :param pulumi.Input[builtins.str] maintain_end: Specifies the time at which a maintenance time window ends. Format: HH:mm. The
               start time and end time of a maintenance time window must indicate the time segment of a supported maintenance time
        ...
        :param pulumi.Input[builtins.str] manager_password: Specifies the password for logging in to the Kafka Manager. The
        ...
        :param pulumi.Input[builtins.str] manager_user: Specifies the username for logging in to the Kafka Manager. The username
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the DMS Kafka instance. An instance name starts with a letter,
               consists of 4 to 64 characters, and supports only letters, digits, hyphens (-) and underscores (_).
        :param pulumi.Input[builtins.str] password: Specifies the password of SASL_SSL user. A password must meet the
        ...
        :param pulumi.Input[builtins.str] product_id: Specifies a product ID, which includes bandwidth, partition, broker and default
               storage capacity.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_ip_ids: Specifies the IDs of the elastic IP address (EIP)
               ...
               | 600MB | 4 |
               | 1,200MB | 8 |
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS Kafka instances. If omitted, the
               provider-level region will be used. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] retention_policy: Specifies the action to be taken when the memory usage reaches the disk
        ...
        :param pulumi.Input[builtins.bool] ssl_enable: Indicates whether the Kafka SASL_SSL is enabled.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage capacity, the unit is GB.
               ...
               It is required when creating an instance with `flavor_id`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the DMS Kafka instance.
        """
...
class _KafkaInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are *prePaid*
               and *postPaid*, defaults to *postPaid*. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] connect_address: Indicates the IP address of the DMS Kafka instance.
        :param pulumi.Input[Sequence[pulumi.Input['KafkaInstanceCrossVpcAccessArgs']]] cross_vpc_accesses: Specifies the cross-VPC access information.
               The object structure is documented below.
        :param pulumi.Input[builtins.str] description: Specifies the description of the DMS Kafka instance. It is a character string
               containing not more than 1,024 characters.
        ...
        :param pulumi.Input[builtins.bool] enable_auto_topic: Specifies whether to enable automatic topic creation. If automatic
               ...
               The default value is false.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.bool] enable_public_ip: Indicates whether public access to the DMS Kafka instance is enabled.
        :param pulumi.Input[builtins.str] engine: Indicates the message engine.
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of the Kafka engine,
               such as 1.1.0, 2.3.0, 2.7 or other supported versions. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID of the Kafka instance.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the Kafka `flavor ID`. This parameter and `product_id` are alternative.
        ...
        :param pulumi.Input[builtins.str] maintain_end: Specifies the time at which a maintenance time window ends. Format: HH:mm. The
               ...
               and `maintain_end` must be set in pairs. If parameter `maintain_end` is left blank, parameter
               `maintain_begin` is also blank. In this case, the system automatically allocates the default end time 06:00.
        :param pulumi.Input[builtins.str] management_connect_address: Indicates the Kafka Manager connection address of a Kafka instance.
        :param pulumi.Input[builtins.str] manager_password: Specifies the password for logging in to the Kafka Manager. The
               password must meet the following complexity requirements: Must be 8 to 32 characters long. Must contain at least 2 of
               the following character types: lowercase letters, uppercase letters, digits, and special characters (`~!@#$%^&*()-_
               =+\\\\|[{}]:'",<.>/?). Changing this creates a new instance resource.
        ...
        :param pulumi.Input[builtins.str] network_id: Specifies the ID of a subnet. Changing this creates a new instance
               resource.
        :param pulumi.Input[builtins.int] partition_num: Indicates the number of partitions in Kafka instance.
        :param pulumi.Input[builtins.str] password: Specifies the password of SASL_SSL user. A password must meet the
               following complexity requirements: Must be 8 to 32 characters long. Must contain at least 2 of the following character
               types: lowercase letters, uppercase letters, digits, and special characters (`~!@#$%^&*()-_=+\\\\|[{}]:'",<.>/?).
               Changing this creates a new instance resource.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS Kafka instances. If omitted, the
               provider-level region will be used. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] resource_spec_code: Indicates a resource specifications identifier.
        :param pulumi.Input[builtins.str] retention_policy: Specifies the action to be taken when the memory usage reaches the disk
               capacity threshold. The valid values are as follows:
               + **time_base**: Automatically delete the earliest messages.
               + **produce_reject**: Stop producing new messages.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group.
        :param pulumi.Input[builtins.bool] ssl_enable: Indicates whether the Kafka SASL_SSL is enabled.
        :param pulumi.Input[builtins.str] status: Indicates the status of the DMS Kafka instance.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage capacity, the unit is GB.
               + When bandwidth is 100MB: 600–90000 GB
               + When bandwidth is 300MB: 1200–90000 GB
               + When bandwidth is 600MB: 2400–90000 GB
        ...
        :param pulumi.Input[builtins.str] storage_spec_code: Specifies the storage I/O specification. Value range:
               ...
               Changing this creates a new instance resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the DMS Kafka instance.
        :param pulumi.Input[builtins.str] type: Indicates the DMS Kafka instance type.
        :param pulumi.Input[builtins.int] used_storage_space: Indicates the used message storage space. Unit: GB
        :param pulumi.Input[builtins.str] user_id: Indicates the ID of the user who created the DMS Kafka instance
        :param pulumi.Input[builtins.str] user_name: Indicates the name of the user who created the DMS Kafka instance
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC. Changing this creates a new instance resource.
        """
        if access_user is not None:
            pulumi.set(__self__, "access_user", access_user)
...
class KafkaInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_client_plain: Optional[pulumi.Input[builtins.bool]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'KafkaInstance':
        """
