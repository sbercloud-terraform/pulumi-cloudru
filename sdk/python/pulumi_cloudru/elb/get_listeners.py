...
def get_listeners(client_ca_tls_container_ref: Optional[builtins.str] = None,
    ...
    :param builtins.str http2_enable: Whether the ELB listener uses HTTP/2.
    ...
    :param builtins.str protocol_port: The front-end listening port of the listener.  
...
def get_listeners_output(client_ca_tls_container_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
