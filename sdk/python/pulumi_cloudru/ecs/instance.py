...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] admin_pass: Specifies the administrative password to assign to the instance.
        :param pulumi.Input[builtins.str] agency_name: Specifies the IAM agency name which is created on IAM to provide
               temporary credentials for ECS to access cloud services.
        :param pulumi.Input[builtins.str] agent_list: Specifies the agent list in comma-separated string.
               Available agents are:
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone in which to create the instance.
        ...
        :param pulumi.Input[builtins.bool] delete_disks_on_termination: Specifies whether to delete the data disks when the instance is terminated.
        ...
        :param pulumi.Input[builtins.bool] delete_eip_on_termination: Specifies whether the EIP is released when the instance is terminated.
               Defaults to *true*.
        :param pulumi.Input[builtins.str] description: Specifies the description of the instance. The description consists of 0 to 85
               characters, and can't contain '<' or '>'.
        :param pulumi.Input[builtins.str] eip_id: Specifies the ID of an *existing* EIP assigned to the instance.
               This parameter and `eip_type`, `bandwidth` are alternative. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] eip_type: Specifies the type of an EIP that will be automatically assigned to the instance.
               Available values are *5_bgp* (dynamic BGP) and *5_sbgp* (static BGP). Changing this creates a new instance.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies a unique id in UUID format of enterprise project.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the flavor ID of the instance to be created.
        :param pulumi.Input[builtins.str] flavor_name: The flavor name of the instance.
        :param pulumi.Input[builtins.str] image_id: Required if `image_name` is empty. Specifies the image ID of the desired
               image for the instance. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] image_name: Required if `image_id` is empty. Specifies the name of the desired image
               for the instance. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] key_pair: Specifies the SSH keypair name used for logging in to the instance.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the instance. The name consists of 1 to 64 characters,
        ...
        :param pulumi.Input[builtins.str] private_key: Specifies the the private key of the keypair in use. This parameter is mandatory
               when replacing or unbinding a keypair and the instance is in **Running** state.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the instance.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Specifies an array of one or more security group IDs to associate with the
               instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: An array of one or more security groups to associate with the instance.
        :param pulumi.Input[builtins.bool] stop_before_destroy: Specifies whether to try stop instance gracefully before destroying it, thus giving
               chance for guest OS daemons to stop correctly. If instance doesn't stop within timeout, it will be destroyed anyway.
        :param pulumi.Input[builtins.int] system_disk_size: Specifies the system disk size in GB, The value range is 1 to 1024.
               Shrinking the disk is not supported.
        :param pulumi.Input[builtins.str] system_disk_type: Specifies the system disk type of the instance. Defaults to `GPSSD`.
               Changing this creates a new instance.
        ...
        :param pulumi.Input[builtins.str] user_data: Specifies the user data to be injected during the instance creation. Text
        ...
        :param pulumi.Input[builtins.str] user_id: Specifies a user ID, required when using key_pair in prePaid charging mode.
               Changing this creates a new instance.
        """
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_ip_v4: The first detected Fixed IPv4 address or the Floating IP.
        ...
        :param pulumi.Input['InstanceBandwidthArgs'] bandwidth: Specifies the bandwidth of an EIP that will be automatically assigned to the instance.
               The object structure is documented below. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] created_at: The creation time, in UTC format.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceDataDiskArgs']]] data_disks: Specifies an array of one or more data disks to attach to the instance.
               The data_disks object structure is documented below. Changing this creates a new instance.
        :param pulumi.Input[builtins.bool] delete_disks_on_termination: Specifies whether to delete the data disks when the instance is terminated.
               Defaults to *false*. This parameter is valid if `charging_mode` is set to *postPaid*, and all data disks will be deleted
        ...
        :param pulumi.Input[builtins.str] private_key: Specifies the the private key of the keypair in use. This parameter is mandatory
               when replacing or unbinding a keypair and the instance is in **Running** state.
        :param pulumi.Input[builtins.str] public_ip: The EIP address that is associted to the instance.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the instance.
               If omitted, the provider-level region will be used. Changing this creates a new instance.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceSchedulerHintArgs']]] scheduler_hints: Specifies the scheduler with hints on how the instance should be launched. The
               available hints are described below.
        ...
        :param pulumi.Input[builtins.bool] stop_before_destroy: Specifies whether to try stop instance gracefully before destroying it, thus giving
               chance for guest OS daemons to stop correctly. If instance doesn't stop within timeout, it will be destroyed anyway.
        :param pulumi.Input[builtins.str] system_disk_id: The system disk voume ID.
        :param pulumi.Input[builtins.int] system_disk_size: Specifies the system disk size in GB, The value range is 1 to 1024.
               Shrinking the disk is not supported.
        :param pulumi.Input[builtins.str] system_disk_type: Specifies the system disk type of the instance. Defaults to `GPSSD`.
               Changing this creates a new instance.
               ...
               + `ESSD`: Extreme SSD type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the instance.
        :param pulumi.Input[builtins.str] updated_at: The last update time, in UTC format.
        :param pulumi.Input[builtins.str] user_data: Specifies the user data to be injected during the instance creation. Text
               and text files can be injected. Changing this creates a new instance.
