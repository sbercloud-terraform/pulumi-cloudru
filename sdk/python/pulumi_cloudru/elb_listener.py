...
class ElbListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] loadbalancer_id: The load balancer on which to provision this listener. Changing this
               creates a new listener.
        :param pulumi.Input[builtins.str] protocol: The protocol can either be TCP, UDP, HTTP or HTTPS. Changing this creates a
               new listener.
        :param pulumi.Input[builtins.str] access_policy: Specifies the access policy for the listener. Valid options are *white* and
               *black*.
        :param pulumi.Input[builtins.bool] advanced_forwarding_enabled: Specifies whether to enable advanced forwarding.
               If advanced forwarding is enabled, more flexible forwarding policies and rules are supported.
        :param pulumi.Input[builtins.str] ca_certificate: Specifies the ID of the CA certificate used by the listener. This parameter is
               valid when protocol is set to *HTTPS*.
        :param pulumi.Input[builtins.str] default_pool_id: The ID of the default pool with which the listener is associated. Changing this
               creates a new listener.
        :param pulumi.Input[builtins.str] description: Human-readable description for the listener.
        :param pulumi.Input[builtins.bool] forward_eip: Specifies whether transfer the load balancer EIP in the X-Forward-EIP header to
               backend servers. The default value is false. This parameter is valid only when the protocol is set to *HTTP* or
               *HTTPS*.
        :param pulumi.Input[builtins.bool] http2_enable: Specifies whether to use HTTP/2. The default value is false. This parameter is valid
               only when the protocol is set to *HTTPS*.
        :param pulumi.Input[builtins.int] idle_timeout: Specifies the idle timeout for the listener. Value range: 0 to 4000.
        :param pulumi.Input[builtins.str] ip_group: Specifies the ip group id for the listener.
        :param pulumi.Input[builtins.str] name: Human-readable name for the listener.
        :param pulumi.Input[builtins.int] protocol_port: The port on which to listen for client traffic. Changing this creates a
               new listener.
        :param pulumi.Input[builtins.bool] real_ip: Specifies whether to transfer the source IP address of the client to backend servers
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the listener resource. If omitted, the
               provider-level region will be used. Changing this creates a new listener.
        :param pulumi.Input[builtins.int] request_timeout: Specifies the request timeout for the listener. Value range: 1 to 300. This
               parameter is valid when protocol is set to *HTTP* or *HTTPS*.
        :param pulumi.Input[builtins.int] response_timeout: Specifies the response timeout for the listener. Value range: 1 to 300. This
               parameter is valid when protocol is set to *HTTP* or *HTTPS*.
        :param pulumi.Input[builtins.str] server_certificate: Specifies the ID of the server certificate used by the listener. This
               parameter is mandatory when protocol is set to *HTTPS*.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sni_certificates: Lists the IDs of SNI certificates (server certificates with a domain name) used
               by the listener. This parameter is valid when protocol is set to *HTTPS*.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the listener.
        :param pulumi.Input[builtins.str] tls_ciphers_policy: Specifies the TLS cipher policy for the listener. Valid options are:
