...
class ElbLoadbalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the list of AZ names. Changing this parameter will create a
               new resource.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled. Valid values are **true** and **false**.
        :param pulumi.Input[builtins.bool] autoscaling_enabled: Specifies whether autoscaling is enabled. Valid values are **true** and
               **false**.
        :param pulumi.Input[builtins.str] bandwidth_charge_mode: Bandwidth billing type. Changing this parameter will create a
               new resource.
        :param pulumi.Input[builtins.int] bandwidth_size: Bandwidth size. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] cross_vpc_backend: Enable this if you want to associate the IP addresses of backend servers with
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the loadbalancer. Changing this
               creates a new loadbalancer.
        :param pulumi.Input[builtins.str] iptype: Elastic IP type. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ipv4_address: The ipv4 address of the load balancer.
        :param pulumi.Input[builtins.str] ipv4_eip_id: The ID of the EIP. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.str] ipv4_subnet_id: The **IPv4 subnet ID** of the subnet on which to allocate the loadbalancer's
               ipv4 address.
        :param pulumi.Input[builtins.str] ipv6_address: The ipv6 address of the Load Balancer.
        :param pulumi.Input[builtins.str] ipv6_bandwidth_id: The ipv6 bandwidth id. Only support shared bandwidth.
        :param pulumi.Input[builtins.str] ipv6_network_id: The **ID** of the subnet on which to allocate the loadbalancer's ipv6 address.
        :param pulumi.Input[builtins.str] l4_flavor_id: The L4 flavor id of the load balancer.
        :param pulumi.Input[builtins.str] l7_flavor_id: The L7 flavor id of the load balancer.
        :param pulumi.Input[builtins.str] min_l7_flavor_id: Specifies the ID of the minimum Layer-7 flavor for elastic scaling.
               This parameter cannot be left blank if there are HTTP or HTTPS listeners.
        :param pulumi.Input[builtins.str] name: Human-readable name for the loadbalancer.
        :param pulumi.Input[builtins.str] region: The region in which to create the loadbalancer resource. If omitted, the
               provider-level region will be used. Changing this creates a new loadbalancer.
        :param pulumi.Input[builtins.str] sharetype: Bandwidth sharing type. Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the loadbalancer.
        :param pulumi.Input[builtins.str] vpc_id: The vpc on which to create the loadbalancer. Changing this creates a new
               loadbalancer.
        """
...
class _ElbLoadbalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] iptype: Elastic IP type. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ipv4_address: The ipv4 address of the load balancer.
        :param pulumi.Input[builtins.str] ipv4_eip: The ipv4 eip address of the Load Balancer.
        :param pulumi.Input[builtins.str] ipv4_eip_id: The ID of the EIP. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.str] ipv6_address: The ipv6 address of the Load Balancer.
        :param pulumi.Input[builtins.str] ipv6_bandwidth_id: The ipv6 bandwidth id. Only support shared bandwidth.
        :param pulumi.Input[builtins.str] ipv6_eip: The ipv6 eip address of the Load Balancer.
        :param pulumi.Input[builtins.str] ipv6_eip_id: The ipv6 eip id of the Load Balancer.
        :param pulumi.Input[builtins.str] ipv6_network_id: The **ID** of the subnet on which to allocate the loadbalancer's ipv6 address.
        :param pulumi.Input[builtins.str] l4_flavor_id: The L4 flavor id of the load balancer.
        :param pulumi.Input[builtins.str] l7_flavor_id: The L7 flavor id of the load balancer.
        :param pulumi.Input[builtins.str] min_l7_flavor_id: Specifies the ID of the minimum Layer-7 flavor for elastic scaling.
