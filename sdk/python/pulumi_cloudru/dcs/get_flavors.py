...
def get_flavors(cache_mode: Optional[builtins.str] = None,
    ...
    :param builtins.str engine_version: The version of a cache engine.
    ...
    :param builtins.str region: Specifies the region in which to obtain the DCS flavors.
...
def get_flavors_output(cache_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
