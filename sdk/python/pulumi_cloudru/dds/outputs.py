...
class InstanceBackupStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int keep_days: Specifies the number of days to retain the generated backup files. The value range is
               from 0 to 732.
        ...
        :param builtins.str period: Specifies the charging period of the instance.
...
class InstanceConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: Specifies the ID of the template.
               Changing this creates a new instance.
        :param builtins.str type: Specifies the node type. Valid value:
...
class InstanceDatastore(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the DB engine. **DDS-Community** is supported.
        :param builtins.str version: Specifies the DB instance version. For the Community Edition, the valid
               values are `3.2`, `3.4`, `4.0`, `4.2`, or `4.4`.
        :param builtins.str storage_engine: Specifies the storage engine of the DB instance.
...
class InstanceFlavor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int num: Specifies the node quantity. Valid value:
        ...
        :param builtins.str spec_code: Specifies the resource specification code. In a cluster instance, multiple
        ...
        :param builtins.str type: Specifies the node type. Valid value:
               ...
               + For a Community Edition replica set instance, the value is **replica**.
               + For a Community Edition single node instance, the value is **single**.
        :param builtins.int size: Specifies the disk size. The value must be a multiple of 10. The unit is GB. This parameter
        ...
        :param builtins.str storage: Specifies the disk type.
...
class InstanceGroup(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: Specifies the DB instance name. The DB instance name of the same type is unique in the
               same tenant.
        :param Sequence['InstanceGroupNodeArgs'] nodes: Indicates the instance nodes information. Structure is documented below.
        :param builtins.str size: Specifies the disk size. The value must be a multiple of 10. The unit is GB. This parameter
               is mandatory for nodes except mongos and invalid for mongos. This parameter can be updated when the value of `type` is
               shard, replica or single.
...
class InstanceGroupNode(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Specifies the DB instance name. The DB instance name of the same type is unique in the
               same tenant.
        :param builtins.str private_ip: Indicates the private IP address of a node. This parameter is valid only for mongos nodes, replica set
               instances, and single node instances.
        :param builtins.str public_ip: Indicates the EIP that has been bound on a node. This parameter is valid only for mongos nodes of
