...
class RabbitmqInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_user: Specifies a username. A username consists of 4 to 64 characters and
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the names of an AZ.
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are
               **prePaid** and **postPaid**, defaults to **postPaid**. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the DMS RabbitMQ instance.
               It is a character string containing not more than 1,024 characters.
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of the RabbitMQ engine. Default to "3.7.17".
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID of the RabbitMQ instance.
        :param pulumi.Input[builtins.str] flavor_id: Specifies a flavor ID.
               It is mandatory when the `charging_mode` is **prePaid**.
        :param pulumi.Input[builtins.str] maintain_begin: Specifies the time at which a maintenance time window starts. Format: HH:mm.
        ...
        :param pulumi.Input[builtins.str] maintain_end: Specifies the time at which a maintenance time window ends. Format: HH:mm.
               The start time and end time of a maintenance time window must indicate the time segment of a supported maintenance
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the DMS RabbitMQ instance. An instance name starts with a letter,
               consists of 4 to 64 characters, and supports only letters, digits, hyphens (-) and underscores (_).
        :param pulumi.Input[builtins.str] password: Specifies the password of the DMS RabbitMQ instance. A password must meet
               ...
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the instance. If `period_unit` is set to
        ...
        :param pulumi.Input[builtins.str] public_ip_id: Specifies the ID of the elastic IP address (EIP)
               bound to the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS RabbitMQ instance resource. If omitted,
               the provider-level region will be used. Changing this creates a new instance resource.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether to enable public access for the DMS RabbitMQ instance.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage space, unit is GB.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the DMS RabbitMQ instance.
        """
...
class _RabbitmqInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the instance. Valid values are
               **prePaid** and **postPaid**, defaults to **postPaid**. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] connect_address: Indicates the IP address of the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] description: Specifies the description of the DMS RabbitMQ instance.
               It is a character string containing not more than 1,024 characters.
        :param pulumi.Input[builtins.bool] enable_public_ip: Indicates whether public access to the DMS RabbitMQ instance is enabled.
        ...
        :param pulumi.Input[builtins.str] maintain_end: Specifies the time at which a maintenance time window ends. Format: HH:mm.
               ...
               If parameter `maintain_end` is left  blank, parameter `maintain_begin` is also blank.
               In this case, the system automatically allocates the default end time 06:00.
        :param pulumi.Input[builtins.str] management_connect_address: Indicates the management address of the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] name: Specifies the name of the DMS RabbitMQ instance. An instance name starts with a letter,
               consists of 4 to 64 characters, and supports only letters, digits, hyphens (-) and underscores (_).
        :param pulumi.Input[builtins.str] network_id: Specifies the ID of a subnet. Changing this creates a new instance
               resource.
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
               Valid values are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.int] port: Indicates the port number of the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] public_ip_id: Specifies the ID of the elastic IP address (EIP)
               bound to the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] region: The region in which to create the DMS RabbitMQ instance resource. If omitted,
               the provider-level region will be used. Changing this creates a new instance resource.
        ...
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group.
        :param pulumi.Input[builtins.str] specification: Indicates the instance specification. For a single-node DMS RabbitMQ instance, VM specifications are
               returned. For a cluster DMS RabbitMQ instance, VM specifications and the number of nodes are returned.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether to enable public access for the DMS RabbitMQ instance.
               Changing this creates a new instance resource.
        :param pulumi.Input[builtins.str] status: Indicates the status of the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.int] storage_space: Specifies the message storage space, unit is GB.
               It is required when creating a instance with `flavor_id`. Value range:
               + Single-node RabbitMQ instance: 100–90000 GB
               + Cluster RabbitMQ instance: 100 GB x Number of nodes to 90000 GB, 200 GB x Number of nodes to 90000 GB,
        ...
        :param pulumi.Input[builtins.str] storage_spec_code: Specifies the storage I/O specification.
               ...
               Changing this creates a new instance resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the DMS RabbitMQ instance.
        :param pulumi.Input[builtins.str] type: Indicates the DMS RabbitMQ instance type.
        :param pulumi.Input[builtins.int] used_storage_space: Indicates the used message storage space. Unit: GB
        :param pulumi.Input[builtins.str] user_id: Indicates the ID of the user who created the DMS RabbitMQ instance
        :param pulumi.Input[builtins.str] user_name: Indicates the name of the user who created the DMS RabbitMQ instance
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC. Changing this creates a new instance resource.
        """
        if access_user is not None:
            pulumi.set(__self__, "access_user", access_user)
...
class RabbitmqInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RabbitmqInstance':
        """
