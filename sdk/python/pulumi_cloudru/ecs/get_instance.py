...
def get_instance(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: Specifies the ECS ID.
           *
    :param builtins.str name: Specifies the ECS name, which can be queried with a regular expression.
    :param builtins.str region: The region in which to obtain the instance. If omitted, the provider-level region will
           be used.
...
def get_instance_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
