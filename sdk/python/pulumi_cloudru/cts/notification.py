...
class NotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operation_type: Specifies the operation type, possible options include **complete** and
               **customized**.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether notification is enabled, defaults to true.
               
               <a name="notification_operations_object"></a>
               The `operations` block supports:
        :param pulumi.Input[builtins.str] name: Specifies the notification name. The value contains a maximum of 64 characters,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NotificationOperationArgs']]] operations: Specifies an array of operations that will trigger notifications.
               ...
               The object structure is documented below.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to manage the CTS notification resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] smn_topic: Specifies the URN of a topic.
        """
...
class _NotificationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the notification name. The value contains a maximum of 64 characters,
               and only letters, digits, underscores(_), and Chinese characters are allowed.
        :param pulumi.Input[builtins.str] notification_id: The notification ID in UUID format.
        :param pulumi.Input[builtins.str] operation_type: Specifies the operation type, possible options include **complete** and
               **customized**.
        :param pulumi.Input[Sequence[pulumi.Input['NotificationOperationUserArgs']]] operation_users: Specifies an array of users. Notifications will be sent when specified users
               perform specified operations. All users are selected by default.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to manage the CTS notification resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] smn_topic: Specifies the URN of a topic.
        :param pulumi.Input[builtins.str] status: The notification status, the value can be **enabled** or **disabled**.
        """
        if agency_name is not None:
            pulumi.set(__self__, "agency_name", agency_name)
...
class Notification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            smn_topic: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Notification':
        """
