...
class BandwidthPolicyScheduledPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] launch_time: Specifies the time when the scaling action is triggered.
               The time format complies with UTC.
               - If scaling_policy_type is set to SCHEDULED, the time format is YYYY-MM-DDThh:mmZ.
               - If scaling_policy_type is set to RECURRENCE, the time format is hh:mm.
...
class ConfigurationInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] charging_mode: Specifies a billing mode for an ECS.
               The value can be `postPaid` and `spot`. The default value is `postPaid`.
               Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input['ConfigurationInstanceConfigDiskArgs']]] disks: Specifies the disk group information. System disks are mandatory and
               data disks are optional. The object structure is documented below.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] ecs_group_id: Specifies the ECS group ID. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] flavor: Specifies the ECS flavor name. A maximum of 10 flavors can be selected.
               Use a comma (,) to separate multiple flavor names. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] flavor_priority_policy: Specifies the priority policy used when there are multiple flavors
               and instances to be created using an AS configuration. The value can be `PICK_FIRST` and `COST_FIRST`.
               ...
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] image: Specifies the ECS image ID. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ECS instance ID when using its specification
               as the template to create AS configurations. In this case, `flavor`, `image`, and `disk` arguments do not take effect.
               If this argument is not specified, `flavor`, `image`, and `disk` arguments are mandatory.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] key_name: Specifies the name of the SSH key pair used to log in to the instance.
               Changing this will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Specifies the key/value pairs to make available from within the instance.
               Changing this will create a new resource.
        ...
        :param pulumi.Input['ConfigurationInstanceConfigPublicIpArgs'] public_ip: Specifies the EIP of the ECS instance.
               The object structure is documented below.
               Changing this will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Specifies an array of one or more security group IDs.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] user_data: Specifies the user data to provide when launching the instance.
               The file content must be encoded with Base64. Changing this will create a new resource.
        """
...
class ConfigurationInstanceConfigDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] disk_type: Specifies whether the disk is a system disk or a data disk.
               Option **DATA** indicates a data disk, option **SYS** indicates a system disk.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] volume_type: Specifies the disk type. Changing this will create a new resource.
               Available options are:
               + `SAS`: high I/O disk type.
               + `SSD`: ultra-high I/O disk type.
               + `GPSSD`: general purpose SSD disk type.
        :param pulumi.Input[builtins.str] kms_id: Specifies the encryption KMS ID of the **DATA** disk.
               Changing this will create a new resource.
...
class ConfigurationInstanceConfigPersonalityArgs:
    def __init__(__self__, *,
                 ...
                 path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: Specifies the content of the injected file, which must be encoded with base64.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] path: Specifies the path of the injected file. Changing this creates a new resource.
        """
...
class ConfigurationInstanceConfigPublicIpEipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConfigurationInstanceConfigPublicIpEipBandwidthArgs'] bandwidth: Specifies the bandwidth information. The object structure is documented below.
               Changing this will create a new resource.
        :param pulumi.Input[builtins.str] ip_type: Specifies the EIP type. Possible values are **5_bgp** (dynamic BGP)
               and **5_sbgp** (static BGP). Changing this will create a new resource.
        """
...
class ConfigurationInstanceConfigPublicIpEipBandwidthArgs:
    def __init__(__self__, *,
                 ...
                 size: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] share_type: Specifies the bandwidth sharing type. The system only supports
               **PER** (indicates exclusive bandwidth). Changing this will create a new resource.
        :param pulumi.Input[builtins.str] charging_mode: Specifies whether the bandwidth is billed by traffic or by bandwidth
               size. The value can be **traffic** or **bandwidth**. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] id: The resource ID in UUID format.
        :param pulumi.Input[builtins.int] size: Specifies the bandwidth (Mbit/s). The value range for bandwidth billed by bandwidth
               is 1 to 2000 and that for bandwidth billed by traffic is 1 to 300.
               Changing this creates a new resource.
...
class GroupLbaasListenerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] pool_id: Specifies the backend ECS group ID.
        :param pulumi.Input[builtins.int] protocol_port: Specifies the backend protocol, which is the port on which a backend ECS listens for
               traffic. The number of the port ranges from 1 to 65535.
        :param pulumi.Input[builtins.int] weight: Specifies the weight, which determines the portion of requests a backend ECS processes
               compared to other backend ECSs added to the same listener. The value of this parameter ranges from 0 to 100. The
               default value is 1.
        """
...
class GroupNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: Specifies the ID of the security group.
               
               <a name="group_lbaas_listener_object"></a>
               The `lbaas_listeners` block supports:
        :param pulumi.Input[builtins.str] ipv6_bandwidth_id: Specifies the ID of the shared bandwidth of an IPv6 address.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to support IPv6 addresses. The default value is `false`.
        :param pulumi.Input[builtins.bool] source_dest_check: Specifies whether processesing only traffic that is destined specifically
               for it. Defaults to true.
...
class PolicyScalingPolicyActionArgs:
    def __init__(__self__, *,
                 ...
                 operation: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] instance_number: Specifies the number of instances to be operated. The default number is 1.
        :param pulumi.Input[builtins.str] operation: Specifies the operation to be performed. The options include `ADD` (default), `REMOVE`,
               and `SET`.
        """
...
class PolicyScheduledPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] launch_time: Specifies the time when the scaling action is triggered.
               ...
               > the `launch_time` of the `SCHEDULED` policy cannot be earlier than the current time.
        :param pulumi.Input[builtins.str] end_time: Specifies the end time of the scaling action triggered periodically. The time format complies
               with UTC. This argument is mandatory when `scaling_policy_type`
               is set to `RECURRENCE`. The time format is YYYY-MM-DDThh:mmZ.
               
               <a name="scaling_policy_action_object"></a>
               The `scaling_policy_action` block supports:
        :param pulumi.Input[builtins.str] recurrence_type: Specifies the periodic triggering type. This argument is mandatory when
               `scaling_policy_type` is set to `RECURRENCE`. The options include `Daily`, `Weekly`, and `Monthly`.
        :param pulumi.Input[builtins.str] recurrence_value: Specifies the frequency at which scaling actions are triggered.
        :param pulumi.Input[builtins.str] start_time: Specifies the start time of the scaling action triggered periodically. The time format
               complies with UTC. The current time is used by default. The time format is YYYY-MM-DDThh:mmZ.
        """
        pulumi.set(__self__, "launch_time", launch_time)
        if end_time is not None:
