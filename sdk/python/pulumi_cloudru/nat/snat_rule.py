...
class SnatRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nat_gateway_id: ID of the nat gateway this snat rule belongs to.
               Changing this creates a new snat rule.
        :param pulumi.Input[builtins.str] cidr: Specifies CIDR, which can be in the format of a network segment or a host IP address.
               This parameter and `network_id` are alternative. Changing this creates a new snat rule.
        :param pulumi.Input[builtins.str] description: Specifies the description of the SNAT rule.
               The value is a string of no more than `255` characters, and angle brackets (<>) are not allowed.
        :param pulumi.Input[builtins.str] floating_ip_id: ID of the floating ip this snat rule connets to.
               Changing this creates a new snat rule.
        :param pulumi.Input[builtins.str] global_eip_id: The IDs (separated by commas) of global EIPs connected by SNAT rule.
        :param pulumi.Input[builtins.str] region: The region in which to create the snat rule resource. If omitted, the provider-level region will be used. Changing this creates a new snat rule resource.
        :param pulumi.Input[builtins.int] source_type: Specifies the scenario. The valid value is 0 (VPC scenario) and 1 (Direct Connect scenario).
               Defaults to 0, only `cidr` can be specified over a Direct Connect connection.
               Changing this creates a new snat rule.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the network IDs of subnet connected by SNAT rule (VPC side).  
...
class SnatRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_type: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SnatRule':
        """
