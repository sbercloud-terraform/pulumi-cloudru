...
class SqlserverDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the database name. The database name can contain 1 to 64 characters,
...
class _SqlserverDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] state: Indicates the database status. Its value can be any of the following:
...
class SqlserverDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlserverDatabase':
        """
