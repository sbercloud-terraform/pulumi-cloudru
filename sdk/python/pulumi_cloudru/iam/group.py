...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the group.
        :param pulumi.Input[builtins.str] name: Specifies the name of the group.The length is less than or equal to 64 bytes.
        """
