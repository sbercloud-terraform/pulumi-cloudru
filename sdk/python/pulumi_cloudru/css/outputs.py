...
class ClusterBackupStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str start_time: Specifies the time when a snapshot is automatically created everyday. Snapshots can
               ...
               and "01:00 GMT+08:00".
        :param builtins.str agency: Specifies the IAM agency used to access OBS.
        ...
        :param builtins.str backup_path: Specifies the storage path of the snapshot in the OBS bucket.
        :param builtins.str bucket: Specifies the OBS bucket used for index data backup. If there is snapshot data in an OBS
               bucket, only the OBS bucket is used and cannot be changed.
        :param builtins.int keep_days: Specifies the number of days to retain the generated snapshots. Snapshots are reserved
               for seven days by default.
        :param builtins.str prefix: Specifies the prefix of the snapshot that is automatically created. Defaults to **snapshot**.
        """
...
class ClusterClientNodeConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 shrink_node_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str flavor: Specifies the flavor name.
        :param builtins.int instance_number: Specifies the number of cluster instances.
        ...
        :param Sequence[builtins.str] shrink_node_ids: Specifies the node IDs that needs to be scaled down.
    ...
    def shrink_node_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterClientNodeConfigVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int size: Specifies the volume size in **GB**, which must be a multiple of `10`.
        :param builtins.str volume_type: Specifies the volume type. Value options are as follows:
...
class ClusterKibanaPublicAccess(dict):
    ...
    def __init__(__self__, *,
                 ...
                 whitelist_enabled: builtins.bool,
                 public_ip: Optional[builtins.str] = None,
                 whitelist: Optional[builtins.str] = None):
        """
        :param builtins.int bandwidth: Specifies the public network bandwidth.
        :param builtins.bool whitelist_enabled: Specifies whether to enable the public network access control.
        :param builtins.str whitelist: Specifies the whitelist of access control. The whitelisted account id must be unique.
        """
    ...
    def whitelist_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def whitelist(self) -> Optional[builtins.str]:
        """
...
class ClusterNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_zone: Specifies the availability zone name.
        ...
        :param builtins.str ip: Instance IP address.
        :param builtins.str name: Specifies the cluster name. It contains `4` to `32` characters.
               Only letters, digits, hyphens (-), and underscores (_) are allowed. The value must start with a letter.
               Changing this parameter will create a new resource.
        :param builtins.str resource_id: The resource ID of this instance.
        :param builtins.str spec_code: Instance specification code.
        :param builtins.str status: Instance status.
        :param builtins.str type: Node type. The options are as follows:
...
class ClusterNodeConfigNetworkInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param builtins.str security_group_id: Specifies the security group ID.
        :param builtins.str subnet_id: Specifies the Subnet ID.
               Changing this parameter will create a new resource.
...
class ClusterVpcepEndpoint(dict):
    ...
    def __init__(__self__, *,
                 endpoint_with_dns_name: builtins.bool,
                 whitelists: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool endpoint_with_dns_name: Specifies whether to enable the private domain name.
        :param Sequence[builtins.str] whitelists: Specifies the whitelist of access control. The whitelisted account id must be unique.
        """
    ...
    def endpoint_with_dns_name(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def whitelists(self) -> Optional[Sequence[builtins.str]]:
        """
        Specifies the whitelist of access control. The whitelisted account id must be unique.
        """
...
class GetFlavorsFlavorResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str disk_range: The disk capacity range of an instance, in GB.
        :param builtins.str id: The ID of CSS flavor.
        :param builtins.int memory: Specifies the memory size(GB) in the CSS flavor.
        :param builtins.str name: Specifies the name of the CSS flavor.
        :param builtins.str region: Specifies the region in which to obtain the CSS flavors. If omitted, the
               provider-level region will be used.
        :param builtins.str type: Specifies the node instance type. The options are `ess`, `ess-cold`, `ess-master`
               and `ess-client`.
        :param builtins.int vcpus: Specifies the number of vCPUs in the CSS flavor.
        :param builtins.str version: Specifies the engine version. The options are `5.5.1`, `6.2.3`, `6.5.4`, `7.1.1`,
               `7.6.2` and `7.9.3`.
        """
