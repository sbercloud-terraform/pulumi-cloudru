...
class AclRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action in the network ACL rule. Currently, the value can be *allow* or
               *deny*.
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol supported by the network ACL rule. Valid values are: *tcp*,
               *udp* and *icmp*.
        :param pulumi.Input[builtins.str] description: Specifies the description for the network ACL rule.
        :param pulumi.Input[builtins.str] destination_ip_address: Specifies the destination IP address to which the traffic is allowed.
               The default value is *0.0.0.0/0*. For example: xxx.xxx.xxx.xxx (IP address), xxx.xxx.xxx.0/24 (CIDR block).
        :param pulumi.Input[builtins.str] destination_port: Specifies the destination port number or port number range. The value ranges
               from 1 to 65535. For a port number range, enter two port numbers connected by a colon(:). For example, 1:100.
        :param pulumi.Input[builtins.bool] enabled: Enabled status for the network ACL rule. Defaults to true.
        :param pulumi.Input[builtins.int] ip_version: Specifies the IP version, either 4 (default) or 6. This parameter is available after
               the IPv6 function is enabled.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the network ACL rule.
        :param pulumi.Input[builtins.str] region: The region in which to create the network ACL rule resource. If omitted, the
               provider-level region will be used. Changing this creates a new network ACL rule resource.
        :param pulumi.Input[builtins.str] source_ip_address: Specifies the source IP address that the traffic is allowed from. The default
               value is *0.0.0.0/0*. For example: xxx.xxx.xxx.xxx (IP address), xxx.xxx.xxx.0/24 (CIDR block).
        :param pulumi.Input[builtins.str] source_port: Specifies the source port number or port number range. The value ranges from 1 to
...
class AclRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            source_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            source_port: Optional[pulumi.Input[builtins.str]] = None) -> 'AclRule':
        """
