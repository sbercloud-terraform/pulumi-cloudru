...
class BucketArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Specifies the name of the bucket. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.str] acl: Specifies the ACL policy for a bucket. The predefined common policies are as follows: "private", "public-read", "public-read-write" and "log-delivery-write". Defaults to `private`.
        ...
        :param pulumi.Input[builtins.bool] encryption: Whether enable default server-side encryption of the bucket in SSE-KMS mode.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the OBS bucket. Changing this creates a OBS bucket.
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all objects should be deleted from the bucket so that the bucket can be destroyed without error. Default to `false`.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the ID of a KMS key. If omitted, the default master key will be used.
        :param pulumi.Input[builtins.str] kms_key_project_id: Specifies the project ID to which the KMS key belongs. If omitted, the ID
        ...
        :param pulumi.Input[builtins.bool] multi_az: Whether enable the multi-AZ mode for the bucket. When the multi-AZ mode is
        ...
        :param pulumi.Input[builtins.bool] parallel_fs: Whether enable a bucket as a parallel file system. Changing this will
               create a new bucket.
        :param pulumi.Input[builtins.str] policy: Specifies the text of the bucket policy in JSON format. For more information about
               obs format bucket policy, see the [Developer Guide](https://support.hc.sbercloud.ru/api/obs/obs_04_0027.html).
        :param pulumi.Input[builtins.str] policy_format: Specifies the policy format, the supported values are *obs* and *s3*. Defaults to *obs*.
        :param pulumi.Input[builtins.int] quota: Specifies bucket storage quota. Must be a positive integer in the unit of byte. The maximum storage quota is 2<sup>63</sup> – 1 bytes. The default bucket storage quota is 0, indicating that the bucket storage quota is not limited.
        :param pulumi.Input[builtins.str] region: Specified the region where this bucket will be created. If not specified, used the region by the provider.
        :param pulumi.Input[builtins.str] storage_class: Specifies the storage class of the bucket. OBS provides three storage classes: "STANDARD", "WARM" (Infrequent Access) and "COLD" (Archive). Defaults to `STANDARD`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the bucket. Each tag is represented by one key-value pair.
        :param pulumi.Input[builtins.bool] versioning: Whether enable versioning. Once you version-enable a bucket, it can never return to an unversioned state.
...
class _BucketState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Specifies the name of the bucket. Changing this parameter will create a new resource.
               ...
               * The name cannot be an IP address.
               * If the name contains any periods (.), a security certificate verification message may appear when you access the bucket or its objects by entering a domain name.
        :param pulumi.Input[builtins.str] bucket_domain_name: The bucket domain name. Will be of format `bucketname.obs.region.hc.sbercloud.ru`.
        :param pulumi.Input[builtins.str] bucket_version: The OBS version of the bucket.
        :param pulumi.Input[Sequence[pulumi.Input['BucketCorsRuleArgs']]] cors_rules: A rule of Cross-Origin Resource Sharing (documented below).
        :param pulumi.Input[builtins.bool] encryption: Whether enable default server-side encryption of the bucket in SSE-KMS mode.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the OBS bucket. Changing this creates a OBS bucket.
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all objects should be deleted from the bucket so that the bucket can be destroyed without error. Default to `false`.
