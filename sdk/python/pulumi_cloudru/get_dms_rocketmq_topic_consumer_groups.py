...
def get_dms_rocketmq_topic_consumer_groups(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str topic_name: Specifies the topic name.
    """
    __args__ = dict()
...
def get_dms_rocketmq_topic_consumer_groups_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
