...
def get_subnet(availability_zone: Optional[builtins.str] = None,
    ...
    * `ipv6_gateway` - The IPv6 subnet gateway.
    ...
    :param builtins.str availability_zone: Specifies the availability zone (AZ) to which the subnet should belong.
    :param builtins.str cidr: Specifies the network segment of specific subnet to retrieve. The value must be in CIDR
           format.
    :param builtins.str gateway_ip: Specifies the subnet gateway address of specific subnet.
    :param builtins.str id: Specifies a resource ID in UUID format.
    :param builtins.str name: Specifies the name of the specific subnet to retrieve.
    :param builtins.str primary_dns: Specifies the IP address of DNS server 1 on the specific subnet.
    :param builtins.str region: Specifies the region in which to obtain the subnet. If omitted, the provider-level
           region will be used.
    :param builtins.str secondary_dns: Specifies the IP address of DNS server 2 on the specific subnet.
    :param builtins.str status: Specifies the value can be ACTIVE, DOWN, UNKNOWN, or ERROR.
...
def get_subnet_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
