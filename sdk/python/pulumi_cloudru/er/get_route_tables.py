...
def get_route_tables(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: Specifies the ID of the ER instance to which the route tables belongs.
    ...
    :param builtins.str region: Specifies the region where the ER instance and route table are located.  
           If omitted, the provider-level region will be used.
    :param builtins.str route_table_id: Specifies the route table ID used to query specified route table.
...
def get_route_tables_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
