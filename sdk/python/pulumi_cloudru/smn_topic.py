...
class SmnTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Topic display name, which is presented as the
               name of the email sender in an email message.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the SMN Topic, Value 0
               indicates the default enterprise project. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: The name of the topic to be created.
        :param pulumi.Input[builtins.str] region: The region in which to create the SMN topic resource. If omitted, the provider-level region will be used. Changing this creates a new SMN Topic resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the SMN topic, key/value pair format.
        """
...
class _SmnTopicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_policy: schema: Internal
        :param pulumi.Input[builtins.str] create_time: Time when the topic was created.
        :param pulumi.Input[builtins.str] display_name: Topic display name, which is presented as the
               name of the email sender in an email message.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the SMN Topic, Value 0
               indicates the default enterprise project. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: The name of the topic to be created.
        :param pulumi.Input[builtins.int] push_policy: Message pushing policy.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the SMN topic resource. If omitted, the provider-level region will be used. Changing this creates a new SMN Topic resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the SMN topic, key/value pair format.
        :param pulumi.Input[builtins.str] topic_urn: Resource identifier of a topic, which is unique.
        :param pulumi.Input[builtins.str] update_time: Time when the topic was updated.
        """
        if access_policy is not None:
            pulumi.set(__self__, "access_policy", access_policy)
