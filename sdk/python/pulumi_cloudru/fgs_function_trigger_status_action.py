...
class FgsFunctionTriggerStatusActionArgs:
    def __init__(__self__, *,
                 event_data: pulumi.Input[builtins.str],
                 function_urn: pulumi.Input[builtins.str],
                 trigger_id: pulumi.Input[builtins.str],
                 trigger_status: pulumi.Input[builtins.str],
                 trigger_type_code: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] event_data: The event data of the trigger.
        :param pulumi.Input[builtins.str] function_urn: The URN of the function.
        :param pulumi.Input[builtins.str] trigger_id: The trigger ID.
        :param pulumi.Input[builtins.str] trigger_status: The status of the trigger. Valid values are ACTIVE and DISABLED.
        :param pulumi.Input[builtins.str] trigger_type_code: The trigger type code.
        :param pulumi.Input[builtins.str] region: The region where the function trigger is located.
        """
    ...
    def event_data(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @event_data.setter
    def event_data(self, value: pulumi.Input[builtins.str]):
    ...
    def trigger_status(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def trigger_status(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "trigger_status", value)

    @property
    @pulumi.getter(name="triggerTypeCode")
    def trigger_type_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def trigger_type_code(self, value: pulumi.Input[builtins.str]):
...
class _FgsFunctionTriggerStatusActionState:
    def __init__(__self__, *,
                 enable_force_new: Optional[pulumi.Input[builtins.str]] = None,
                 event_data: Optional[pulumi.Input[builtins.str]] = None,
                 function_urn: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_id: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_status: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_type_code: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="eventData")
    def event_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The event data of the trigger.
        """
        return pulumi.get(self, "event_data")
    ...
    @event_data.setter
    def event_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_data", value)
    ...
    @property
    @pulumi.getter(name="triggerStatus")
    def trigger_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The status of the trigger. Valid values are ACTIVE and DISABLED.
        """
        return pulumi.get(self, "trigger_status")
    ...
    @trigger_status.setter
    def trigger_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trigger_status", value)

    @property
    @pulumi.getter(name="triggerTypeCode")
    def trigger_type_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The trigger type code.
        """
        return pulumi.get(self, "trigger_type_code")
    ...
    @trigger_type_code.setter
    def trigger_type_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trigger_type_code", value)
...
class FgsFunctionTriggerStatusAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trigger_id: Optional[pulumi.Input[builtins.str]] = None,
            trigger_status: Optional[pulumi.Input[builtins.str]] = None,
            trigger_type_code: Optional[pulumi.Input[builtins.str]] = None) -> 'FgsFunctionTriggerStatusAction':
        """
    ...
    @property
    @pulumi.getter(name="eventData")
    def event_data(self) -> pulumi.Output[builtins.str]:
        """
        The event data of the trigger.
        """
        return pulumi.get(self, "event_data")
    ...
    @property
    @pulumi.getter(name="triggerTypeCode")
    def trigger_type_code(self) -> pulumi.Output[builtins.str]:
        """
        The trigger type code.
        """
        return pulumi.get(self, "trigger_type_code")
