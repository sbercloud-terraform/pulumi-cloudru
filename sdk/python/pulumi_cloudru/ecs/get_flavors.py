...
def get_flavors(availability_zone: Optional[builtins.str] = None,
    ...
    ***
    ...
    :param builtins.str availability_zone: Specifies the AZ name.
    ...
    :param builtins.str region: The region in which to obtain the flavors. If omitted, the provider-level region will be used.
    """
    __args__ = dict()
