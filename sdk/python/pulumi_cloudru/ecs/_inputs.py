...
class InstanceBandwidthArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] share_type: Specifies the bandwidth sharing type. Changing this creates a new instance.
               Possible values are as follows:
               + **PER**: Dedicated bandwidth
               + **WHOLE**: Shared bandwidth
        :param pulumi.Input[builtins.str] charge_mode: Specifies the bandwidth billing mode. The value can be *traffic* or *bandwidth*.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] id: Specifies the **shared** bandwidth id. This parameter is mandatory when
               `share_type` is set to **WHOLE**. Changing this creates a new instance.
        :param pulumi.Input[builtins.int] size: Specifies the bandwidth size. The value ranges from 1 to 300 Mbit/s.
               This parameter is mandatory when `share_type` is set to **PER**. Changing this creates a new instance.
        """
...
class InstanceDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size: Specifies the data disk size, in GB. The value ranges form 10 to 32768.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] type: Specifies the ECS data disk type, which must be one of available disk types,
               contains of *SSD*, *GPSSD* and *SAS*. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the ID of a KMS key. This is used to encrypt the disk.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] snapshot_id: Specifies the snapshot id. Changing this creates a new instance.
        """
        pulumi.set(__self__, "size", size)
...
class InstanceNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] access_network: Specifies if this network should be used for provisioning access.
               Accepts true or false. Defaults to false.
        :param pulumi.Input[builtins.str] fixed_ip_v4: Specifies a fixed IPv4 address to be used on this network.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] fixed_ip_v6: The Fixed IPv6 address of the instance on that network.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 function is enabled for the nic.
               Defaults to false. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] mac: The MAC address of the NIC on that network.
        :param pulumi.Input[builtins.str] port: The port ID corresponding to the IP address on that network.
        :param pulumi.Input[builtins.bool] source_dest_check: Specifies whether the ECS processes only traffic that is destined specifically
               for it. This function is enabled by default but should be disabled if the ECS functions as a SNAT server or has a
               virtual IP address bound to it.
        :param pulumi.Input[builtins.str] uuid: Specifies the network UUID to attach to the instance.
               Changing this creates a new instance.
        """
...
class InstanceSchedulerHintArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] deh_id: Specifies the ID of DeH.
               This parameter takes effect only when the value of tenancy is dedicated. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] fault_domain: schema: Internal
        :param pulumi.Input[builtins.str] group: Specifies a UUID of a Server Group.
               The instance will be placed into that group. Changing this creates a new instance.
        :param pulumi.Input[builtins.str] tenancy: Specifies the tenancy specifies whether the ECS is to be created on a
               Dedicated Host
               (DeH) or in a shared pool. Changing this creates a new instance.
        """
...
class InstanceVolumeAttachedArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] boot_index: The volume boot index on that attachment.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the ID of a KMS key. This is used to encrypt the disk.
               Changing this creates a new instance.
        :param pulumi.Input[builtins.str] pci_address: The volume pci address on that attachment.
        :param pulumi.Input[builtins.int] size: The volume size on that attachment.
        :param pulumi.Input[builtins.str] type: The volume type on that attachment.
        :param pulumi.Input[builtins.str] volume_id: The volume ID on that attachment.
        """
