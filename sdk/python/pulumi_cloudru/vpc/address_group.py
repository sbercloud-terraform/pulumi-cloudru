...
class AddressGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: Specifies an array of one or more IP addresses. The address can be a single IP
               address, IP address range or IP address CIDR. The maximum length is 20.
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the IP address group.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the IP address group name. The value is a string of 1 to 64 characters that can contain
               letters, digits, underscores (_), hyphens (-) and periods (.).
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the IP address group. If omitted, the
...
class AddressGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_capacity: Optional[pulumi.Input[builtins.int]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressGroup':
        """
