...
class AccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_id: Specifies the ID of the user who is requesting to create an access key.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the access key.
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form
               `keybase:some_person_that_exists`. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] secret_file: Specifies the file name that can save access key and access secret key.
               Defaults to *./credentials-{{user name}}.csv*. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] status: Specifies the status of the access key. It must be *active* or *inactive*. Default value
               is *active*.
        """
...
class _AccessKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The time when the access key was created.
        :param pulumi.Input[builtins.str] description: Specifies the description of the access key.
        :param pulumi.Input[builtins.str] key_fingerprint: The fingerprint of the PGP key used to encrypt the secret
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form
               `keybase:some_person_that_exists`. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] secret: The access secret key. Setting the value only when writing to `secret_file` failed.
        :param pulumi.Input[builtins.str] secret_file: Specifies the file name that can save access key and access secret key.
               Defaults to *./credentials-{{user name}}.csv*. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] status: Specifies the status of the access key. It must be *active* or *inactive*. Default value
               is *active*.
        :param pulumi.Input[builtins.str] user_id: Specifies the ID of the user who is requesting to create an access key.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] user_name: The name of IAM user.
        """
