...
class StreamPartitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] hash_range: Possible value range of the hash key used by each partition.
        :param pulumi.Input[builtins.str] id: The ID of the partition.
        :param pulumi.Input[builtins.str] sequence_number_range: Sequence number range of each partition.
