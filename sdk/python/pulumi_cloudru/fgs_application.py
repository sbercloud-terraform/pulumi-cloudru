...
class FgsApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agency_name: Specifies the agency name used by the application.  
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the application.  
               The description can contain a maximum of `1,024` characters.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the application name.  
               The name can contain a maximum of 60 characters and must start with a letter and end with a letter or digit.
               Only letters, digits, underscores (_) and hyphens (-) are allowed.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] params: Specifies the template parameters, in JSON format.  
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create an application.  
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] template_id: Specifies the ID of the template used by the application.  
               Changing this parameter will create a new resource.
        """
