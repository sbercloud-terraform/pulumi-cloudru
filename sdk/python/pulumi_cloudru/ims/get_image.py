...
def get_image(architecture: Optional[builtins.str] = None,
    ...
    :param builtins.str architecture: Specifies the image architecture type. The value can be **x86** and **arm**.
    :param builtins.str enterprise_project_id: Specifies the enterprise project ID of the image.
    :param builtins.str flavor_id: Specifies the ECS flavor ID used to filter out available images.
           You can specify only one flavor ID and only ECS flavor ID is valid, BMS flavor is not supported.
    :param builtins.str image_type: Specifies the environment where the image is used. For a BMS image, the value is **Ironic**.
    :param builtins.bool most_recent: If more than one result is returned, use the latest updated image.
    :param builtins.str name: The name of the image. Cannot be used simultaneously with `name_regex`.
    :param builtins.str name_regex: The regular expressian of the name of the image.
           Cannot be used simultaneously with `name`.
    :param builtins.str os: Specifies the image OS type. The value can be **Windows**, **Ubuntu**,
           **RedHat**, **SUSE**, **CentOS**, **Debian**, **OpenSUSE**, **Oracle Linux**, **Fedora**, **Other**,
           **CoreOS**, or **EulerOS**.
    :param builtins.str os_version: Specifies the OS version. For example, *CentOS 7.4 64bit* or *Ubuntu 18.04 server 64bit*.
    :param builtins.str owner: The owner (UUID) of the image.
    :param builtins.str region: The region in which to obtain the images. If omitted, the provider-level region will be
           used.
    :param builtins.str sort_direction: Order the results in either `asc` or `desc`.
    :param builtins.str sort_key: Sort images based on a certain key. Must be one of
           "name", "container_format", "disk_format", "status", "id" or "size". Defaults to `name`.
    :param builtins.str tag: Search for images with a specific tag in "Key=Value" format.
...
def get_image_output(architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
