...
def get_vaults(auto_expand_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.str region: Specifies the region in which to query the CBR vaults.
...
def get_vaults_output(auto_expand_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
