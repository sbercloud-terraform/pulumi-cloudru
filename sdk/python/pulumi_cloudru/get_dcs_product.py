...
def get_dcs_product(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to obtain the dcs products.
           If omitted, the provider-level region will be used.
    :param builtins.str spec_code: Specifies the DCS instance specification code. For details, see
