...
class BucketCorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: Specifies the acceptable operation type of buckets and objects.
               The methods include `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: Requests from this origin can access the bucket. Multiple matching rules are allowed.
               One rule occupies one line, and allows one wildcard character (*) at most.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: Specifies the allowed header of cross-origin requests.
               Only CORS requests matching the allowed header are valid.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: Specifies the exposed header in CORS responses, providing additional information for clients.
        :param pulumi.Input[builtins.int] max_age_seconds: Specifies the duration that your browser can cache CORS responses, expressed in seconds.
               The default value is 100.
        """
...
class BucketLifecycleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Unique identifier for lifecycle rules. The Rule Name contains a maximum of 255 characters.
...
class BucketLifecycleRuleExpirationArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days when objects that have been last updated are automatically deleted.
               The expiration time must be greater than the transition times.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLifecycleRuleNoncurrentVersionExpirationArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days when noncurrent object versions are automatically deleted.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLifecycleRuleNoncurrentVersionTransitionArgs:
    def __init__(__self__, *,
                 ...
                 storage_class: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days when noncurrent object versions are automatically transitioned to the specified storage class.
        :param pulumi.Input[builtins.str] storage_class: The class of storage used to store the object. Only `WARM` and `COLD` are supported.
        """
        pulumi.set(__self__, "days", days)
...
class BucketLifecycleRuleTransitionArgs:
    def __init__(__self__, *,
                 ...
                 storage_class: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days when objects that have been last updated are automatically transitioned to the specified storage class.
        :param pulumi.Input[builtins.str] storage_class: The class of storage used to store the object. Only `WARM` and `COLD` are supported.
        """
        pulumi.set(__self__, "days", days)
        pulumi.set(__self__, "storage_class", storage_class)
...
class BucketStorageInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] object_number: The number of objects stored in the bucket.
        :param pulumi.Input[builtins.int] size: The stored size of the bucket.
        """
...
class BucketWebsiteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] error_document: Specifies the error page returned when an error occurs during static website access.
               Only HTML, JPG, PNG, BMP, and WEBP files under the root directory are supported.
        :param pulumi.Input[builtins.str] index_document: Unless using `redirect_all_requests_to`. Specifies the default homepage of the static website, only HTML web pages are supported.
               OBS only allows files such as `index.html` in the root directory of a bucket to function as the default homepage.
               That is to say, do not set the default homepage with a multi-level directory structure (for example, /page/index.html).
        ...
        :param pulumi.Input[builtins.str] routing_rules: A JSON or XML format containing routing rules describing redirect behavior and when redirects are applied.
               Each rule contains a `Condition` and a `Redirect` as shown in the following table:
