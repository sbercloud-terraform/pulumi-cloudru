...
class L7policyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Specifies whether requests are forwarded to another backend server group
        ...
        :param pulumi.Input[builtins.str] listener_id: Specifies the ID of the listener for which the forwarding policy is added.
               Changing this creates a new L7 Policy.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the L7 Policy. This value can only be true (UP).
        :param pulumi.Input[builtins.str] description: Human-readable description for the L7 Policy.
        :param pulumi.Input[builtins.str] name: Human-readable name for the L7 Policy. Does not have to be unique.
        :param pulumi.Input[builtins.int] position: The position of this policy on the listener. Positions start at 1.
               Changing this creates a new L7 Policy.
        :param pulumi.Input[builtins.str] redirect_listener_id: Specifies the ID of the listener to which the traffic is redirected.
        ...
        :param pulumi.Input[builtins.str] redirect_pool_id: Specifies the ID of the backend server group to which traffic is forwarded.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the L7 Policy resource. If omitted, the
...
class L7policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redirect_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'L7policy':
        """
