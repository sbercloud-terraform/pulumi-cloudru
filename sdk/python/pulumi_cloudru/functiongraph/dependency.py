...
class DependencyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] link: The OBS storage URL of the dependency package.
        :param pulumi.Input[builtins.str] runtime: Specifies the dependency package runtime.
               ...
               + **Custom**
               + **http**
        :param pulumi.Input[builtins.str] description: Specifies the dependency description.
               The description can contain a maximum of `512` characters.
        :param pulumi.Input[builtins.str] name: Specifies the dependency name.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create a custom dependency package.
...
class _DependencyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the dependency description.
               The description can contain a maximum of `512` characters.
        :param pulumi.Input[builtins.str] etag: The unique ID of the dependency package.
        :param pulumi.Input[builtins.str] link: The OBS storage URL of the dependency package.
        :param pulumi.Input[builtins.str] name: Specifies the dependency name.
               The name can contain a maximum of `96` characters and must start with a letter and end with a letter or digit.
               Only letters, digits, underscores (_), periods (.), and hyphens (-) are allowed.
        :param pulumi.Input[builtins.str] owner: The base64 encoded digest of the dependency after encryption by MD5.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create a custom dependency package.
               If omitted, the provider-level region will be used. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] runtime: Specifies the dependency package runtime.
               The valid values are as follows:
               ...
               + **Custom**
               + **http**
        :param pulumi.Input[builtins.int] size: The dependency package size in bytes.
...
class Dependency(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            runtime: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Dependency':
        """
