...
class AssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] attachment_id: The ID of the attachment corresponding to the association.
        ...
        :param pulumi.Input[_builtins.str] route_table_id: The ID of the route table to which the association belongs.
...
@pulumi.type_token("cloudru:Er/association:Association")
