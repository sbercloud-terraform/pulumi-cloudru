...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_name: Specifies the log group name. Changing this parameter will create a new
               resource.
        :param pulumi.Input[builtins.int] ttl_in_days: Specifies the log expiration time(days), value range: 1-30.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project ID to which the log group belongs.
        :param pulumi.Input[builtins.str] region: The region in which to create the log group resource. If omitted, the
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl_in_days: Optional[pulumi.Input[builtins.int]] = None) -> 'Group':
        """
