...
class MysqlAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the rds instance id. Changing this will create a new resource.
        :param pulumi.Input[builtins.str] password: Specifies the password of the db account. The parameter must be 8 to 32 characters
        ...
        :param pulumi.Input[builtins.str] description: Specifies remarks of the database account. The parameter must be 1 to 512
        ...
        :param pulumi.Input[builtins.str] name: Specifies the username of the db account. Only lowercase letters, digits,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the rds account resource. If omitted, the
...
class MysqlAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'MysqlAccount':
        """
