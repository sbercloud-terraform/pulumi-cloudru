...
def get_bandwidth(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str enterprise_project_id: The enterprise project id of the Shared Bandwidth to retrieve.
    :param builtins.str name: The name of the Shared Bandwidth to retrieve.
    :param builtins.str region: The region in which to obtain the bandwidth. If omitted, the provider-level region will
           be used.
    :param builtins.int size: The size of the Shared Bandwidth to retrieve. The value ranges from 5 to 2000 G.
    """
    __args__ = dict()
...
def get_bandwidth_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
