...
def get_role(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: Specifies the display name of the role displayed on the console.
           It is recommended to use this parameter instead of `name` and required if `name` is not specified.
    :param builtins.str name: Specifies the name of the role for internal use.
...
def get_role_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
