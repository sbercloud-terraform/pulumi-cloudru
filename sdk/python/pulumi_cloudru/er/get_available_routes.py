...
def get_available_routes(destination: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to query the available routes.
    ...
    :param builtins.str route_table_id: The route table ID to which the available routes belong.
    """
    __args__ = dict()
...
def get_available_routes_output(destination: Optional[pulumi.Input[Optional[builtins.str]]] = None,
