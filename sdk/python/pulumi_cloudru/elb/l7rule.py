...
class L7ruleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compare_type: The comparison type for the L7 rule - can either be STARTS_WITH, EQUAL_TO or REGEX
        :param pulumi.Input[builtins.str] l7policy_id: The ID of the L7 Policy to query. Changing this creates a new L7 Rule.
        :param pulumi.Input[builtins.str] type: The L7 Rule type - can either be HOST_NAME or PATH. Changing this creates a new
               L7 Rule.
        :param pulumi.Input[builtins.str] value: The value to use for the comparison. For example, the file type to compare.
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the L7 Rule. The value can only be true (UP).
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the L7 Rule resource. If omitted, the
...
class L7rule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'L7rule':
        """
