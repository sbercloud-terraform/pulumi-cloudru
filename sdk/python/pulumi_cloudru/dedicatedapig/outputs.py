...
class ApiPublishmentHistory(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: The version description of the API publishment.
        :param _builtins.str version_id: The version ID of the API publishment.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class CustomAuthorizerIdentity(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str location: The parameter location.
        :param _builtins.str name: The name of the parameter to be verified.
        :param _builtins.str validation: The parameter verification expression.
        """
        pulumi.set(__self__, "location", location)
        pulumi.set(__self__, "name", name)
...
class ResponseRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status_code: Optional[_builtins.int] = None):
        """
        :param _builtins.str body: The body template of the API custom response rule.
        :param _builtins.str error_type: The error type of the API custom response rule.
        :param Sequence['ResponseRuleHeaderArgs'] headers: The configuration of the custom response headers.
        :param _builtins.int status_code: The HTTP status code of the API custom response rule.
        """
...
class ResponseRuleHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str key: The key name of the response header.
        :param _builtins.str value: The value for the specified response header key.
        """
...
class ThrottlingPolicyAppThrottle(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str throttling_object_id: The object ID which the special throttling policy belongs.
