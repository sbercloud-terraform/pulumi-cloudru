...
def get_access_control_logs(action: Optional[builtins.str] = None,
...
def get_access_control_logs_output(action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
