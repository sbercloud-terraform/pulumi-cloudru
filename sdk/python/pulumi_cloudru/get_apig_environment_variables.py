...
def get_apig_environment_variables(env_id: Optional[_builtins.str] = None,
...
def get_apig_environment_variables_output(env_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
