...
class KeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_alias: The alias in which to create the key. It is required when
               we create a new key. Changing this updates the alias of key.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the kms key. Changing this creates a new key.
        ...
        :param pulumi.Input[builtins.str] key_algorithm: The algorithm of the key. Valid values are AES_256, SM4, RSA_2048, RSA_3072,
               RSA_4096, EC_P256, EC_P384, SM2. Changing this creates a new key.
        :param pulumi.Input[builtins.str] key_description: The description of the key as viewed in Sber console.
               Changing this updates the description of key.
        :param pulumi.Input[builtins.str] pending_days: Duration in days after which the key is deleted
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the KMS key resource. If omitted, the provider-level region will be used. Changing this creates a new KMS key resource.
        :param pulumi.Input[builtins.bool] rotation_enabled: Specifies whether the key rotation is enabled. Defaults to false.
        :param pulumi.Input[builtins.int] rotation_interval: Specifies the key rotation interval. The valid value is range from 30 to 365,
               defaults to 365.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the kms key.
        """
...
class _KeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] creation_date: Creation time (time stamp) of a key.
        :param pulumi.Input[builtins.str] default_key_flag: Identification of a Master Key. The value 1 indicates a Default
               Master Key, and the value 0 indicates a key.
        :param pulumi.Input[builtins.str] domain_id: ID of a user domain for the key.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the kms key. Changing this creates a new key.
        :param pulumi.Input[builtins.str] expiration_time: Expiration time.
        :param pulumi.Input[builtins.bool] is_enabled: Specifies whether the key is enabled. Defaults to true.
               Changing this updates the state of existing key.
        :param pulumi.Input[builtins.str] key_algorithm: The algorithm of the key. Valid values are AES_256, SM4, RSA_2048, RSA_3072,
               RSA_4096, EC_P256, EC_P384, SM2. Changing this creates a new key.
        ...
        :param pulumi.Input[builtins.int] rotation_interval: Specifies the key rotation interval. The valid value is range from 30 to 365,
               defaults to 365.
        :param pulumi.Input[builtins.int] rotation_number: The total number of key rotations.
        :param pulumi.Input[builtins.str] scheduled_deletion_date: Scheduled deletion time (time stamp) of a key.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the kms key.
        """
