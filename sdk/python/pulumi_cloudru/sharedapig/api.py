...
class ApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: Specifies the ID of the API group. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance to which the API belongs.
        :param pulumi.Input[builtins.str] request_method: Specifies the request method, including 'GET','POST','PUT' and etc..
        :param pulumi.Input[builtins.str] request_path: The request address.
        :param pulumi.Input[builtins.str] request_protocol: Specifies the request protocol. The value can be 'HTTP', 'HTTPS', and 'BOTH'
        ...
        :param pulumi.Input[builtins.bool] cors: Specifies whether CORS is supported or not.
        :param pulumi.Input[builtins.str] description: Specifies the description of the API. The description cannot exceed 255 characters.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the API. An API name consists of 3–64 characters, starting with a
               letter. Only letters, digits, and underscores (_) are allowed.
        :param pulumi.Input[builtins.str] region: The region in which to create the API resource. If omitted, the provider-level
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: the tags of API in format of string list.
