...
class EndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_id: Specifies the network ID of the subnet in the VPC specified by `vpc_id`.
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] service_id: Specifies the ID of the VPC endpoint service.
               The VPC endpoint service could be private or public. Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC where the VPC endpoint is to be created. Changing
               this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] description: Specifies the description of the VPC endpoint.
               
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.bool] enable_dns: Specifies whether to create a private domain name. The default value is
               true. Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.bool] enable_whitelist: Specifies whether to enable access control. The default value is
               false.
        :param pulumi.Input[builtins.str] ip_address: Specifies the IP address for accessing the associated VPC endpoint
               service. Only IPv4 addresses are supported. Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC endpoint. If omitted, the provider-level
               region will be used. Changing this creates a new VPC endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the VPC endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelists: Specifies the list of IP address or CIDR block which can be accessed to the
...
class _EndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_id: Specifies the network ID of the subnet in the VPC specified by `vpc_id`.
               Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.int] packet_id: The packet ID of the VPC endpoint.
        :param pulumi.Input[builtins.str] private_domain_name: The domain name for accessing the associated VPC endpoint service. This parameter is only
               available when enable_dns is set to true.
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC endpoint. If omitted, the provider-level
               region will be used. Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] service_id: Specifies the ID of the VPC endpoint service.
               The VPC endpoint service could be private or public. Changing this creates a new VPC endpoint.
        :param pulumi.Input[builtins.str] service_name: The name of the VPC endpoint service.
        :param pulumi.Input[builtins.str] service_type: The type of the VPC endpoint service.
        :param pulumi.Input[builtins.str] status: The status of the VPC endpoint. The value can be **accepted**, **pendingAcceptance** or **rejected**.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the VPC endpoint.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC where the VPC endpoint is to be created. Changing
               this creates a new VPC endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelists: Specifies the list of IP address or CIDR block which can be accessed to the
...
class Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Endpoint':
        """
