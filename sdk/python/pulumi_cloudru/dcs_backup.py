...
class _DcsBackupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] begin_time: Indicates the time when the backup task is created. The format is yyyy-mm-dd hh:mm:ss.
               The value is in UTC format.
        :param pulumi.Input[builtins.str] description: Specifies the description of DCS instance backup.
               
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] end_time: Indicates the time at which DCS instance backup is completed. The format is yyyy-mm-dd hh:mm:ss.
               The value is in UTC format.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the DCS instance.
        ...
        :param pulumi.Input[builtins.str] status: Indicates the backup status. Valid value:
        ...
        :param pulumi.Input[builtins.str] type: Indicates the backup type. Valid value:
