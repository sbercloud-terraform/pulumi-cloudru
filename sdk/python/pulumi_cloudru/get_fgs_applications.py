...
def get_fgs_applications(application_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_id: Specifies the application ID used to query specified application.
    ...
    :param builtins.str region: Specifies the region where the applications are located.  
...
def get_fgs_applications_output(application_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
