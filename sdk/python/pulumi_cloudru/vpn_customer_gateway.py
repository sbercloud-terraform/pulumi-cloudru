...
class VpnCustomerGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] asn: The BGP ASN number of the customer gateway.
        ...
        :param pulumi.Input[builtins.str] certificate_content: The CA certificate content of the customer gateway.
        :param pulumi.Input[builtins.str] id_type: Specifies the identifier type of a customer gateway.
               The value can be **ip** or **fqdn**. The default value is **ip**.
        :param pulumi.Input[builtins.str] id_value: Specifies the identifier of a customer gateway.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the customer gateway.
        """
        if asn is not None:
...
class _VpnCustomerGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] asn: The BGP ASN number of the customer gateway.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] certificate_content: The CA certificate content of the customer gateway.
        :param pulumi.Input[builtins.str] certificate_id: Indicates the ID of the customer gateway certificate.
        :param pulumi.Input[builtins.str] created_at: The create time.
        :param pulumi.Input[builtins.str] expire_time: Indicates the expire time of the customer gateway certificate.
        :param pulumi.Input[builtins.str] id_type: Specifies the identifier type of a customer gateway.
               The value can be **ip** or **fqdn**. The default value is **ip**.
        :param pulumi.Input[builtins.str] id_value: Specifies the identifier of a customer gateway.
               When `id_type` is set to **ip**, the value is an IPv4 address in dotted decimal notation, for example, 192.168.45.7.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] ip: The IP address of the customer gateway.
        :param pulumi.Input[builtins.bool] is_updatable: Indicates whether the customer gateway certificate is updatable.
        :param pulumi.Input[builtins.str] issuer: Indicates the issuer of the customer gateway certificate.
        :param pulumi.Input[builtins.str] name: The customer gateway name.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] route_mode: The route mode of the customer gateway.
        :param pulumi.Input[builtins.str] serial_number: Indicates the serial number of the customer gateway certificate.
        :param pulumi.Input[builtins.str] signature_algorithm: Indicates the signature algorithm of the customer gateway certificate.
        :param pulumi.Input[builtins.str] subject: Indicates the subject of the customer gateway certificate.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the customer gateway.
