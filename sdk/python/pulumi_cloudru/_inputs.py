...
class DcsParametersConfigurationParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] need_restart: Indicates whether a restart is required.
        :param pulumi.Input[builtins.str] type: Indicates the parameter type.
        :param pulumi.Input[builtins.str] user_permission: Indicates a user permission
...
class DcsRestoreRestoreRecordArgs:
    def __init__(__self__, *,
                 ...
                 updated_at: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] backup_id: ID of the backup record.
        :param pulumi.Input[builtins.str] backup_name: Name of the backup record.
        :param pulumi.Input[builtins.str] backup_remark: Description of DCS instance backup.
        :param pulumi.Input[builtins.str] created_at: Time at which the restoration task is created.
        :param pulumi.Input[builtins.str] error_code: Error code returned if DCS instance restoration fails.
        :param pulumi.Input[builtins.str] progress: Restoration progress.
        :param pulumi.Input[builtins.str] restore_id: ID of the restoration record.
        :param pulumi.Input[builtins.str] restore_name: Name of the restoration record.
        :param pulumi.Input[builtins.str] restore_remark: Description of DCS instance restoration.
        :param pulumi.Input[builtins.str] status: Restoration status:
        :param pulumi.Input[builtins.str] updated_at: Time at which DCS instance restoration completed.
        """
...
class DdsParameterTemplateCompareDifferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] parameter_name: Indicates the parameter name.
        :param pulumi.Input[builtins.str] source_value: Indicates the parameter value in the source parameter template.
        :param pulumi.Input[builtins.str] target_value: Indicates the parameter value in the destination parameter template.
        """
...
class DdsParameterTemplateCopyParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] description: Specifies the description of replicated parameter template.
               The value is left blank by default. The description must consist of a maximum of **256** characters and cannot contain
               the carriage return character or the following special characters: >!<"&'=
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of replicated parameter template.
               The parameter template name can contain **1** to **64** characters. It can contain only letters, digits, hyphens (-),
               underscores (_), and periods (.).
               Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.bool] restart_required: Indicates whether the instance needs to be restarted.
               + If the value is **true**, restart is required.
               + If the value is **false**, restart is not required.
        :param pulumi.Input[builtins.str] type: Indicates the parameter type. The value can be integer, string, boolean, float, or list.
        :param pulumi.Input[builtins.str] value: Indicates the parameter value.
...
class DdsParameterTemplateParameterArgs:
    def __init__(__self__, *,
                 ...
                 value_range: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] description: Specifies the parameter template description.
               The description must consist of a maximum of 256 characters and cannot contain the carriage
               return character or the following special characters: >!<"&'=.
        :param pulumi.Input[builtins.str] name: Specifies the parameter template name.
               The value must be 1 to 64 characters, which can contain only letters, digits, hyphens (-),
               underscores (_), and periods (.).
        :param pulumi.Input[builtins.bool] readonly: Indicates whether the parameter is read-only.
               + If the value is **true**, the parameter is read-only.
...
class DmsRocketmqInstanceConfigArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the config name.
        :param pulumi.Input[builtins.str] value: Specifies the config value.
...
class DmsRocketmqInstanceCrossVpcAccessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] advertised_ip: The advertised IP Address or domain name.
        :param pulumi.Input[builtins.str] listener_ip: The listener IP address.
        :param pulumi.Input[builtins.int] port: The port number.
        :param pulumi.Input[builtins.str] port_id: The port ID associated with the address.
        """
...
class DmsRocketmqMigrationTaskBindingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination: Specifies the message target. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] destination_type: Specifies the message target type.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] routing_key: Specifies the routing key. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] source: Specifies the message source. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] vhost: Specifies the virtual host name. Changing this creates a new resource.
        """
...
class DmsRocketmqMigrationTaskExchangeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] durable: Specifies whether to enable data persistence.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the switch name. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] type: Specifies the exchange type. Changing this creates a new resource.
...
class DmsRocketmqMigrationTaskSubscriptionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] consume_enable: Specifies whether to enable consumption.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.bool] consume_from_min_enable: Specifies whether to enable consumption from the earliest
               offset. Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.int] retry_queue_num: Specifies the number of retry queues.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.int] which_broker_when_consume_slow: Specifies the ID of the broker selected for slow
               consumption. Changing this creates a new resource.
...
class DmsRocketmqMigrationTaskTopicConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: Specifies the topic name. Changing this creates a new resource.
        :param pulumi.Input[builtins.bool] order: Specifies whether a message is an ordered message.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.int] perm: Specifies the number of permission. Changing this creates a new resource.
...
class DmsRocketmqTopicBrokerArgs:
    def __init__(__self__, *,
                 ...
                 write_queue_num: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the broker.
               
               <a name="DmsRocketMQTopic_QueueRef"></a>
               The `queues` block supports:
        :param pulumi.Input[builtins.int] read_queue_num: Indicates the read queues number of the broker. It's useless when create a topic.
        :param pulumi.Input[builtins.int] write_queue_num: Indicates the read queues number of the broker. It's useless when create a topic.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if read_queue_num is not None:
...
class ElbIpgroupIpListArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ip: IP address or CIDR block.
        :param pulumi.Input[builtins.str] description: Human-readable description for the ip.
        """
...
class ElbL7ruleConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: The value to use for the comparison.
        """
        pulumi.set(__self__, "value", value)
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class ElbPoolPersistenceArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of persistence mode. The current specification supports SOURCE_IP,
               HTTP_COOKIE, and APP_COOKIE.
        :param pulumi.Input[builtins.str] cookie_name: The name of the cookie if persistence mode is set appropriately. Required
               if `type = APP_COOKIE`.
        :param pulumi.Input[builtins.int] timeout: Specifies the sticky session timeout duration in minutes. This parameter is
               invalid when type is set to APP_COOKIE. The value range varies depending on the protocol of the backend server group:
               + When the protocol of the backend server group is TCP or UDP, the value ranges from 1 to 60.
               + When the protocol of the backend server group is HTTP or HTTPS, the value ranges from 1 to 1440.
        """
...
class ElbSecurityPolicyListenerArgs:
    def __init__(__self__, *,
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: The listener id.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class FgsAsyncInvokeConfigurationOnFailureArgs:
    def __init__(__self__, *,
                 ...
                 param: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination: Specifies the object type.  
               The valid values are as follows:
               + **OBS**
               + **SMN**
               + **DIS**
               + **FunctionGraph**
        :param pulumi.Input[builtins.str] param: Specifies the parameters (map object in JSON format) corresponding to the target service.
               + The **OBS** objects include: `bucket` (bucket name), `prefix` (object directory prefix) and `expires` (object
               expiration time, the valid value ranges from `0` to `365`. If the value is `0`, the object will not expire.).
               + The **SMN** objects include: `topic_urn`.
               + The **DIS** objects include: `stream_name`.
...
class GesGraphPublicIpArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] eip_id: Indicates the ID of an EIP.  Changing this parameter will create a new resource.
...
class SwrOrganizationPermissionsSelfPermissionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] permission: The permission of current user.
        :param pulumi.Input[builtins.str] user_id: The ID of current user.
        :param pulumi.Input[builtins.str] user_name: The name of current user.
        """
...
class SwrOrganizationPermissionsUserArgs:
    def __init__(__self__, *,
                 ...
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] permission: Specifies the permission of the existing SberCloud user.
               The values can be **Manage**, **Write** and **Read**.
        :param pulumi.Input[builtins.str] user_id: Specifies the ID of the existing SberCloud user.
        :param pulumi.Input[builtins.str] user_name: Specifies the name of the existing SberCloud user.
        """
        pulumi.set(__self__, "permission", permission)
        pulumi.set(__self__, "user_id", user_id)
        if user_name is not None:
...
class VpnConnectionIkepolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authentication_algorithm: The authentication algorithm. The value can be **sha1**, **md5**,
               **sha2-256**, **sha2-384**, **sha2-512**. Defaults to **sha2-256**. **sha1** and **md5** are less secure,
               please use them with caution.
        ...
        :param pulumi.Input['VpnConnectionIkepolicyDpdArgs'] dpd: Specifies the dead peer detection (DPD) object.
               ...
               <a name="Connection_DPD"></a>
               The `dpd` block supports:
        :param pulumi.Input[builtins.str] encryption_algorithm: The encryption algorithm. The value can be **3des**, **aes-128**, **aes-192**,
               **aes-256**, **aes-128-gcm-16**, **aes-256-gcm-16**, **aes-128-gcm-128**, **aes-256-gcm-128**. Defaults to **aes-128**.
               **3des** is less secure, please use it with caution.
        :param pulumi.Input[builtins.str] ike_version: The IKE negotiation version. The value can be **v1** and **v2**. Defaults to **v2**.
        ...
        :param pulumi.Input[builtins.str] local_id_type: The local ID type. The value can be **ip** or **fqdn**. Defaults to **ip**.
        :param pulumi.Input[builtins.str] peer_id: The peer ID.
        :param pulumi.Input[builtins.str] peer_id_type: The peer ID type. The value can be **ip**, **fqdn** or **any**. Defaults to **ip**.
        :param pulumi.Input[builtins.str] pfs: The DH key group used by PFS. The value can be **group1**, **group2**, **group5**, **group14**
               **group16**, **group19**, **group20**, **group21**. Defaults to **group14**.
...
class VpnConnectionIkepolicyDpdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] interval: Specifies the DPD idle timeout period.
               The value ranges from **10** to **3600**, in seconds. Defaults to **30**.
        :param pulumi.Input[builtins.str] msg: Specifies the format of DPD packets. The value can be:
               + **seq-hash-notify**: indicates that the payload of DPD packets is in the sequence of hash-notify;
               + **seq-notify-hash**: indicates that the payload of DPD packets is in the sequence of notify-hash;
...
class VpnGatewayCertificateArgs:
    def __init__(__self__, *,
                 ...
                 updated_at: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] certificate_chain: The certificate chain of the gateway certificate.
        :param pulumi.Input[builtins.str] content: The content of the gateway certificate.
        :param pulumi.Input[builtins.str] enc_certificate: The enc certificate of the gateway certificate.
        :param pulumi.Input[builtins.str] enc_private_key: The enc private key of the gateway certificate.
        :param pulumi.Input[builtins.str] name: The name of the gateway certificate.
        :param pulumi.Input[builtins.str] private_key: The private of the gateway certificate.
        :param pulumi.Input[builtins.str] certificate_chain_expire_time: The expire time of the certificate.
        :param pulumi.Input[builtins.str] certificate_chain_serial_number: The serial number of the certificate chain.
        :param pulumi.Input[builtins.str] certificate_chain_subject: The subject of the certificate chain.
        :param pulumi.Input[builtins.str] certificate_expire_time: The expire time of the certificate.
        :param pulumi.Input[builtins.str] certificate_id: The certificate ID.
        :param pulumi.Input[builtins.str] certificate_serial_number: The serial number of the certificate.
        :param pulumi.Input[builtins.str] certificate_subject: The subject of the certificate.
        :param pulumi.Input[builtins.str] created_at: The create time of the gateway certificate.
        :param pulumi.Input[builtins.str] enc_certificate_expire_time: The expire time of the enc certificate.
        :param pulumi.Input[builtins.str] enc_certificate_serial_number: The serial number of the enc certificate.
        :param pulumi.Input[builtins.str] enc_certificate_subject: The subject of the enc certificate.
        :param pulumi.Input[builtins.str] issuer: The issuer of the certificate.
        :param pulumi.Input[builtins.str] signature_algorithm: The signature algorithm of the certificate.
        :param pulumi.Input[builtins.str] status: The status of the certificate.
        :param pulumi.Input[builtins.str] updated_at: The update time of the gateway certificate.
        """
...
class VpnGatewayEip1Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth_name: The bandwidth name.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] bandwidth_size: Bandwidth size in Mbit/s. When the `flavor` is **Basic**, the value
               cannot be greater than **100**. When the `flavor` is **Professional1**, the value cannot be greater than **300**.
               When the `flavor` is **Professional2**, the value cannot be greater than **1000**.
