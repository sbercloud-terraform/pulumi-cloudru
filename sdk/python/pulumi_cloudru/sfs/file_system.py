...
class FileSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] size: The size (GB) of the shared file system.
        :param pulumi.Input[builtins.str] access_level: Specifies the access level of the shared file system. Possible values are *ro* (read-only)
               and *rw* (read-write). The default value is *rw* (read/write). Changing this will create a new access rule.
        :param pulumi.Input[builtins.str] access_to: Specifies the value that defines the access rule. The value contains 1 to 255 characters.
        ...
        :param pulumi.Input[builtins.str] access_type: Specifies the type of the share access rule. The default value is *cert*.
               Changing this will create a new access rule.
        :param pulumi.Input[builtins.str] availability_zone: The availability zone name. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] description: Describes the shared file system.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the shared file system. Changing this creates a new resource.
        :param pulumi.Input[builtins.bool] is_public: The level of visibility for the shared file system.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata key and value pairs as a dictionary of strings.
        ...
        :param pulumi.Input[builtins.str] name: The name of the shared file system.
        :param pulumi.Input[builtins.str] region: The region in which to create the sfs resource. If omitted, the provider-level region will be used. Changing this creates a new sfs resource.
        :param pulumi.Input[builtins.str] share_proto: The protocol for sharing file systems. The default value is NFS.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the shared file system.
        """
...
class _FileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_level: Specifies the access level of the shared file system. Possible values are *ro* (read-only)
               and *rw* (read-write). The default value is *rw* (read/write). Changing this will create a new access rule.
        :param pulumi.Input[builtins.str] access_rule_status: The status of the share access rule.
        ...
        :param pulumi.Input[builtins.str] description: Describes the shared file system.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the shared file system. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] export_location: The address for accessing the shared file system.
        :param pulumi.Input[builtins.bool] is_public: The level of visibility for the shared file system.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata key and value pairs as a dictionary of strings.
               The supported metadata keys are "#sfs_crypt_key_id", "#sfs_crypt_domain_id" and "#sfs_crypt_alias",
               and the keys should be exist at the same time to enable the data encryption function.
        ...
        :param pulumi.Input[builtins.str] name: The name of the shared file system.
        :param pulumi.Input[builtins.str] region: The region in which to create the sfs resource. If omitted, the provider-level region will be used. Changing this creates a new sfs resource.
        :param pulumi.Input[builtins.str] share_access_id: The UUID of the share access rule.
        :param pulumi.Input[builtins.str] share_proto: The protocol for sharing file systems. The default value is NFS.
        :param pulumi.Input[builtins.int] size: The size (GB) of the shared file system.
        :param pulumi.Input[builtins.str] status: The status of the share access rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the shared file system.
        """
        if access_level is not None:
            pulumi.set(__self__, "access_level", access_level)
...
class FileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'FileSystem':
        """
