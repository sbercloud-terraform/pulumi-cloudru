...
class PolicyBackupCycleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] execution_times: Specifies the backup time. Automated backups will be triggered at the backup
               time. The current time is in the UTC format (HH:MM). The minutes in the list must be set to **00** and the hours
               cannot be repeated. In the replication policy, you are advised to set one time point for one day.
               
               <a name="cbr_policy_long_term_retention"></a>
               The `long_term_retention` block supports:
        :param pulumi.Input[builtins.str] days: Specifies the weekly backup day of backup schedule. It supports seven days a week (MO, TU,
               WE, TH, FR, SA, SU) and this parameter is separated by a comma (,) without spaces, between date and date during the
               configuration.
        :param pulumi.Input[builtins.int] interval: Specifies the interval (in days) of backup schedule. The value range is `1` to `30`. This
               parameter and `days` are alternative.
        """
...
class PolicyLongTermRetentionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] daily: Specifies the latest backup of each day is saved in the long term.
        ...
        :param pulumi.Input[builtins.int] monthly: Specifies the latest backup of each month is saved in the long term.
        :param pulumi.Input[builtins.int] weekly: Specifies the latest backup of each week is saved in the long term.
        :param pulumi.Input[builtins.int] yearly: Specifies the latest backup of each year is saved in the long term.
...
class VaultResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excludes: Specifies the array of disk IDs which will be excluded in the backup.
               Only **server** vault support this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] includes: Specifies the array of disk or SFS file system IDs which will be included in the backup.
               Only **disk** and **turbo** vault support this parameter.
        :param pulumi.Input[builtins.str] server_id: Specifies the ID of the ECS instance to be backed up.
        """
