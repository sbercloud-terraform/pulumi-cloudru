...
def get_peering_connection(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the specific VPC Peering Connection to retrieve.
    :param builtins.str name: The name of the specific VPC Peering Connection to retrieve.
    :param builtins.str peer_tenant_id: The Tenant ID of the accepter/peer VPC of the specific VPC Peering Connection to
           retrieve.
    :param builtins.str peer_vpc_id: The ID of the accepter/peer VPC of the specific VPC Peering Connection to retrieve.
    :param builtins.str region: The region in which to obtain the VPC Peering Connection. If omitted, the provider-level
           region will be used.
    :param builtins.str status: The status of the specific VPC Peering Connection to retrieve.
    :param builtins.str vpc_id: The ID of the requester VPC of the specific VPC Peering Connection to retrieve.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_peering_connection_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
