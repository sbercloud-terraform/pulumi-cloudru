...
class FunctionFuncMountArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] local_mount_path: Specifies the function access path.
        :param pulumi.Input[builtins.str] mount_resource: Specifies the ID of the mounted resource (corresponding cloud service).
        :param pulumi.Input[builtins.str] mount_share_path: Specifies the remote mount path. Example: 192.168.0.12:/data.
        :param pulumi.Input[builtins.str] mount_type: Specifies the mount type. Options: sfs, sfsTurbo, and ecs.
