...
class ApigSignatureAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: The ID of the dedicated instance to which the APIs and the signature belong.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] publish_ids: The publish IDs corresponding to the APIs bound by the signature.
        :param pulumi.Input[_builtins.str] signature_id: The signature ID for APIs binding.
        :param pulumi.Input[_builtins.str] region: The region where the signature and the APIs are located.
        """
...
class ApigSignatureAssociate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            publish_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            signature_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApigSignatureAssociate':
        """
