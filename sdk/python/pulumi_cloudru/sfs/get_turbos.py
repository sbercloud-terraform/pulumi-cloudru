...
def get_turbos(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to obtain the SFS turbo file systems.
...
def get_turbos_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
