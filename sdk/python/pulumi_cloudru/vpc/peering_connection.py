...
class PeeringConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] peer_vpc_id: Specifies the VPC ID of the accepter tenant. Changing this creates a new
               VPC peering connection.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC involved in a VPC peering connection. Changing this
               creates a new VPC peering connection.
        :param pulumi.Input[builtins.str] name: Specifies the name of the VPC peering connection. The value can contain 1 to 64
               characters.
        :param pulumi.Input[builtins.str] peer_tenant_id: Specified the Tenant Id of the accepter tenant. Changing this creates
               a new VPC peering connection.
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC peering connection. If omitted, the
...
class _PeeringConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC peering connection. If omitted, the
               provider-level region will be used. Changing this creates a new VPC peering connection resource.
        :param pulumi.Input[builtins.str] status: The VPC peering connection status. The value can be PENDING_ACCEPTANCE, REJECTED, EXPIRED, DELETED, or
               ACTIVE.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC involved in a VPC peering connection. Changing this
               creates a new VPC peering connection.
        """
...
class PeeringConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PeeringConnection':
        """
