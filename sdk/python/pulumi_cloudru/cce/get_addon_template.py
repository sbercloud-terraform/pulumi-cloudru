...
def get_addon_template(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Specifies the add-on name.
    :param builtins.str region: Specifies the region in which to obtain the CCE add-ons. If omitted, the provider-level
           region will be used.
    :param builtins.str version: Specifies the add-on version.
    """
    __args__ = dict()
...
def get_addon_template_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
