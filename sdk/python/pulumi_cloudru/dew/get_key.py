...
def get_key(default_key_flag: Optional[builtins.str] = None,
    ...
    :param builtins.str default_key_flag: Identification of a Master Key. The value "1" indicates a Default Master Key,
           and the value "0" indicates a key. Changing this gets a new key.
    :param builtins.str domain_id: ID of a user domain for the key. Changing this gets a new key.
    :param builtins.str enterprise_project_id: The enterprise project id of the kms key.
    :param builtins.str key_alias: The alias in which to create the key. It is required when we create a new key.
           Changing this gets the new key.
    :param builtins.str key_description: The description of the key as viewed in Huawei console. Changing this gets a
           new key.
    :param builtins.str key_id: The globally unique identifier for the key. Changing this gets the new key.
    :param builtins.str key_state: The state of a key. "1" indicates that the key is waiting to be activated.
    ...
    :param builtins.str region: The region in which to obtain the keys. If omitted, the provider-level region will be
           used.
    """
    __args__ = dict()
...
def get_key_output(default_key_flag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
