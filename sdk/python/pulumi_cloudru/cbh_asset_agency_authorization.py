...
class CbhAssetAgencyAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] csms: Specifies whether to enable CSMS credential agency authorization. The value can be **true**
               or **false**.
        ...
        :param pulumi.Input[builtins.bool] kms: Specifies whether to enable KMS key agency authorization. The value can be **true** or
               **false**.
               ...
               instance.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the CBH asset agency authorization.
