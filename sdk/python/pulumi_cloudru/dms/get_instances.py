...
def get_instances(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str enterprise_project_id: Specifies the enterprise project ID to which all instances of the list
           belong.
    :param builtins.bool fuzzy_match: Specifies whether to match the instance name fuzzily, the default is a exact
           match (`flase`).
    :param builtins.bool include_failure: Specifies whether the query results contain instances that failed to create.
    :param builtins.str instance_id: Specifies the kafka instance ID to match exactly.
    :param builtins.str name: Specifies the kafka instance name for data-source queries.
    :param builtins.str region: The region in which to query the kafka instance list.
