...
class _DcsAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_role: Specifies the role of the account.
               ...
               + **read**: The account has read-only privilege.
               + **write**: The account has read and write privilege.
        :param pulumi.Input[builtins.str] account_type: Indicates the type of the account. The value can be **normal** or **default**.
        :param pulumi.Input[builtins.str] description: Specifies the description of the account.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the DCS instance.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] status: Indicates the status of the account. The value can be **CREATING**, **AVAILABLE**, **CREATEFAILED**,
