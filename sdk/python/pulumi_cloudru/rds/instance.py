...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the list of AZ name. Changing this parameter will create a
               new resource.
        ...
        :param pulumi.Input[builtins.str] flavor: Specifies the specification code.
        ...
        :param pulumi.Input[builtins.str] security_group_id: Specifies the security group which the RDS DB instance belongs to.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the network id of a subnet. Changing this parameter will create a
               new resource.
        :param pulumi.Input['InstanceVolumeArgs'] volume: Specifies the volume information. Structure is documented below.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.int] binlog_retention_hours: Specify the binlog retention period in hours. This parameter applies only to
               MySQL Server databases. Value range: **0** to **168 (7x24)**.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the RDS DB instance. Valid values are
               **prePaid** and **postPaid**, defaults to **postPaid**. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] collation: Specifies the Character Set, only available to Microsoft SQL Server DB instances.
        :param pulumi.Input[builtins.str] description: Specifies the description of the instance. The value consists of 0 to 64
               characters, including letters, digits, periods (.), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] dss_pool_id: Specifies the exclusive storage ID for Dec users. It is different for each az
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the RDS instance.
        :param pulumi.Input[builtins.str] fixed_ip: Specifies an intranet floating IP address of RDS DB instance.
        :param pulumi.Input[builtins.str] ha_replication_mode: Required for HA instances. Specifies the replication mode for the standby DB instance.
        ...
        :param pulumi.Input[builtins.str] lower_case_table_names: Specifies the case-sensitive state of the database table name,
        ...
        :param pulumi.Input[builtins.str] maintain_begin: Specifies the time at which the maintenance time window starts, for example, **22:00**.
        :param pulumi.Input[builtins.str] maintain_end: Specifies the time at which the maintenance time window ends, for example, **01:00**.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the DB instance name. The DB instance name of the same type must be unique for
        ...
        :param pulumi.Input[builtins.str] param_group_id: Specifies the parameter group ID.
        ...
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the RDS DB instance. If `period_unit` is set
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the RDS DB instance. Valid values
               are **month** and **year**. This parameter is mandatory if `charging_mode` is set to **prePaid**. Changing this
               creates a new resource.
        :param pulumi.Input[builtins.str] power_action: Specifies the power action to be done for the instance.
               Value options: **ON**, **OFF** and **REBOOT**.
               
               > **NOTE:** The `power_action` is a one-time action.
        :param pulumi.Input[builtins.str] private_dns_name_prefix: Specifies the prefix of the private domain name. The value contains
               **8** to **64** characters. Only uppercase letters, lowercase letters, and digits are allowed.
        :param pulumi.Input[builtins.str] read_write_permissions: Specifies the read write permissions of the instance. Valid values:
               + **readwrite**: read write permissions.
               + **readonly**: readonly permissions.
        :param pulumi.Input[builtins.str] region: The region in which to create the rds instance resource. If omitted, the
        ...
        :param pulumi.Input[builtins.int] rotate_day: Specifies the rotation days of TDE rotation.
        :param pulumi.Input[builtins.bool] seconds_level_monitoring_enabled: Specifies whether to enable seconds level monitoring.
        :param pulumi.Input[builtins.int] seconds_level_monitoring_interval: Specifies the seconds level monitoring interval. Valid values:
               **1**, **5**. It is mandatory when `seconds_level_monitoring_enabled` is **true**.
        :param pulumi.Input[builtins.str] secret_id: Specifies the key ID of TDE rotation.
        :param pulumi.Input[builtins.str] secret_name: Specifies the key name of TDE rotation.
        :param pulumi.Input[builtins.str] secret_version: Specifies the key version of TDE rotation.
               
               > **NOTE:** `rotate_day`, `secret_id`, `secret_name` and `secret_version` will only take effect when `tde_enabled`
               is **true**.
        :param pulumi.Input[builtins.str] slow_log_show_original_status: Specifies the slow log show original status of the instance.
               Only **MySQL** and **PostgreSQL** are supported. Value options: **on**, **off**.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether to enable the SSL for MySQL database.
        :param pulumi.Input[builtins.str] switch_strategy: Specifies the database switchover policy.
               + **reliability**: reliability first.
               + **availability**: availability first.
               
               Defaults to **reliability**.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the RDS instance. Each tag is represented by one key-value
               pair.
        :param pulumi.Input[builtins.bool] tde_enabled: Specifies whether enable TDE for the instance.
               
               > **NOTE:** TDE cannot be disabled after being enabled.
        :param pulumi.Input[builtins.str] time_zone: Specifies the UTC time zone. For MySQL and PostgreSQL Chinese mainland site
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the RDS DB instance. Valid values are
               **prePaid** and **postPaid**, defaults to **postPaid**. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] collation: Specifies the Character Set, only available to Microsoft SQL Server DB instances.
        :param pulumi.Input[builtins.str] created: Indicates the creation time.
        :param pulumi.Input['InstanceDbArgs'] db: Specifies the database information. Structure is documented below. Changing this
               parameter will create a new resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the instance. The value consists of 0 to 64
               characters, including letters, digits, periods (.), underscores (_), and hyphens (-).
        ...
        :param pulumi.Input[builtins.str] private_dns_name_prefix: Specifies the prefix of the private domain name. The value contains
               **8** to **64** characters. Only uppercase letters, lowercase letters, and digits are allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_dns_names: Indicates the private domain name list of the DB instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: Indicates the private IP address list. It is a blank string until an ECS is created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_ips: Indicates the public IP address list.
        :param pulumi.Input[builtins.str] read_write_permissions: Specifies the read write permissions of the instance. Valid values:
               + **readwrite**: read write permissions.
               + **readonly**: readonly permissions.
        :param pulumi.Input[builtins.str] region: The region in which to create the rds instance resource. If omitted, the
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            volume: Optional[pulumi.Input[Union['InstanceVolumeArgs', 'InstanceVolumeArgsDict']]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
