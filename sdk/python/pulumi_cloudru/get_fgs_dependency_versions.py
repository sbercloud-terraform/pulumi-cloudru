...
def get_fgs_dependency_versions(dependency_id: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region where the dependency package and the versions are located.  
    ...
    :param builtins.str version_id: Specifies the ID of the dependency package version.
    """
    __args__ = dict()
...
def get_fgs_dependency_versions_output(dependency_id: Optional[pulumi.Input[builtins.str]] = None,
