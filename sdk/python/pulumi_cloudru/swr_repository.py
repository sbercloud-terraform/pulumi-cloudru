...
class SwrRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] organization: Specifies the name of the organization (namespace) the repository belongs.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] category: Specifies the category of the repository.
               The value can be `app_server`, `linux`, `framework_app`, `database`, `lang`, `other`, `windows`, `arm`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the repository.
        :param pulumi.Input[builtins.bool] is_public: Specifies whether the repository is public. Default is false.
        :param pulumi.Input[builtins.str] name: Specifies the name of the repository. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource. If omitted, the
...
class _SwrRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: Specifies the category of the repository.
               The value can be `app_server`, `linux`, `framework_app`, `database`, `lang`, `other`, `windows`, `arm`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the repository.
        :param pulumi.Input[builtins.str] internal_path: Intra-cluster image address for docker pull.
        :param pulumi.Input[builtins.bool] is_public: Specifies whether the repository is public. Default is false.
        :param pulumi.Input[builtins.str] name: Specifies the name of the repository. Changing this creates a new resource.
        :param pulumi.Input[builtins.int] num_images: Number of image tags in a repository.
        :param pulumi.Input[builtins.str] organization: Specifies the name of the organization (namespace) the repository belongs.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] path: Image address for docker pull.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the resource. If omitted, the
               provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.int] repository_id: Numeric ID of the repository
        :param pulumi.Input[builtins.int] size: Repository size.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
        if description is not None:
