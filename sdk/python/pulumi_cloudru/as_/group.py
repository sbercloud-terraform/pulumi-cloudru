...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scaling_group_name: Specifies the name of the scaling group. The name can contain
               letters, digits, underscores(_), and hyphens(-),and cannot exceed 64 characters.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this creates a new group.
        :param pulumi.Input[builtins.str] agency_name: Specifies the IAM agency name. If you change the agency,
               the new agency will be available for ECSs scaled out after the change.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the availability zones in which to create the instances in the
               autoscaling group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] available_zones: schema: Deprecated; use availability_zones instead
        :param pulumi.Input[builtins.int] cool_down_time: Specifies the cooling duration (in seconds). The value ranges from 0 to 86400,
               and is 300 by default.
        :param pulumi.Input[builtins.str] delete_instances: Specifies whether to delete the instances in the AS group when deleting
               the AS group. The options are `yes` and `no`.
        :param pulumi.Input[builtins.bool] delete_publicip: Specifies whether to delete the elastic IP address bound to the instances of
               AS group when deleting the instances. The options are `true` and `false`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the AS group.
               The value can contain 0 to 256 characters.
        :param pulumi.Input[builtins.int] desire_instance_number: Specifies the expected number of instances. The default value is the
               minimum number of instances. The value ranges from the minimum number of instances to the maximum number of instances.
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the AS Group. The options are `true` and `false`.
               The default value is `true`.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the AS group.
               
               <a name="group_network_object"></a>
               The `networks` block supports:
        :param pulumi.Input[builtins.bool] force_delete: Specifies whether to forcibly delete the AS group, remove the ECS instances and
               release them. The default value is `false`.
        :param pulumi.Input[builtins.int] health_periodic_audit_grace_period: Specifies the health check grace period for instances.
        ...
        :param pulumi.Input[builtins.str] health_periodic_audit_method: Specifies the health check method for instances in the AS group.
        ...
        :param pulumi.Input[builtins.int] health_periodic_audit_time: Specifies the health check period for instances. The unit is minute
               and value includes 0, 1, 5 (default), 15, 60, and 180. If the value is set to 0, health check is performed every 10 seconds.
        :param pulumi.Input[builtins.str] instance_terminate_policy: Specifies the instance removal policy. The policy has four
        ...
        :param pulumi.Input[builtins.int] max_instance_number: Specifies the maximum number of instances. The default value is 0.
        :param pulumi.Input[builtins.int] min_instance_number: Specifies the minimum number of instances. The default value is 0.
        :param pulumi.Input[builtins.str] multi_az_scaling_policy: Specifies the priority policy used to select target AZs when adjusting
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the AS group.
               If omitted, the provider-level region will be used. Changing this creates a new group.
        :param pulumi.Input[builtins.str] scaling_configuration_id: Specifies the configuration ID which defines configurations
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the AS group.
        """
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] cool_down_time: Specifies the cooling duration (in seconds). The value ranges from 0 to 86400,
               and is 300 by default.
        :param pulumi.Input[builtins.int] current_instance_number: The number of current instances in the AS group.
        :param pulumi.Input[builtins.str] delete_instances: Specifies whether to delete the instances in the AS group when deleting
               the AS group. The options are `yes` and `no`.
        :param pulumi.Input[builtins.bool] delete_publicip: Specifies whether to delete the elastic IP address bound to the instances of
               AS group when deleting the instances. The options are `true` and `false`.
        ...
        :param pulumi.Input[builtins.str] instance_terminate_policy: Specifies the instance removal policy. The policy has four
               ...
               + **OLD_INSTANCE**: The earlier-created instances are removed first.
               + **NEW_INSTANCE**: The later-created instances are removed first.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: The instances IDs of the AS group.
        :param pulumi.Input[builtins.str] lb_listener_id: The system supports the binding of up to six ELB listeners, the IDs of which are separated using a comma.
        :param pulumi.Input[Sequence[pulumi.Input['GroupLbaasListenerArgs']]] lbaas_listeners: Specifies an array of one or more enhanced load balancer. The system supports
               the binding of up to six load balancers. The object structure is documented below.
        :param pulumi.Input[builtins.int] max_instance_number: Specifies the maximum number of instances. The default value is 0.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GroupSecurityGroupArgs']]] security_groups: Specifies an array of one or more security group IDs to associate with the group.
               ...
               ECS instances will be added to the default security group. For your convenience, you are advised to specify the security
               group in the AS configuration.
        :param pulumi.Input[builtins.str] status: The status of the AS group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the AS group.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID. Changing this creates a new group.
        """
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Group':
        """
