...
class FgsLtsLogEnableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region where the LTS log function is to be enabled.  
...
class FgsLtsLogEnable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'FgsLtsLogEnable':
        """
