...
class ClusterBackupStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] start_time: Specifies the time when a snapshot is automatically created everyday. Snapshots can
               only be created on the hour. The time format is the time followed by the time zone, specifically, **HH:mm z**. In the
               format, **HH:mm** refers to the hour time and z refers to the time zone. For example, "00:00 GMT+08:00"
               and "01:00 GMT+08:00".
        :param pulumi.Input[builtins.str] agency: Specifies the IAM agency used to access OBS.
               
               > **NOTE:**  If the `bucket`, `backup_path`, and `agency` parameters are empty at the same time, the system will
               automatically create an OBS bucket and IAM agent, otherwise the configured parameter values will be used.
        :param pulumi.Input[builtins.str] backup_path: Specifies the storage path of the snapshot in the OBS bucket.
        :param pulumi.Input[builtins.str] bucket: Specifies the OBS bucket used for index data backup. If there is snapshot data in an OBS
               bucket, only the OBS bucket is used and cannot be changed.
        :param pulumi.Input[builtins.int] keep_days: Specifies the number of days to retain the generated snapshots. Snapshots are reserved
               for seven days by default.
        :param pulumi.Input[builtins.str] prefix: Specifies the prefix of the snapshot that is automatically created. Defaults to **snapshot**.
        """
...
class ClusterClientNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] flavor: Specifies the flavor name.
        :param pulumi.Input[builtins.int] instance_number: Specifies the number of cluster instances.
               + When it is `master_node_config`, The value range is `3` to `10`.
               + When it is `client_node_config`, The value range is `1` to `32`.
        :param pulumi.Input['ClusterClientNodeConfigVolumeArgs'] volume: Specifies the information about the volume.
               The volume structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] shrink_node_ids: Specifies the node IDs that needs to be scaled down.
...
class ClusterClientNodeConfigVolumeArgs:
    def __init__(__self__, *,
                 ...
                 volume_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] size: Specifies the volume size in **GB**, which must be a multiple of `10`.
        :param pulumi.Input[builtins.str] volume_type: Specifies the volume type. Value options are as follows:
               + **COMMON**: Common I/O. The SATA disk is used.
               + **HIGH**: High I/O. The SAS disk is used.
               + **ULTRAHIGH**: Ultra-high I/O. The solid-state drive (SSD) is used.
...
class ClusterKibanaPublicAccessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] bandwidth: Specifies the public network bandwidth.
        :param pulumi.Input[builtins.bool] whitelist_enabled: Specifies whether to enable the public network access control.
        :param pulumi.Input[builtins.str] whitelist: Specifies the whitelist of access control. The whitelisted account id must be unique.
        """
...
class ClusterNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip: Instance IP address.
        :param pulumi.Input[builtins.str] name: Specifies the cluster name. It contains `4` to `32` characters.
               Only letters, digits, hyphens (-), and underscores (_) are allowed. The value must start with a letter.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] resource_id: The resource ID of this instance.
        :param pulumi.Input[builtins.str] spec_code: Instance specification code.
        :param pulumi.Input[builtins.str] status: Instance status.
        :param pulumi.Input[builtins.str] type: Node type. The options are as follows:
               + **ess-master:** Indicates a master node.
               + **ess-client:** Indicates a client node.
               + **ess-cold:** Indicates a cold data node.
               + **ess indicates:** Indicates a data node.
...
class ClusterNodeConfigNetworkInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subnet_id: Specifies the Subnet ID.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the VPC ID.
               Changing this parameter will create a new resource.
        """
...
class ClusterVpcepEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] endpoint_with_dns_name: Specifies whether to enable the private domain name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelists: Specifies the whitelist of access control. The whitelisted account id must be unique.
        """
