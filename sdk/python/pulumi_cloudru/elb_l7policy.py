...
class ElbL7policyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] listener_id: The Listener on which the L7 Policy will be associated with. Changing
        ...
        :param pulumi.Input[builtins.str] redirect_pool_id: Requests matching this policy will be redirected to the pool with this ID.
