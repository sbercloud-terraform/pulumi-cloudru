...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] direction: Specifies the direction of data flow.
        ...
        :param pulumi.Input['JobSourceDbArgs'] source_db: Specifies the source database configuration.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] type: Specifies the job type. Changing this parameter will create a new
               resource. The options are as follows:
               + **migration**: Online Migration.
               + **sync**: Data Synchronization.
               + **cloudDataGuard**: Disaster Recovery.
        :param pulumi.Input[builtins.str] description: Specifies the description of the job, which contain a
               maximum of 256 characters, and certain special characters (including !<>&'"\\\\) are not allowed.
        :param pulumi.Input[builtins.bool] destination_db_readnoly: Specifies the destination DB instance as read-only helps
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] expired_days: Specifies how many days after the task is abnormal, it will automatically
               end. The value ranges from 14 to 100. the default value is `14`. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] force_destroy: Specifies whether to forcibly destroy the job even if it is running.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['JobLimitSpeedArgs']]] limit_speeds: Specifies the migration speed by setting a time period.
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] migrate_definer: Specifies whether to migrate the definers of all source database
               objects to the `user` of `destination_db`. The default value is `true`.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] migration_type: Specifies migration type.
               Changing this parameter will create a new resource. The options are as follows:
        ...
        :param pulumi.Input[builtins.bool] multi_write: Specifies whether to enable multi write. It is mandatory when `type`
        ...
        :param pulumi.Input[builtins.str] net_type: Specifies the network type.
               Changing this parameter will create a new resource. The options are as follows:
        ...
        :param pulumi.Input[builtins.str] start_time: Specifies the time to start the job. The time format
               is `yyyy-MM-dd HH:mm:ss`. Start immediately by default. Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the DRS job.
               Changing this parameter will create a new resource.
        """
...
class _JobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Create time. The format is ISO8601:YYYY-MM-DDThh:mm:ssZ
        :param pulumi.Input[builtins.str] description: Specifies the description of the job, which contain a
               maximum of 256 characters, and certain special characters (including !<>&'"\\\\) are not allowed.
        :param pulumi.Input['JobDestinationDbArgs'] destination_db: Specifies the destination database configuration.
               The `db_info` object structure of the `destination_db` is documented below.
