...
class WhitelistArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] listener_id: The Listener ID that the whitelist will be associated with. Changing this
               creates a new whitelist.
        :param pulumi.Input[builtins.bool] enable_whitelist: Specify whether to enable access control.
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB whitelist resource. If omitted, the
               provider-level region will be used. Changing this creates a new whitelist.
        :param pulumi.Input[builtins.str] whitelist: Specifies the IP addresses in the whitelist. Use commas(,) to separate the multiple
               IP addresses.
        """
...
class Whitelist(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            whitelist: Optional[pulumi.Input[builtins.str]] = None) -> 'Whitelist':
        """
