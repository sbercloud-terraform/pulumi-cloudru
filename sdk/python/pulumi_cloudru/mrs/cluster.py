...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone in which to create the cluster.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] component_lists: Specifies the list of component names. For the components supported by
               the cluster, please following [reference](https://support.hc.sbercloud.ru/api/mrs/mrs_02_0101.html)
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] manager_admin_pass: Specifies the administrator password, which is used to log in to
        ...
        :param pulumi.Input['ClusterMasterNodesArgs'] master_nodes: Specifies a list of the information about the master nodes in the
               ...
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the network ID of a subnet which bound to the MapReduce cluster.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] version: Specifies the MapReduce cluster version. The valid values are `MRS 2.1.0`
               , `MRS 3.0.5` and `MRS 3.1.0`. Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC which bound to the MapReduce cluster. Changing
        ...
        :param pulumi.Input[builtins.str] eip_id: Specifies the EIP ID which bound to the MapReduce cluster.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies a unique ID in UUID format of enterprise project.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.bool] log_collection: Specifies whether logs are collected when cluster installation fails.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the MapReduce cluster. The name can contain 2 to 64
        ...
        :param pulumi.Input[builtins.str] node_admin_pass: Specifies the administrator password, which is used to log in to the
        ...
        :param pulumi.Input[builtins.str] node_key_pair: Specifies the name of a key pair, which is used to log in to the each
               nodes(/ECSs). Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] public_ip: Specifies the EIP address which bound to the MapReduce cluster.
               The EIP must have been created and must be in the same region as the cluster.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the MapReduce cluster resource. If omitted, the
               provider-level region will be used. Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.bool] safe_mode: Specifies whether the running mode of the MapReduce cluster is secure,
               default to true.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Specifies an array of one or more security group ID to attach to the
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the cluster.
        :param pulumi.Input[builtins.str] template_id: Specifies the template used for node deployment when the cluster type is
               CUSTOM.
        ...
        :param pulumi.Input[builtins.str] type: Specifies the type of the MapReduce cluster. The valid values are *ANALYSIS*,
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone in which to create the cluster.
               For more information about regions and AZs, see [Regions and Endpoints](https://support.hc.sbercloud.ru/en-us/endpoint/index.html).
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] charging_start_time: The charging start time which is the start time of billing, in RFC-3339 format.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] component_lists: Specifies the list of component names. For the components supported by
               the cluster, please following [reference](https://support.hc.sbercloud.ru/api/mrs/mrs_02_0101.html)
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] create_time: The cluster creation time, in RFC-3339 format.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterCustomNodeArgs']]] custom_nodes: Specifies a list of the informations about the custom nodes in the MapReduce
               cluster.
               The `nodes` object structure of the `custom_nodes` is documented below.
               `Unlike other nodes, it needs to specify group_name`
        ...
        :param pulumi.Input[builtins.str] manager_admin_pass: Specifies the administrator password, which is used to log in to
               ...
               spelled backwards. The password must contain lowercase letters, uppercase letters, digits, spaces and the special
               characters: `!?,.:-_{}[]@$^+=/`. Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] master_node_ip: The IP address of the master node.
        :param pulumi.Input['ClusterMasterNodesArgs'] master_nodes: Specifies a list of the information about the master nodes in the
               MapReduce cluster.
               The `nodes` object structure of the `master_nodes` is documented below.
               Changing this will create a new MapReduce cluster resource.
        ...
        :param pulumi.Input[builtins.str] node_key_pair: Specifies the name of a key pair, which is used to log in to the each
               nodes(/ECSs). Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] private_ip: The preferred private IP address of the master node.
        :param pulumi.Input[builtins.str] public_ip: Specifies the EIP address which bound to the MapReduce cluster.
               The EIP must have been created and must be in the same region as the cluster.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the MapReduce cluster resource. If omitted, the
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Specifies an array of one or more security group ID to attach to the
               MapReduce cluster. If using the specified security group, the group need to open the specified port (9022) rules.
        :param pulumi.Input[builtins.str] status: The cluster state, which include: running, frozen, abnormal and failed.
        :param pulumi.Input['ClusterStreamingCoreNodesArgs'] streaming_core_nodes: Specifies a list of the informations about the streaming core nodes in the
               MapReduce cluster.
               The `nodes` object structure of the `streaming_core_nodes` is documented below.
        :param pulumi.Input['ClusterStreamingTaskNodesArgs'] streaming_task_nodes: Specifies a list of the informations about the streaming task nodes in the
        ...
        :param pulumi.Input[builtins.str] template_id: Specifies the template used for node deployment when the cluster type is
               ...
               and data instances are deployed in different node groups. This deployment mode is applicable to a cluster with more
               than 500 nodes. Components can be deployed separately, which can be used for a larger cluster scale.
        :param pulumi.Input[builtins.int] total_node_number: The total number of nodes deployed in the cluster.
        :param pulumi.Input[builtins.str] type: Specifies the type of the MapReduce cluster. The valid values are *ANALYSIS*,
               *STREAMING* and *MIXED*, default to *ANALYSIS*. Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] update_time: The cluster update time, in RFC-3339 format.
        :param pulumi.Input[builtins.str] version: Specifies the MapReduce cluster version. The valid values are `MRS 2.1.0`
               , `MRS 3.0.5` and `MRS 3.1.0`. Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC which bound to the MapReduce cluster. Changing
               this will create a new MapReduce cluster resource.
