...
class AclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the network ACL. This parameter can
               contain a maximum of 255 characters and cannot contain angle brackets (< or >).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inbound_rules: A list of the IDs of ingress rules associated with the network ACL.
        :param pulumi.Input[builtins.str] name: Specifies the network ACL name. This parameter can contain a maximum of 64 characters,
               which may consist of letters, digits, underscores (_), and hyphens (-).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_rules: A list of the IDs of egress rules associated with the network ACL.
        :param pulumi.Input[builtins.str] region: The region in which to create the network acl resource. If omitted, the
               provider-level region will be used. Changing this creates a new network acl resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: A list of the IDs of networks associated with the network ACL.
        """
...
class _AclState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the network ACL. This parameter can
               contain a maximum of 255 characters and cannot contain angle brackets (< or >).
        :param pulumi.Input[builtins.str] inbound_policy_id: The ID of the ingress firewall policy for the network ACL.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inbound_rules: A list of the IDs of ingress rules associated with the network ACL.
        :param pulumi.Input[builtins.str] name: Specifies the network ACL name. This parameter can contain a maximum of 64 characters,
               which may consist of letters, digits, underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] outbound_policy_id: The ID of the egress firewall policy for the network ACL.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_rules: A list of the IDs of egress rules associated with the network ACL.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ports: A list of the port IDs of the subnet gateway.
        :param pulumi.Input[builtins.str] region: The region in which to create the network acl resource. If omitted, the
               provider-level region will be used. Changing this creates a new network acl resource.
...
class Acl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Acl':
        """
