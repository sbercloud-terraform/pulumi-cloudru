...
def get_keypairs(fingerprint: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to obtain the keypairs. If omitted, the provider-level
           region will be used.
    """
    __args__ = dict()
...
def get_keypairs_output(fingerprint: Optional[pulumi.Input[Optional[builtins.str]]] = None,
