...
def get_flavors(availability_zone: Optional[builtins.str] = None,
    ...
    :param builtins.str availability_zone: Specifies the availability zone which the RDS flavor belongs to.
    :param builtins.str db_type: Specifies the DB engine. Value: MySQL, PostgreSQL, SQLServer.
    :param builtins.str db_version: Specifies the database version. Available value:
    ...
    :param builtins.str region: The region in which to obtain the RDS flavors. If omitted, the provider-level region will be used.
...
def get_flavors_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
