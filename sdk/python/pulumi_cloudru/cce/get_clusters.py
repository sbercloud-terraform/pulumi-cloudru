...
def get_clusters(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: Specifies the ID of the cluster.
    ...
    :param builtins.str region: Specifies the region in which to obtain the CCE clusters. If omitted, the
...
def get_clusters_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
