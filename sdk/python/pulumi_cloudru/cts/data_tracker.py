...
class DataTrackerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_bucket: Specifies the OBS bucket tracked by the data tracker.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] bucket_name: Specifies the OBS bucket to which traces will be transferred.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_operations: Specifies an array of operation types tracked by the data tracker,
               the value of operation can be **WRITE** or **READ**.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether tracker is enabled.
        :param pulumi.Input[builtins.str] file_prefix: Specifies the file name prefix to mark trace files that need to be stored
               in an OBS bucket. The value contains 0 to 64 characters. Only letters, numbers, hyphens (-), underscores (_),
               and periods (.) are allowed.
        :param pulumi.Input[builtins.bool] lts_enabled: Specifies whether trace analysis is enabled.
        :param pulumi.Input[builtins.str] name: Specifies the data tracker name. The name cannot be system or ststem-trace.
               Changing this creates a new resource.
        :param pulumi.Input[builtins.int] obs_retention_period: Specifies the retention period that traces are stored in `bucket_name`,
               the value can be **0**(permanent), **30**, **60**, **90**, **180** or **1095**.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to manage the CTS data tracker resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.bool] validate_file: Specifies whether trace file verification is enabled during trace transfer.
        """
...
class _DataTrackerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to manage the CTS data tracker resource.
               If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] status: The tracker status, the value can be **enabled**, **disabled** or **error**.
        :param pulumi.Input[builtins.bool] transfer_enabled: Whether traces will be transferred.
        :param pulumi.Input[builtins.str] type: The tracker type, only **data** is available.
        :param pulumi.Input[builtins.bool] validate_file: Specifies whether trace file verification is enabled during trace transfer.
        """
...
class DataTracker(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transfer_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            validate_file: Optional[pulumi.Input[builtins.bool]] = None) -> 'DataTracker':
        """
