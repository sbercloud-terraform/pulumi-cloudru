...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies an ID of the MapReduce cluster to which the job belongs to.
               Changing this will create a new MapReduce job resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the MapReduce job. The name can contain 1 to 64
        ...
        :param pulumi.Input[builtins.str] parameters: Specifies the parameters for the MapReduce job. Add an at sign (@) before
               ...
               MapReduce job resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] program_parameters: Specifies the the key/value pairs of the program parameters, such as
               ...
               **HiveScript**. Refer to the documents for each type of support key-values.
               Changing this will create a new MapReduce job resource.
        :param pulumi.Input[builtins.str] program_path: Specifies the .jar package path or .py file path for program execution.
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the MapReduce job resource. If
               omitted, the provider-level region will be used. Changing this will create a new MapReduce job resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] service_parameters: Specifies the key/value pairs used to modify service configuration.
               Parameter configurations of services are available on the Service Configuration tab page of MapReduce Manager.
               Changing this will create a new MapReduce job resource.
        :param pulumi.Input[builtins.str] sql: Specifies the SQL command or file path. Only required if `type` is **HiveSql**
...
class _JobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Specifies an ID of the MapReduce cluster to which the job belongs to.
               Changing this will create a new MapReduce job resource.
        :param pulumi.Input[builtins.str] finish_time: The completion time of the MapReduce job.
        :param pulumi.Input[builtins.str] name: Specifies the name of the MapReduce job. The name can contain 1 to 64
               characters, which may consist of letters, digits, underscores (_) and hyphens (-). Changing this will create a new
               MapReduce job resource.
        ...
        :param pulumi.Input[builtins.str] sql: Specifies the SQL command or file path. Only required if `type` is **HiveSql**
               or **SparkSql**. Changing this will create a new MapReduce job resource.
        :param pulumi.Input[builtins.str] start_time: The creation time of the MapReduce job.
        :param pulumi.Input[builtins.str] status: Status of the MapReduce job.
        :param pulumi.Input[builtins.str] submit_time: The submission time of the MapReduce job.
        """
