...
def get_associations(attachment_id: Optional[builtins.str] = None,
                     attachment_type: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: Specifies the ER instance ID to which the association belongs.
...
def get_associations_output(attachment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            attachment_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
