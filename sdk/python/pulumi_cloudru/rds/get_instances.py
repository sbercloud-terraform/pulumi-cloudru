...
def get_instances(datastore_type: Optional[builtins.str] = None,
    ...
    :param builtins.str datastore_type: Specifies the type of the database. Valid values are: MySQL, PostgreSQL, and SQLServer.
...
def get_instances_output(datastore_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
