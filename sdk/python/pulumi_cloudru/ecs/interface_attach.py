...
class InterfaceAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_id: The ID of the Network to attach to an Instance. A port will be created
               automatically.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the network interface attache resource. If
               omitted, the provider-level region will be used. Changing this creates a new network interface attache resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Specifies the list of security group IDs bound to the specified port.  
...
class _InterfaceAttachState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fixed_ip: An IP address to assosciate with the port.
               ...
               the supplied network.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Instance to attach the Port or Network to.
        :param pulumi.Input[builtins.str] mac: The MAC address of the NIC.
        :param pulumi.Input[builtins.str] network_id: The ID of the Network to attach to an Instance. A port will be created
               automatically.
               This option and `port_id` are mutually exclusive.
        :param pulumi.Input[builtins.str] port_id: The ID of the Port to attach to an Instance.
...
class InterfaceAttach(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            source_dest_check: Optional[pulumi.Input[builtins.bool]] = None) -> 'InterfaceAttach':
        """
