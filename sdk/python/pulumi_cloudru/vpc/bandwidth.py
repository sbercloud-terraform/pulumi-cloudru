...
class BandwidthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] size: The size of the Shared Bandwidth. The value ranges from 5 to 2000 G.
        :param pulumi.Input[builtins.str] bandwidth_type: Indicates the bandwidth type.
        :param pulumi.Input[builtins.str] charge_mode: Indicates whether the billing is based on traffic, bandwidth, or 95th percentile bandwidth (enhanced).
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the Shared Bandwidth. Changing
               this creates a new bandwidth.
        :param pulumi.Input[builtins.str] name: The name of the Shared Bandwidth.
        :param pulumi.Input[builtins.str] region: The region in which to create the Shared Bandwidth. If omitted, the
...
class _BandwidthState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the Shared Bandwidth. If omitted, the
               provider-level region will be used. Changing this creates a new Shared Bandwidth resource.
        :param pulumi.Input[builtins.str] share_type: Indicates whether the bandwidth is shared or dedicated.
        :param pulumi.Input[builtins.int] size: The size of the Shared Bandwidth. The value ranges from 5 to 2000 G.
        :param pulumi.Input[builtins.str] status: Indicates the bandwidth status.
        """
        if auto_renew is not None:
            pulumi.set(__self__, "auto_renew", auto_renew)
        if bandwidth_type is not None:
...
class Bandwidth(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Bandwidth':
        """
