...
def get_maintainwindow(begin: Optional[builtins.str] = None,
    ...
    maintainwindow1 = sbercloud.Dcs.get_maintainwindow(seq=1)
    ```
    ...
    :param builtins.str region: The region in which to obtain the dcs maintainwindows. If omitted, the provider-level region will be used.
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:Dcs/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult).value
...
def get_maintainwindow_output(begin: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:Dcs/getMaintainwindow:getMaintainwindow', __args__, opts=opts, typ=GetMaintainwindowResult)
