...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol of the identity provider.
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the identity provider.
        :param pulumi.Input[builtins.str] metadata: Specifies the metadata of the IDP(Identity Provider) server.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the identity provider to be registered.
               ...
               Changing this creates a new resource.
        :param pulumi.Input[builtins.str] sso_type: The single sign-on type of the identity provider.
        :param pulumi.Input[builtins.bool] status: Enabled status for the identity provider. Defaults to true.
        """
...
class _ProviderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the identity provider.
        :param pulumi.Input[builtins.str] login_link: The login link of the identity provider.
        :param pulumi.Input[builtins.str] metadata: Specifies the metadata of the IDP(Identity Provider) server.
               To obtain the metadata file of your enterprise IDP, contact the enterprise administrator.
               This field is used to import a metadata file to IAM to implement federated identity authentication.
               This field is required only if the protocol is set to *saml*.
...
class Provider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[builtins.str]] = None,
            sso_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.bool]] = None) -> 'Provider':
        """
