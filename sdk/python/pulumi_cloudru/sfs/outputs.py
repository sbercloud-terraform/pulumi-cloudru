...
class FileSystemAccessRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_level: Specifies the access level of the shared file system. Possible values are *ro* (read-only)
               and *rw* (read-write). The default value is *rw* (read/write). Changing this will create a new access rule.
        :param builtins.str access_rule_id: The UUID of the share access rule.
        :param builtins.str access_to: Specifies the value that defines the access rule. The value contains 1 to 255 characters.
        ...
        :param builtins.str access_type: Specifies the type of the share access rule. The default value is *cert*.
               Changing this will create a new access rule.
        :param builtins.str status: The status of the share access rule.
        """
...
class GetTurbosTurboResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param builtins.str availability_zone: The availability zone where the SFS turbo file system is located.
        :param builtins.str available_capacity: The available capacity of the SFS turbo file system, in GB.
        :param builtins.str crypt_key_id: The ID of a KMS key to encrypt the SFS turbo file system.
        :param builtins.bool enhanced: Whether the SFS turbo file system is enhanced.
        :param builtins.str enterprise_project_id: The enterprise project ID of the SFS turbo file system.
        :param builtins.str export_location: The mount point of the SFS turbo file system.
        :param builtins.str id: The resource ID of the SFS turbo file system.
        :param builtins.str name: Specifies the name of the SFS turbo file system.
        :param builtins.str security_group_id: The ID of the security group to which the SFS turbo belongs.
        :param builtins.str share_proto: Specifies the protocol of the SFS turbo file system. The valid value is **NFS**.
        :param builtins.str share_type: Specifies the type of the SFS turbo file system.
               The valid values are **STANDARD** and **PERFORMANCE**.
        :param builtins.int size: Specifies the capacity of the SFS turbo file system, in GB.
               The value ranges from `500` to `32,768`, and must be large than `10,240` for an enhanced file system.
        :param builtins.str subnet_id: The **network ID** of the subnet to which the SFS turbo belongs.
        :param builtins.str version: The version of the SFS turbo file system.
        :param builtins.str vpc_id: The ID of the VPC to which the SFS turbo belongs.
        """
