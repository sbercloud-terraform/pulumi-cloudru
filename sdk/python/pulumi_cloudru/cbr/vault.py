...
class VaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protection_type: Specifies the protection type of the CBR vault.
               The valid values are **backup** and **replication**. Vaults of type **disk** don't support **replication**.
               Changing this will create a new vault.
        :param pulumi.Input[builtins.int] size: Specifies the vault capacity, in GB. The valid value range is `1` to `10,485,760`.
               
               > You cannot update `size` if the vault is **prePaid** mode.
        :param pulumi.Input[builtins.str] type: Specifies the object type of the CBR vault.
               Changing this will create a new vault. Vaild values are as follows:
               + **server** (Cloud Servers)
               + **disk** (EVS Disks)
               + **turbo** (SFS Turbo file systems)
        :param pulumi.Input[builtins.bool] auto_bind: Specifies whether automatic association is enabled. Defaults to **false**.
        :param pulumi.Input[builtins.bool] auto_expand: Specifies to enable auto capacity expansion for the backup protection type vault.
               Defaults to **false**.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] bind_rules: Specifies the tags to filter resources for automatic association with **auto_bind**.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the vault.
        ...
        :param pulumi.Input[builtins.str] consistent_level: Specifies the backup specifications.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies a unique ID in UUID format of enterprise project.
               Changing this will create a new vault.
        :param pulumi.Input[builtins.bool] is_multi_az: Specifies whether multiple availability zones are used for backing up.
               Defaults to **false**.
        :param pulumi.Input[builtins.bool] locked: Locked status of the vault.
        :param pulumi.Input[builtins.str] name: Specifies a unique name of the CBR vault. This parameter can contain a maximum of 64
               characters, which may consist of letters, digits, underscores(_) and hyphens (-).
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the vault.
               If `period_unit` is set to **month**, the value ranges from 1 to 9.
               If `period_unit` is set to **year**, the value ranges from 1 to 5.
               This parameter is mandatory if `charging_mode` is set to **prePaid**.
               Changing this will create a new vault.
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the vault.
        ...
        :param pulumi.Input[builtins.str] policy_id: Specifies a policy to associate with the CBR vault.
               `policy_id` cannot be used with the vault of replicate protection type.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the CBR vault. If omitted, the
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the CBR vault.
        """
...
class _VaultState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] allocated: The allocated capacity of the vault, in GB.
        :param pulumi.Input[builtins.bool] auto_bind: Specifies whether automatic association is enabled. Defaults to **false**.
        :param pulumi.Input[builtins.bool] auto_expand: Specifies to enable auto capacity expansion for the backup protection type vault.
               Defaults to **false**.
...
class Vault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            used: Optional[pulumi.Input[builtins.float]] = None) -> 'Vault':
        """
