...
class PackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] object_path: Specifies the OBS storage path where the package is located.
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] type: Specifies the package type.
               + **jar**: `.jar` or jar related files.
               + **pyFile**: `.py` or python related files.
               + **file**: Other user files.
               
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] group_name: Specifies the group name which the package belongs to.
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.bool] is_async: Specifies whether to upload resource packages in asynchronous mode.
               The default value is **false**. Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] owner: Specifies the name of the package owner. The owner must be IAM user.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to upload packages.
...
class _PackageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Time when a queue is created.
        :param pulumi.Input[builtins.str] group_name: Specifies the group name which the package belongs to.
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.bool] is_async: Specifies whether to upload resource packages in asynchronous mode.
               The default value is **false**. Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] object_name: The package name.
        :param pulumi.Input[builtins.str] object_path: Specifies the OBS storage path where the package is located.
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] owner: Specifies the name of the package owner. The owner must be IAM user.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to upload packages.
               If omitted, the provider-level region will be used.
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] status: Status of a package group to be uploaded.
        :param pulumi.Input[builtins.str] type: Specifies the package type.
               + **jar**: `.jar` or jar related files.
               + **pyFile**: `.py` or python related files.
               + **file**: Other user files.
               ...
               Changing this parameter will delete the current package and upload a new package.
        :param pulumi.Input[builtins.str] updated_at: The last time when the package configuration update has complated.
        """
...
class Package(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Package':
        """
