...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of a queue.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the database name. The name consists of 1 to 128 characters, starting
               with a letter or digit. Only letters, digits and underscores (_) are allowed and the name cannot be all digits.
               Changing this parameter will create a new database resource.
        :param pulumi.Input[builtins.str] owner: Specifies the name of the SQL database owner.
               The owner must be IAM user.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the DLI database resource.
...
class Database(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Database':
        """
