...
class ClusterAnalysisCoreNodesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] data_volume_count: Specifies the data disk number of the nodes. The number configuration
               of each node are as follows:
               + master_nodes: 1.
               + analysis_core_nodes: minimum is one and the maximum is subject to the configuration of the corresponding flavor.
               + streaming_core_nodes: minimum is one and the maximum is subject to the configuration of the corresponding flavor.
               ...
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] flavor: Specifies the instance specifications for each nodes in node group.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.int] node_number: Specifies the number of nodes for the node group.
               
               > **NOTE:** Only the core group and task group updations are allowed. The number of nodes after scaling cannot be
               less than the number of nodes originally created.
        :param pulumi.Input[builtins.int] root_volume_size: Specifies the system disk size of the nodes. Changing this will create
               a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] root_volume_type: Specifies the system disk flavor of the nodes. Changing this will
               create a new MapReduce cluster resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] assigned_roles: Specifies the roles deployed in a node group.This argument is mandatory
               when the cluster type is CUSTOM. Each character string represents a role expression.
               ...
               **Role expression definition:**
               ...
               > `DBService` is a basic component of a cluster. Components such as Hive, Hue, Oozie, Loader, and Redis, and Loader
               store their metadata in DBService, and provide the metadata backup and restoration functions by using DBService.
        :param pulumi.Input[builtins.int] data_volume_size: Specifies the data disk size of the nodes,in GB. The value range is 10
               to 32768. Required if `data_volume_count` is greater than zero. Changing this will create a new MapReduce
               cluster resource.
        :param pulumi.Input[builtins.str] data_volume_type: Specifies the data disk flavor of the nodes.
               Required if `data_volume_count` is greater than zero. Changing this will create a new MapReduce cluster resource.
               The following disk types are supported:
               + `SATA`: common I/O disk
               + `SAS`: high I/O disk
               + `SSD`: ultra-high I/O disk
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] host_ips: The host list of this nodes group in the cluster.
        """
...
class ClusterCustomNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] flavor: Specifies the instance specifications for each nodes in node group.
               Changing this will create a new MapReduce cluster resource.
        :param pulumi.Input[builtins.str] group_name: Specifies the name of nodes for the node group.
