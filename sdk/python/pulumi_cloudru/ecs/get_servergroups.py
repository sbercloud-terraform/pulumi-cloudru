...
def get_servergroups(name: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Specifies the region in which to obtain the server groups.
...
def get_servergroups_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
