...
def get_route_table(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Specifies the ID of the route table.
    :param builtins.str name: Specifies the name of the route table.
    :param builtins.str region: The region in which to query the vpc route table.
           If omitted, the provider-level region will be used.
    :param builtins.str vpc_id: Specifies the VPC ID where the route table resides.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_route_table_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
