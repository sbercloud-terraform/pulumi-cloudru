...
class GetBlackWhiteListsResult:
    ...
    def list_type(self) -> builtins.int:
...
def get_black_white_lists(address: Optional[builtins.str] = None,
                          ...
                          list_type: Optional[builtins.int] = None,
    ...
    :param builtins.int list_type: Specifies the blacklist/whitelist type.
...
def get_black_white_lists_output(address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
