...
class ReadReplicaInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the AZ name.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] flavor: Specifies the specification code.
        :param pulumi.Input[builtins.str] primary_instance_id: Specifies the DB instance ID, which is used to create a read replica.
               Changing this parameter will create a new resource.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the read replica instance.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] name: Specifies the DB instance name. The DB instance name of the same type
               ...
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] region: The region in which to create the rds read replica instance resource.
               If omitted, the provider-level region will be used.
               
               Currently, read replicas can be created *only* in the same region as that of the primary DB instance.
        :param pulumi.Input[builtins.str] security_group_id: Indicates the security group which the RDS DB instance belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the RDS read replica instance. Each tag is represented by one key-value pair.
        """
...
class _ReadReplicaInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] primary_instance_id: Specifies the DB instance ID, which is used to create a read replica.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: Indicates the private IP address list.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the rds read replica instance resource.
               ...
               Currently, read replicas can be created *only* in the same region as that of the primary DB instance.
        :param pulumi.Input[builtins.str] security_group_id: Indicates the security group which the RDS DB instance belongs to.
        :param pulumi.Input[builtins.str] status: Indicates the instance status.
        :param pulumi.Input[builtins.str] subnet_id: Indicates the subnet id.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the RDS read replica instance. Each tag is represented by one key-value pair.
        :param pulumi.Input[builtins.str] type: Indicates the DB engine. Value: MySQL, PostgreSQL, SQLServer.
        :param pulumi.Input['ReadReplicaInstanceVolumeArgs'] volume: Specifies the volume information. Structure is documented below.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] vpc_id: Indicates the VPC ID.
        """
        if auto_renew is not None:
            pulumi.set(__self__, "auto_renew", auto_renew)
...
class ReadReplicaInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            volume: Optional[pulumi.Input[Union['ReadReplicaInstanceVolumeArgs', 'ReadReplicaInstanceVolumeArgsDict']]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ReadReplicaInstance':
        """
