...
class VipAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] port_ids: An array of one or more IDs of the ports to attach the vip to.
        :param pulumi.Input[builtins.str] vip_id: The ID of vip to attach the ports to.
        :param pulumi.Input[builtins.str] region: The region in which to create the vip associate resource. If omitted, the
...
class _VipAssociateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: The IP addresses of ports to attach the vip to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] port_ids: An array of one or more IDs of the ports to attach the vip to.
        :param pulumi.Input[builtins.str] region: The region in which to create the vip associate resource. If omitted, the
               provider-level region will be used.
        :param pulumi.Input[builtins.str] vip_id: The ID of vip to attach the ports to.
        :param pulumi.Input[builtins.str] vip_ip_address: The IP address in the subnet for this vip.
        :param pulumi.Input[builtins.str] vip_subnet_id: The ID of the subnet this vip connects to.
        """
...
class VipAssociate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vip_id: Optional[pulumi.Input[builtins.str]] = None,
            vip_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            vip_subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VipAssociate':
        """
