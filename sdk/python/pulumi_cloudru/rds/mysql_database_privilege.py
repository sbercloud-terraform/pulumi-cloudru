...
class MysqlDatabasePrivilegeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db_name: Specifies the database name. Changing this creates a new resource.
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the RDS database privilege resource. If omitted,
