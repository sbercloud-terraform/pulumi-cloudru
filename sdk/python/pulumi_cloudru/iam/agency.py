...
class AgencyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] all_resources_roles: Specifies an array of one or more role names which stand for the permissions
        ...
        :param pulumi.Input[builtins.str] delegated_domain_name: Specifies the name of delegated user domain. This parameter
               and `delegated_service_name` are alternative.
        :param pulumi.Input[builtins.str] delegated_service_name: Specifies the name of delegated cloud service. The value must start
               with *op_svc_*, for example, *op_svc_obs*. This parameter and `delegated_domain_name` are alternative.
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the agency. The value is a string of
               0 to 255 characters, excluding these characters: '__@#$%^&*<>\\\\__'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_roles: Specifies an array of one or more role names which stand for the permissionis to be
               granted to agency on domain.
        :param pulumi.Input[builtins.str] duration: Specifies the validity period of an agency. The valid value are *ONEDAY* and *FOREVER*
               , defaults to *FOREVER*.
        :param pulumi.Input[builtins.str] name: Specifies the name of agency. The name is a string of 1 to 64 characters.
...
class _AgencyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] all_resources_roles: Specifies an array of one or more role names which stand for the permissions
               to be granted to agency on all resources, including those in enterprise projects, region-specific projects,
               and global services under your account.
        :param pulumi.Input[builtins.str] create_time: The time when the agency was created.
        :param pulumi.Input[builtins.str] delegated_domain_name: Specifies the name of delegated user domain. This parameter
               and `delegated_service_name` are alternative.
        :param pulumi.Input[builtins.str] delegated_service_name: Specifies the name of delegated cloud service. The value must start
               with *op_svc_*, for example, *op_svc_obs*. This parameter and `delegated_domain_name` are alternative.
        ...
        :param pulumi.Input[builtins.str] duration: Specifies the validity period of an agency. The valid value are *ONEDAY* and *FOREVER*
               , defaults to *FOREVER*.
        :param pulumi.Input[builtins.str] expire_time: The expiration time of agency.
        :param pulumi.Input[builtins.str] name: Specifies the name of agency. The name is a string of 1 to 64 characters.
               Changing this will create a new agency.
        :param pulumi.Input[Sequence[pulumi.Input['AgencyProjectRoleArgs']]] project_roles: Specifies an array of one or more roles and projects which are used to grant
               permissions to agency on project. The structure is documented below.
