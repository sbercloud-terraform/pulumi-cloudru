...
class VipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_id: Specifies the network ID of the VPC subnet to which the VIP belongs.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.str] ip_address: Specifies the IP address desired in the subnet for this VIP.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.int] ip_version: Specifies the IP version, either `4` (default) or `6`.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the VIP.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the VIP.
...
class _VipState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] device_owner: The device owner of the VIP.
        :param pulumi.Input[builtins.str] ip_address: Specifies the IP address desired in the subnet for this VIP.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.int] ip_version: Specifies the IP version, either `4` (default) or `6`.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.str] mac_address: The MAC address of the VIP.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the VIP.
        :param pulumi.Input[builtins.str] network_id: Specifies the network ID of the VPC subnet to which the VIP belongs.
               Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the VIP.
               If omitted, the provider-level region will be used. Changing this will create a new VIP resource.
        :param pulumi.Input[builtins.str] status: The VIP status.
        """
...
class Vip(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Vip':
        """
