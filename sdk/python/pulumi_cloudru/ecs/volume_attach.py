...
class VolumeAttachArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the volume resource. If omitted, the provider-level region will be used. Changing this creates a new resource.
        """
...
class _VolumeAttachState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the Instance to attach the Volume to.
        :param pulumi.Input[builtins.str] pci_address: PCI address of the block device.
        :param pulumi.Input[builtins.str] region: The region in which to create the volume resource. If omitted, the provider-level region will be used. Changing this creates a new resource.
        :param pulumi.Input[builtins.str] volume_id: The ID of the Volume to attach to an Instance.
        """
        if device is not None:
