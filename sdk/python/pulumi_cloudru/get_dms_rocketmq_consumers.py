...
class GetDmsRocketmqConsumersResult:
    ...
    def is_detail(self) -> Optional[builtins.bool]:
    ...
    def subscription_consistency(self) -> builtins.bool:
        """
...
def get_dms_rocketmq_consumers(group: Optional[builtins.str] = None,
                               instance_id: Optional[builtins.str] = None,
                               is_detail: Optional[builtins.bool] = None,
    ...
    :param builtins.str group: Specifies the consumer group name.
    :param builtins.str instance_id: Specifies the instance ID.
    :param builtins.bool is_detail: Specifies whether to query the consumer details.
...
def get_dms_rocketmq_consumers_output(group: Optional[pulumi.Input[builtins.str]] = None,
                                      instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                      is_detail: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
