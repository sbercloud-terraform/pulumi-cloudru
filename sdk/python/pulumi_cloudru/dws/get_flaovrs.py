...
def get_flaovrs(availability_zone: Optional[builtins.str] = None,
    ...
    :param builtins.str availability_zone: The availability zone name.
...
def get_flaovrs_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
