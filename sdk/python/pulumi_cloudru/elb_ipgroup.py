...
class ElbIpgroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ElbIpgroupIpListArgs']]] ip_lists: Specifies an array of one or more ip addresses. The ip_list object structure is
               documented below.
        :param pulumi.Input[builtins.str] description: Human-readable description for the ip group.
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project id of the ip group. Changing this
               creates a new ip group.
        :param pulumi.Input[builtins.str] name: Human-readable name for the ip group.
        :param pulumi.Input[builtins.str] region: The region in which to create the ip group resource. If omitted, the
