...
class DdsParameterTemplateCompareArgs:
    def __init__(__self__, *,
                 source_configuration_id: pulumi.Input[builtins.str],
                 target_configuration_id: pulumi.Input[builtins.str],
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DdsParameterTemplateCompare resource.
        :param pulumi.Input[builtins.str] source_configuration_id: Specifies the ID of the source parameter template to be
               compared. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] target_configuration_id: Specifies the ID of the destination parameter template to be
               compared. Changing this parameter will create a new resource.
    ...
    def source_configuration_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_configuration_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_configuration_id", value)

    @property
    @pulumi.getter(name="targetConfigurationId")
    def target_configuration_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_configuration_id(self, value: pulumi.Input[builtins.str]):
...
class _DdsParameterTemplateCompareState:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 source_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_configuration_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sourceConfigurationId")
    def source_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the source parameter template to be
        compared. Changing this parameter will create a new resource.
        """
    ...
    @source_configuration_id.setter
    def source_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_configuration_id", value)

    @property
    @pulumi.getter(name="targetConfigurationId")
    def target_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the destination parameter template to be
        compared. Changing this parameter will create a new resource.
        """
    ...
    @target_configuration_id.setter
    def target_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_configuration_id", value)
...
class DdsParameterTemplateCompare(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            source_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
            target_configuration_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DdsParameterTemplateCompare':
        """
    ...
    @property
    @pulumi.getter(name="sourceConfigurationId")
    def source_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the source parameter template to be
        compared. Changing this parameter will create a new resource.
        """
    ...
    @property
    @pulumi.getter(name="targetConfigurationId")
    def target_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the destination parameter template to be
        compared. Changing this parameter will create a new resource.
        """
