...
class PoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lb_method: The load balancing algorithm to distribute traffic to the pool's members. Must be one
               of ROUND_ROBIN, LEAST_CONNECTIONS, or SOURCE_IP.
        :param pulumi.Input[builtins.str] protocol: The protocol - can either be TCP, UDP or HTTP.
        ...
        :param pulumi.Input[builtins.bool] admin_state_up: The administrative state of the pool. A valid value is true (UP) or false (DOWN).
        :param pulumi.Input[builtins.str] description: Human-readable description for the pool.
        :param pulumi.Input[builtins.str] listener_id: The Listener on which the members of the pool will be associated with.
               Changing this creates a new pool. Note:  At least one of LoadbalancerID or ListenerID must be provided.
        :param pulumi.Input[builtins.str] loadbalancer_id: The load balancer on which to provision this pool. Changing this
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB pool resource. If omitted, the the
...
class Pool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Pool':
        """
