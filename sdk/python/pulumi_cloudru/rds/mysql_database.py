...
class MysqlDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] character_set: Specifies the character set used by the database, For example **utf8**,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the database description. The value can contain `0` to `512` characters.
               This parameter takes effect only for DB instances whose kernel versions are at least **5.6.51.3**, **5.7.33.1**,
               or **8.0.21.4**.
        :param pulumi.Input[builtins.str] name: Specifies the database name. The database name contains `1` to `64`
        ...
        :param pulumi.Input[builtins.str] region: The region in which to create the RDS database resource. If omitted, the
...
class MysqlDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'MysqlDatabase':
        """
