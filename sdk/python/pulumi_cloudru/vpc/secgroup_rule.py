...
class SecgroupRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] direction: Specifies the direction of the rule, valid values are **ingress** or
               **egress**. Changing this creates a new security group rule.
        :param pulumi.Input[builtins.str] ethertype: Specifies the layer 3 protocol type, valid values are **IPv4** or **IPv6**.
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the security group ID the rule should belong to. Changing
               this creates a new security group rule.
        :param pulumi.Input[builtins.str] action: Specifies the effective policy. The valid values are **allow** and **deny**.
               This parameter is not used with `port_range_min` and `port_range_max`.
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.str] description: Specifies the supplementary information about the networking security
               group rule. This parameter can contain a maximum of 255 characters and cannot contain angle brackets (< or >).
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.int] port_range_max: Specifies the higher part of the allowed port range, valid integer value
               needs to be between `1` and `65,535`. Changing this creates a new security group rule.
               This parameter and `ports` are alternative.
        :param pulumi.Input[builtins.int] port_range_min: Specifies the lower part of the allowed port range, valid integer value
               needs to be between `1` and `65,535`. Changing this creates a new security group rule.
               This parameter and `ports` are alternative.
        :param pulumi.Input[builtins.str] ports: Specifies the allowed port value range, which supports single port (80),
               continuous port (1-30) and discontinous port (22, 3389, 80) The valid port values is range form `1` to `65,535`.
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.int] priority: Specifies the priority number.
               The valid value is range from **1** to **100**. The default value is **1**.
               This parameter is not used with `port_range_min` and `port_range_max`.
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.str] protocol: Specifies the layer 4 protocol type, valid values are **tcp**, **udp**,
        ...
        :param pulumi.Input[builtins.str] region: The region in which to obtain the V2 networking client.
               ...
               security group rule.
        :param pulumi.Input[builtins.str] remote_address_group_id: Specifies the remote address group ID.
               This parameter is not used with `port_range_min` and `port_range_max`.
               Changing this creates a new security group rule.
        :param pulumi.Input[builtins.str] remote_group_id: Specifies the remote group ID. Changing this creates a new security
               group rule.
        :param pulumi.Input[builtins.str] remote_ip_prefix: Specifies the remote CIDR, the value needs to be a valid CIDR (i.e.
...
class SecgroupRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remote_group_id: Optional[pulumi.Input[builtins.str]] = None,
            remote_ip_prefix: Optional[pulumi.Input[builtins.str]] = None,
            security_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SecgroupRule':
        """
