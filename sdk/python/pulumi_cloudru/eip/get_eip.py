...
def get_eip(enterprise_project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str enterprise_project_id: The enterprise project id of the EIP.
    :param builtins.str port_id: The port id of the EIP.
    :param builtins.str public_ip: The public ip address of the EIP.
    :param builtins.str region: The region in which to obtain the EIP. If omitted, the provider-level region will be
           used.
    """
    __args__ = dict()
...
def get_eip_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
