...
if typing.TYPE_CHECKING:
    import pulumi_sbercloud.aom as __aom
    aom = __aom
    import pulumi_sbercloud.as_ as __as_
    as_ = __as_
    import pulumi_sbercloud.cbr as __cbr
    cbr = __cbr
    import pulumi_sbercloud.cce as __cce
    cce = __cce
    import pulumi_sbercloud.cdm as __cdm
    cdm = __cdm
    import pulumi_sbercloud.ces as __ces
    ces = __ces
    import pulumi_sbercloud.cfw as __cfw
    cfw = __cfw
    import pulumi_sbercloud.config as __config
    config = __config
    import pulumi_sbercloud.css as __css
    css = __css
    import pulumi_sbercloud.cts as __cts
    cts = __cts
    import pulumi_sbercloud.dcs as __dcs
    dcs = __dcs
    import pulumi_sbercloud.dds as __dds
    dds = __dds
    import pulumi_sbercloud.dedicatedapig as __dedicatedapig
    dedicatedapig = __dedicatedapig
    import pulumi_sbercloud.dew as __dew
    dew = __dew
    import pulumi_sbercloud.dis as __dis
    dis = __dis
    import pulumi_sbercloud.dli as __dli
    dli = __dli
    import pulumi_sbercloud.dms as __dms
    dms = __dms
    import pulumi_sbercloud.dns as __dns
    dns = __dns
    import pulumi_sbercloud.drs as __drs
    drs = __drs
    import pulumi_sbercloud.dws as __dws
    dws = __dws
    import pulumi_sbercloud.ecs as __ecs
    ecs = __ecs
    import pulumi_sbercloud.eip as __eip
    eip = __eip
    import pulumi_sbercloud.elb as __elb
    elb = __elb
    import pulumi_sbercloud.eps as __eps
    eps = __eps
    import pulumi_sbercloud.er as __er
    er = __er
    import pulumi_sbercloud.evs as __evs
    evs = __evs
    import pulumi_sbercloud.functiongraph as __functiongraph
    functiongraph = __functiongraph
    import pulumi_sbercloud.iam as __iam
    iam = __iam
    import pulumi_sbercloud.ims as __ims
    ims = __ims
    import pulumi_sbercloud.lts as __lts
    lts = __lts
    import pulumi_sbercloud.mrs as __mrs
    mrs = __mrs
    import pulumi_sbercloud.nat as __nat
    nat = __nat
    import pulumi_sbercloud.networkacl as __networkacl
    networkacl = __networkacl
    import pulumi_sbercloud.obs as __obs
    obs = __obs
    import pulumi_sbercloud.rds as __rds
    rds = __rds
    import pulumi_sbercloud.sfs as __sfs
    sfs = __sfs
    import pulumi_sbercloud.sharedapig as __sharedapig
    sharedapig = __sharedapig
    import pulumi_sbercloud.vpc as __vpc
    vpc = __vpc
    import pulumi_sbercloud.vpcep as __vpcep
    vpcep = __vpcep
else:
    aom = _utilities.lazy_import('pulumi_sbercloud.aom')
    as_ = _utilities.lazy_import('pulumi_sbercloud.as_')
    cbr = _utilities.lazy_import('pulumi_sbercloud.cbr')
    cce = _utilities.lazy_import('pulumi_sbercloud.cce')
    cdm = _utilities.lazy_import('pulumi_sbercloud.cdm')
    ces = _utilities.lazy_import('pulumi_sbercloud.ces')
    cfw = _utilities.lazy_import('pulumi_sbercloud.cfw')
    config = _utilities.lazy_import('pulumi_sbercloud.config')
    css = _utilities.lazy_import('pulumi_sbercloud.css')
    cts = _utilities.lazy_import('pulumi_sbercloud.cts')
    dcs = _utilities.lazy_import('pulumi_sbercloud.dcs')
    dds = _utilities.lazy_import('pulumi_sbercloud.dds')
    dedicatedapig = _utilities.lazy_import('pulumi_sbercloud.dedicatedapig')
    dew = _utilities.lazy_import('pulumi_sbercloud.dew')
    dis = _utilities.lazy_import('pulumi_sbercloud.dis')
    dli = _utilities.lazy_import('pulumi_sbercloud.dli')
    dms = _utilities.lazy_import('pulumi_sbercloud.dms')
    dns = _utilities.lazy_import('pulumi_sbercloud.dns')
    drs = _utilities.lazy_import('pulumi_sbercloud.drs')
    dws = _utilities.lazy_import('pulumi_sbercloud.dws')
    ecs = _utilities.lazy_import('pulumi_sbercloud.ecs')
    eip = _utilities.lazy_import('pulumi_sbercloud.eip')
    elb = _utilities.lazy_import('pulumi_sbercloud.elb')
    eps = _utilities.lazy_import('pulumi_sbercloud.eps')
    er = _utilities.lazy_import('pulumi_sbercloud.er')
    evs = _utilities.lazy_import('pulumi_sbercloud.evs')
    functiongraph = _utilities.lazy_import('pulumi_sbercloud.functiongraph')
    iam = _utilities.lazy_import('pulumi_sbercloud.iam')
    ims = _utilities.lazy_import('pulumi_sbercloud.ims')
    lts = _utilities.lazy_import('pulumi_sbercloud.lts')
    mrs = _utilities.lazy_import('pulumi_sbercloud.mrs')
    nat = _utilities.lazy_import('pulumi_sbercloud.nat')
    networkacl = _utilities.lazy_import('pulumi_sbercloud.networkacl')
    obs = _utilities.lazy_import('pulumi_sbercloud.obs')
    rds = _utilities.lazy_import('pulumi_sbercloud.rds')
    sfs = _utilities.lazy_import('pulumi_sbercloud.sfs')
    sharedapig = _utilities.lazy_import('pulumi_sbercloud.sharedapig')
    vpc = _utilities.lazy_import('pulumi_sbercloud.vpc')
    vpcep = _utilities.lazy_import('pulumi_sbercloud.vpcep')
...
[
 ...
 },
 {
  ...
  "fqn": "pulumi_sbercloud.dedicatedapig",
  "classes": {
 ...
 },
 {
  ...
  "fqn": "pulumi_sbercloud.functiongraph",
  "classes": {
 ...
 },
 {
  "pkg": "sbercloud",
  "mod": "NetworkAcl/acl",
  "fqn": "pulumi_sbercloud.networkacl",
  "classes": {
 ...
 },
 {
  "pkg": "sbercloud",
  "mod": "SharedApig/api",
  "fqn": "pulumi_sbercloud.sharedapig",
  "classes": {
