...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] port_id: Specifies the ID for identifying the backend resource of the VPC endpoint service.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServicePortMappingArgs']]] port_mappings: Specifies the port mappings opened to the VPC endpoint service. Structure is
               documented below.
        :param pulumi.Input[builtins.str] server_type: Specifies the backend resource type. The valid values are as follows:
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC to which the backend resource of the VPC endpoint
               service belongs. Changing this creates a new VPC endpoint service.
        :param pulumi.Input[builtins.bool] approval: Specifies whether connection approval is required. The default value is false.
        :param pulumi.Input[builtins.str] description: Specifies the description of the VPC endpoint service.
        :param pulumi.Input[builtins.bool] enable_policy: Specifies whether the VPC endpoint policy is enabled. Defaults to **false**.
               Changing this creates a new VPC endpoint service resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the VPC endpoint service. The value contains a maximum of 16
               characters, including letters, digits, underscores (_), and hyphens (-).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organization_permissions: Specifies the list of organizations to access the VPC endpoint service.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: Specifies the list of accounts to access the VPC endpoint service.
               The record is in the `iam:domain::domain_id` format, while `*` allows all users to access the VPC endpoint service.
        :param pulumi.Input[builtins.str] region: The region in which to create the VPC endpoint service. If omitted, the
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the VPC endpoint service.
        """
...
class _ServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_type: Specifies the backend resource type. The valid values are as follows:
               ...
               Changing this creates a new VPC endpoint service.
        :param pulumi.Input[builtins.str] service_name: The full name of the VPC endpoint service in the format: *region.name.id* or *region.id*.
        :param pulumi.Input[builtins.str] service_type: The type of the VPC endpoint service.
        :param pulumi.Input[builtins.str] status: The connection status of the VPC endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the VPC endpoint service.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of the VPC to which the backend resource of the VPC endpoint
               service belongs. Changing this creates a new VPC endpoint service.
        """
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Service':
        """
