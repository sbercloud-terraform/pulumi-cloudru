...
def get_bucket_object(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str bucket: The name of the bucket to put the file in.
    :param builtins.str key: The name of the object once it is in the bucket.
    :param builtins.str region: The region in which to obtain the OBS object. If omitted, the provider-level region will
           be used.
    """
    __args__ = dict()
