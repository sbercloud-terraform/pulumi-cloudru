...
def get_regions(enterprise_project_id: Optional[builtins.str] = None,
...
def get_regions_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
