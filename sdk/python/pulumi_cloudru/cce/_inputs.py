...
class AddonValuesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] basic: Specifies the key/value pairs vary depending on the add-on.
               Only supports non-nested structure and only supports string type elements.
               This is an alternative to `basic_json`, but it is not recommended.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] basic_json: Specifies the json string vary depending on the add-on.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom: Specifies the key/value pairs vary depending on the add-on.
               Only supports non-nested structure and only supports string type elements.
               This is an alternative to `custom_json`, but it is not recommended.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] custom_json: Specifies the json string vary depending on the add-on.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] flavor: Specifies the key/value pairs vary depending on the add-on.
               Only supports non-nested structure and only supports string type elements.
               This is an alternative to `flavor_json`, but it is not recommended.
               Changing this parameter will create a new resource.
               ...
               the add-on type and version. For more detailed description of add-ons
               see add-ons description
        :param pulumi.Input[builtins.str] flavor_json: Specifies the json string vary depending on the add-on.
               Changing this parameter will create a new resource.
        """
...
class ClusterCertificateClusterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_authority_data: The certificate data.
        :param pulumi.Input[builtins.str] name: Specifies the component name.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] server: The server IP address.
        """
...
class ClusterCertificateUserArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_certificate_data: The client certificate data.
        :param pulumi.Input[builtins.str] client_key_data: The client key data.
        :param pulumi.Input[builtins.str] name: Specifies the component name.
               Changing this parameter will create a new cluster resource.
        """
...
class ClusterComponentConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the component name.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] configurations: Specifies JSON string of the component configurations.
               Changing this parameter will create a new cluster resource.
        """
        pulumi.set(__self__, "name", name)
...
class ClusterExtendParamArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cluster_az: Specifies the AZ of master nodes in the cluster. The value can be:
               + **multi_az**: The cluster will span across AZs. This field is configurable only for high-availability clusters.
               + **AZ of the dedicated cloud computing pool**: The cluster will be deployed in the AZ of Dedicated Cloud (DeC).
               This parameter is mandatory for dedicated CCE clusters.
               
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] cpu_manager_policy: Specifies the cluster CPU management policy.
               The value can be:
               + **none**: CPU cores will not be exclusively allocated to workload pods.
               Select this value if you want a large pool of shareable CPU cores.
               + **static**: CPU cores can be exclusively allocated to workload pods.
               ...
               <a name="cce_cluster_component_configurations"></a>
               The `component_configurations` block supports:
        :param pulumi.Input[builtins.str] dec_master_flavor: Specifies the specifications of the master node
               in the dedicated hybrid cluster.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] docker_umask_mode: Specifies the default UmaskMode configuration of Docker in a
               cluster. The value can be **secure** or **normal**, defaults to normal.
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] dss_master_volumes: Specifies whether the system and data disks of a master node
               use dedicated distributed storage. If left unspecified, EVS disks are used by default.
               This parameter is mandatory for dedicated CCE clusters.
               It is in the following format:
               ...
               Changing this parameter will create a new cluster resource.
        :param pulumi.Input[builtins.str] fix_pool_mask: Specifies the number of mask bits of the fixed IP address pool
               of the container network model. This field can only be used when `container_network_type` is set to **vpc-router**.
               Changing this parameter will create a new cluster resource.
        """
...
class ClusterMasterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone of the master node.
               Changing this parameter will create a new cluster resource.
...
class NodeAttachExtensionNicArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet to which the NIC belongs.
        """
...
class NodeAttachStorageGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the Node Name.
        """
        pulumi.set(__self__, "name", name)
...
class NodeAttachTaintArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] effect: Available options are NoSchedule, PreferNoSchedule, and NoExecute.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] key: A key must contain 1 to 63 characters starting with a letter or digit.
               Only letters, digits, hyphens (-), underscores (_), and periods (.) are allowed. A DNS subdomain name can be used
               as the prefix of a key. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] value: A value must start with a letter or digit and can contain a maximum of 63
               characters, including letters, digits, hyphens (-), underscores (_), and periods (.). Changing this parameter will
               create a new resource.
        """
...
class NodeDataVolumeArgs:
    def __init__(__self__, *,
                 ...
                 throughput: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] size: Specifies the disk size in GB.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] volumetype: Specifies the disk type.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] extend_param: Specifies the extended parameter.
               Changing this parameter will create a new resource.
               The available keys are as follows:
               + **agency_name**: The agency name to provide temporary credentials for CCE node to access other cloud services.
               + **alpha.cce/NodeImageID**: The custom image ID used to create the BMS nodes.
               ...
               The following is an example default configuration:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] extend_params: Specifies the disk expansion parameters.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] hw_passthrough: schema: Internal
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the ID of a KMS key. This is used to encrypt the volume.
               Changing this parameter will create a new resource.
        """
        pulumi.set(__self__, "size", size)
        pulumi.set(__self__, "volumetype", volumetype)
...
class NodeExtendParamsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_pods: Specifies the maximum number of instances a node is allowed to create.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] postinstall: Specifies the script to be executed after installation.
               The input value can be a Base64 encoded string or not. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] preinstall: Specifies the script to be executed before installation.
               The input value can be a Base64 encoded string or not. Changing this parameter will create a new resource.
        """
...
class NodeExtensionNicArgs:
    def __init__(__self__, *,
                 subnet_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of the subnet to which the NIC belongs.
               Changing this parameter will create a new resource.
        """
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class NodeHostnameConfigArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Specifies the storage type. Currently, only **evs (EVS volumes)** is supported.
               The default value is **evs**. Changing this parameter will create a new resource.
        """
        pulumi.set(__self__, "type", type)
...
class NodePoolDataVolumeArgs:
    def __init__(__self__, *,
                 ...
                 throughput: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] size: Specifies the disk size in GB. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] volumetype: Specifies the disk type. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] dss_pool_id: Specifies the DSS pool ID. This field is used only for dedicated storage.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] extend_params: Specifies the disk expansion parameters.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] hw_passthrough: schema: Internal
        :param pulumi.Input[builtins.int] iops: Specifies the iops of the disk,
               required when `volumetype` is **GPSSD2** or **ESSD2**.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the KMS key ID. This is used to encrypt the volume.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] throughput: Specifies the throughput of the disk in MiB/s,
               required when `volumetype` is **GPSSD2**.
...
class NodePoolExtendParamsArgs:
    def __init__(__self__, *,
                 ...
                 system_reserved_mem: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] agency_name: Specifies the agency name.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] docker_base_size: Specifies the available disk space of a single container on a node,
               in GB. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] kube_reserved_mem: Specifies the reserved node memory, which is reserved for
               Kubernetes-related components. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] max_pods: Specifies the maximum number of instances a node is allowed to create.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] nic_threshold: Specifies the ENI pre-binding thresholds.
               Example setting: **"0.3:0.6"**. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] node_image_id: Specifies the image ID to create the node.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] node_multi_queue: Specifies the number of ENI queues.
               Example setting: **"[{\\"queue\\":4}]"**. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] postinstall: Specifies the script to be executed after installation.
               The input value can be a Base64 encoded string or not. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] preinstall: Specifies the script to be executed before installation.
               The input value can be a Base64 encoded string or not. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.int] system_reserved_mem: Specifies the reserved node memory, which is reserved
               value for system components. Changing this parameter will create a new resource.
        """
        if agency_name is not None:
            pulumi.set(__self__, "agency_name", agency_name)
...
class NodePoolExtensionScaleGroupMetadataArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the node pool name.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class NodePoolExtensionScaleGroupSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NodePoolExtensionScaleGroupSpecAutoscalingArgs'] autoscaling: Specifies the auto scaling configurations of the extended scaling group.
               ...
               <a name="capacity_reservation_specification"></a>
               The `capacity_reservation_specification` block supports:
        :param pulumi.Input[builtins.str] az: Specifies the availability zone of a node.
               If this parameter is not specified or left blank, the default scaling group configurations take effect.
        :param pulumi.Input['NodePoolExtensionScaleGroupSpecCapacityReservationSpecificationArgs'] capacity_reservation_specification: Specifies the capacity reservation
               configurations of the extended scaling group.
               The object structure is documented below.
        :param pulumi.Input[builtins.str] flavor: Specifies the node flavor.
        """
...
class NodePoolExtensionScaleGroupSpecAutoscalingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable auto scaling for the scaling group, defaults to **false**.
        :param pulumi.Input[builtins.int] extension_priority: Specifies the priority of the scaling group, defaults to **0**.
               A higher value indicates a greater priority.
        :param pulumi.Input[builtins.int] max_node_count: Specifies the maximum number of nodes allowed if auto scaling is enabled.
        :param pulumi.Input[builtins.int] min_node_count: Specifies the minimum number of nodes allowed if auto scaling is enabled.
        """
...
class NodePoolExtensionScaleGroupSpecCapacityReservationSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The resource ID in UUID format.
        :param pulumi.Input[builtins.str] preference: Specifies the capacity of a private storage pool. If the value is none,
               the capacity reservation is not specified. If the value is targeted, the capacity reservation is specified.
               In this case, the `id` cannot be left blank.
...
class NodePoolHostnameConfigArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Specifies the node pool type. Possible values are: **vm** and **ElasticBMS**.
        """
        pulumi.set(__self__, "type", type)
...
class NodePoolStorageGroupArgs:
    def __init__(__self__, *,
                 ...
                 cce_managed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of an extended scaling group.
               The value cannot be default and can contain a maximum of 55 characters.
               Only digits, lowercase letters, and hyphens (-) are allowed.
               
               <a name="spec"></a>
               The `spec` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] selector_names: Specifies the list of names of selectors to match.
               This parameter corresponds to name in `selectors`. A group can match multiple selectors,
               but a selector can match only one group. Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input['NodePoolStorageGroupVirtualSpaceArgs']]] virtual_spaces: Specifies the detailed management of space configuration in a group.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.bool] cce_managed: Specifies the whether the storage space is for **kubernetes** and
               **runtime** components. Only one group can be set to true. The default value is **false**.
               Changing this parameter will create a new resource.
        """
        pulumi.set(__self__, "name", name)
...
class NodePoolStorageGroupVirtualSpaceArgs:
    def __init__(__self__, *,
                 ...
                 runtime_lv_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the virtual space name. Currently, only **kubernetes**, **runtime**,
               and **user** are supported. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] size: Specifies the size of a virtual space. Only an integer percentage is supported.
               Example: 90%. Note that the total percentage of all virtual spaces in a group cannot exceed 100%.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] lvm_lv_type: Specifies the LVM write mode, values can be **linear** and **striped**.
               This parameter takes effect only in **kubernetes** and **user** configuration. Changing this parameter will create
               a new resource.
        :param pulumi.Input[builtins.str] lvm_path: Specifies the absolute path to which the disk is attached.
               This parameter takes effect only in **user** configuration. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] runtime_lv_type: Specifies the LVM write mode, values can be **linear** and **striped**.
               This parameter takes effect only in **runtime** configuration. Changing this parameter will create a new resource.
...
class NodePoolStorageSelectorArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the selector name, used as the index of `selector_names` in storage group.
               The name of each selector must be unique. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_count: Specifies the number of disks to be selected. If omitted,
               all disks of this type are selected. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_metadata_cmkid: Specifies the customer master key ID of an encrypted
               disk. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_metadata_encrypted: Specifies the disk encryption identifier.
               Values can be: **0** indicates that the disk is not encrypted and **1** indicates that the disk is encrypted.
               If omitted, whether the disk is encrypted is not limited. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_size: Specifies the matched disk size. If omitted,
               the disk size is not limited. Example: 100. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_volume_type: Specifies the EVS disk type. Currently,
               **SSD**, **GPSSD**, and **SAS** are supported. If omitted, the disk type is not limited.
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] type: Specifies the storage type. Currently, only **evs (EVS volumes)** is supported.
               The default value is **evs**. Changing this parameter will create a new resource.
...
class NodePoolTaintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] effect: Available options are NoSchedule, PreferNoSchedule, and NoExecute.
               ...
               <a name="extend_params"></a>
               The `extend_params` block supports:
        :param pulumi.Input[builtins.str] key: A key must contain 1 to 63 characters starting with a letter or digit. Only letters,
               digits, hyphens (-), underscores (_), and periods (.) are allowed. A DNS subdomain name can be used as the
               prefix of a key.
        :param pulumi.Input[builtins.str] value: A value must start with a letter or digit and can contain a maximum of 63 characters,
               including letters, digits, hyphens (-), underscores (_), and periods (.).
        """
        pulumi.set(__self__, "effect", effect)
        pulumi.set(__self__, "key", key)
...
class NodeStorageGroupArgs:
    def __init__(__self__, *,
                 ...
                 cce_managed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of a virtual storage group. Each group name must be unique.
               Changing this parameter will create a new resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] selector_names: Specifies the list of names of seletors to match.
               This parameter corresponds to name in `selectors`. A group can match multiple selectors,
               but a selector can match only one group. Changing this parameter will create a new resource.
...
class NodeStorageSelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] match_label_count: Specifies the number of disks to be selected. If omitted,
               all disks of this type are selected. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_metadata_cmkid: Specifies the cstomer master key ID of an encrypted
               disk. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] match_label_metadata_encrypted: Specifies the disk encryption identifier.
               Values can be: **0** indicates that the disk is not encrypted and **1** indicates that the disk is encrypted.
               If omitted, whether the disk is encrypted is not limited. Changing this parameter will create a new resource.
