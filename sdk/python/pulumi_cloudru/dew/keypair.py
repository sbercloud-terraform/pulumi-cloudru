...
class KeypairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of keypair.
        :param pulumi.Input[builtins.str] encryption_type: Specifies encryption mode. The options are as follows:
        ...
        :param pulumi.Input[builtins.str] key_file: Specifies the path of the created private key.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the KMS key ID to encrypt private keys.
        :param pulumi.Input[builtins.str] kms_key_name: Specifies the KMS key name to encrypt private keys.
               ...
               `kms_key_name`.
        :param pulumi.Input[builtins.str] name: Specifies a unique name for the keypair. The name can contain a maximum of `64`
               characters, including letters, digits, underscores (_) and hyphens (-).
               Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] private_key: Specifies the imported OpenSSH-formatted private key.
        ...
        :param pulumi.Input[builtins.str] public_key: Specifies the imported OpenSSH-formatted public key.
               It is required when import keypair. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the keypair resource. If omitted, the
               provider-level region will be used. Changing this parameter will create a new resource.
        :param pulumi.Input[builtins.str] scope: Specifies the scope of keypair. The options are as follows:
        ...
        :param pulumi.Input[builtins.str] user_id: Specifies the user ID to which the keypair belongs.
...
class _KeypairState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The keypair creation time.
        :param pulumi.Input[builtins.str] description: Specifies the description of keypair.
        :param pulumi.Input[builtins.str] encryption_type: Specifies encryption mode. The options are as follows:
               + **default**: The default encryption mode. Applicable to sites where KMS is not deployed.
               + **kms**: KMS encryption mode.
               ...
               > 1. Please configure this field to **default** if the KMS service is not available at the site.
               <br/>2. Due to API restrictions, `private_key` must be configured when editing this field.
        :param pulumi.Input[builtins.str] fingerprint: Fingerprint information about a keypair.
        :param pulumi.Input[builtins.bool] is_managed: Whether the private key is managed by sberCloud.
        :param pulumi.Input[builtins.str] key_file: Specifies the path of the created private key.
               The private key file (**.pem**) is created only when creating a KPS keypair.
               Importing an existing keypair will not obtain the private key information.
...
class Keypair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Keypair':
        """
