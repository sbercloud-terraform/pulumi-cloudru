...
class FunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] memory_size: Specifies the memory size(MB) allocated to the function.
        :param pulumi.Input[builtins.str] runtime: Specifies the environment for executing the function.
        :param pulumi.Input[builtins.int] timeout: Specifies the timeout interval of the function, ranges from 3s to 900s.
        :param pulumi.Input[builtins.str] agency: Specifies the agency. This parameter is mandatory if the function needs to access other cloud services.
        :param pulumi.Input[builtins.str] app: Specifies the group to which the function belongs.
        :param pulumi.Input[builtins.str] app_agency: Specifies An execution agency enables you to obtain a token or an AK/SK for accessing other cloud services.
        :param pulumi.Input[builtins.str] code_encrypt_kms_key_id: The KMS key ID for encrypting the function code.
        :param pulumi.Input[builtins.str] code_filename: Specifies the name of a function file, This field is mandatory only when coe_type is
               set to jar or zip.
        :param pulumi.Input[builtins.str] code_type: Specifies the function code type, which can be inline: inline code, zip: ZIP file,
               jar: JAR file or java functions, obs: function code stored in an OBS bucket.
        :param pulumi.Input[builtins.str] code_url: Specifies the code url. This parameter is mandatory when code_type is set to obs.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] depend_lists: Specifies the dependencies of the function.
        :param pulumi.Input[builtins.str] description: Specifies the description of the function.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the function.
        ...
        :param pulumi.Input[builtins.str] func_code: Specifies the function code. When code_type is set to inline, zip, or jar, this parameter is mandatory,
        ...
        :param pulumi.Input[builtins.str] handler: Specifies the entry point of the function.
        :param pulumi.Input[builtins.str] heartbeat_handler: The heartbeat handler of the function.
        :param pulumi.Input[builtins.str] initializer_handler: Specifies the initializer of the function.
        :param pulumi.Input[builtins.int] initializer_timeout: Specifies the maximum duration the function can be initialized. Value range: 1s to 300s.
        ...
        :param pulumi.Input[builtins.int] mount_user_group_id: Specifies the user group ID, a non-0 integer from –1 to 65534. Default to -1.
        :param pulumi.Input[builtins.int] mount_user_id: Specifies the user ID, a non-0 integer from –1 to 65534. Default to -1.
        :param pulumi.Input[builtins.str] name: Specifies the name of the function.
        :param pulumi.Input['FunctionNetworkControllerArgs'] network_controller: The network configuration of the function.
        :param pulumi.Input[builtins.str] network_id: Specifies the ID of subnet.
        :param pulumi.Input[builtins.str] peering_cidr: The VPC CIDR blocks used in the function code to detect whether it conflicts with the VPC
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the Function resource.
        ...
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of VPC.
        """
...
class _FunctionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_stream_name: The LTS stream name for collecting logs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] lts_custom_tag: The custom tags configuration that used to filter the LTS logs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] lts_custom_tag_origin: The script configuration value of this change is also the original value used for comparison with
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The key/value pairs to associate with the function.
        :param pulumi.Input[builtins.int] timeout: Specifies the timeout interval of the function, ranges from 3s to 900s.
        :param pulumi.Input[builtins.str] urn: Uniform Resource Name
        :param pulumi.Input[builtins.str] user_data: The key/value information defined for the function.
        :param pulumi.Input[builtins.str] user_data_encrypt_kms_key_id: The KMS key ID for encrypting the user data.
...
class Function(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            versions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FunctionVersionArgs', 'FunctionVersionArgsDict']]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            xrole: Optional[pulumi.Input[builtins.str]] = None) -> 'Function':
        """
