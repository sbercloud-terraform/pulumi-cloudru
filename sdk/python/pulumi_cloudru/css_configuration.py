...
class CssConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] http_cors_allow_credetials: Whether to return the Access-Control-Allow-Credentials of
        ...
        :param pulumi.Input[builtins.str] http_cors_enabled: Whether to allow cross-domain access.  
               The value can be **true** or **false**. Default value: **false**.
        :param pulumi.Input[builtins.str] http_cors_max_age: Cache duration of the browser. The cache is automatically cleared
        ...
        :param pulumi.Input[builtins.str] reindex_remote_whitelist: Configured for migrating data from the current cluster to
