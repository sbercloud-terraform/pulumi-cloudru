...
class ElbMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The IP address of the member to receive traffic from the load balancer.
               Changing this creates a new member.
        :param pulumi.Input[builtins.str] pool_id: The id of the pool that this member will be assigned to.
        ...
        :param pulumi.Input[builtins.int] protocol_port: The port on which to listen for client traffic. Changing this creates a
               new member.
        :param pulumi.Input[builtins.str] region: The region in which to create the ELB member resource. If omitted, the the
        ...
        :param pulumi.Input[builtins.int] weight: A positive integer value that indicates the relative portion of traffic that this member
