...
class VpcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: Specifies the range of available subnets in the VPC. The value ranges from 10.0.0.0/8 to
               10.255.255.0/24, 172.16.0.0/12 to 172.31.255.0/24, or 192.168.0.0/16 to 192.168.255.0/24.
        :param pulumi.Input[builtins.str] description: Specifies supplementary information about the VPC. The value is a string of
               no more than 255 characters and cannot contain angle brackets (< or >).
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the VPC. Changing this
               creates a new VPC resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the VPC. The name must be unique for a tenant. The value is a string
               of no more than 64 characters and can contain digits, letters, underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the VPC. If omitted, the
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the VPC.
        """
...
class _VpcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: Specifies the region in which to create the VPC. If omitted, the
               provider-level region will be used. Changing this creates a new VPC resource.
        :param pulumi.Input[builtins.str] secondary_cidr: schema: Deprecated; use secondary_cidrs instead
        :param pulumi.Input[builtins.str] status: The current status of the VPC. Possible values are as follows: CREATING, OK or ERROR.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the key/value pairs to associate with the VPC.
        """
        if block_service_endpoint_states is not None:
            pulumi.set(__self__, "block_service_endpoint_states", block_service_endpoint_states)
